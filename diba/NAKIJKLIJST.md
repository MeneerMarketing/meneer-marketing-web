...
- [ De Nordlys van Candela is geen laser maar IPL: intens gepulst licht. Een laser zendt één golflengte uit, IPL een band. Candela noemt zijn variant Selective Waveband Technology: twee filters knippen boven- en onderkant van het spectrum weg, zodat er een smallere band overblijft dan bij gewone IP...
  <sub>src/data/apparatuur.ts:488</sub>
...
- Het bedrag is voor het traject, met de producten voor thuis erbij.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:116</sub>
- Dan begin je met een intake. We meten je huid, stellen vast welk type pigment het is en of Cosmelan of Dermamelan erbij past. Een losse intake duurt maximaal ${INTAKE_MINUTEN} minuten en kost ${euro(INTAKE_PRIJS)}.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:120</sub>
- Het traject begint met een meting, en bij de controles onderweg wordt er opnieuw gemeten, zodat je op de opnames ziet wat er verandert.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:186</sub>

**Inhoud: dermaplaning-rotterdam** (1)
...
- De behandelaar beoordeelt eerst of je huid rustig genoeg is, want bij een actieve ontsteking gaat het mesje er niet overheen.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:149</sub>
...
**Inhoud: elektrische-epilatie-rotterdam** (1)
...
- De behandelaar kijkt eerst of een deel van je haar nog op laser reageert, want dan is dat de snellere weg. Wat overblijft, doet de behandelaar haar voor haar.
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:156</sub>

**Inhoud: fotona-4d-rotterdam** (1)

- Dan boek je een behandeling op advies, waar we maximaal ${alsWoord(ADVIES_MINUTEN.nieuw / 60)} uur voor reserveren. Fotona 4D duurt zelf ${F4.duurMinuten} minuten, dus of hij in die eerste afspraak past, hangt af van hoe lang de intake duurt. Past het niet, dan plannen we hem direct daarna in.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:113</sub>

**Inhoud: hoeveel-sessies** (1)

- [ Wat een behandeling doet, hangt af van hoe jouw huid erop reageert, en dat is vooraf een inschatting. Bij de een is de textuur na drie sessies waar hij zijn moet, bij de ander vraagt hetzelfde doel er zes. Een getal dat vooraf vastligt is dus een belofte over iemand anders zijn huid., Daarom me...
  <sub>src/data/landings/hoeveel-sessies.ts:88</sub>

**Inhoud: huidanalyse-rotterdam** (2)

- De drie consulten kosten hetzelfde; ze verschillen in waar de behandelaar naar kijkt.
  <sub>src/data/landings/huidanalyse-rotterdam.ts:102</sub>
- Bij een eerste afspraak begin je met een intake, en bij de meeste klachten hoort daar een meting bij. Ben je al klant en kom je voor een behandeling die je eerder had, dan is er geen nieuwe intake nodig.
  <sub>src/data/landings/huidanalyse-rotterdam.ts:209</sub>

**Inhoud: hydrafacial-rotterdam** (1)
...
- Welke van de drie bij je past bespreekt de behandelaar tijdens de intake, op basis van wat je huid nodig heeft en wat je met de behandeling wilt.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:108</sub>

**Inhoud: ipl-rotterdam** (1)

- [ Een laser zendt één golflengte uit en is daarmee heel precies. IPL zendt een band uit, raakt daardoor meerdere doelen tegelijk en werkt over een groter vlak. Voor één specifiek plekje is een laser preciezer; voor zonschade verspreid over je wangen is IPL sneller en gelijkmatiger., Wij werken me...
  <sub>src/data/landings/ipl-rotterdam.ts:92</sub>
...
- Meestal drie tot zes, met vier tot zes weken ertussen, en dat hoor je pas na de meting omdat het van de oorzaak afhangt. Bij pigment werken we onder het oog bewust in kleinere stappen, dus reken op meer sessies dan bij dezelfde vlek op je wang.
  <sub>src/data/kringen.ts:218</sub>
...
- De eerste verandering zie je meestal na twee tot drie maanden. Reken dus op maanden en niet op weken, en op onderhoud daarna. Dat laatste is geen bijzaak maar het grootste deel van het werk.
  <sub>src/data/melasma.ts:178</sub>

**Inhoud: microneedling-rotterdam** (1)

- [ De [SkinPen](/apparatuur/skinpen-cit) heeft veertien naalden en werkt iets bedaarder. De [Dermapen 4](/apparatuur/dermapen-4) haalt tot 1920 prikken per seconde en werkt een vlak daardoor sneller af, met voorgeprogrammeerde standen, waaronder een instelling voor littekens op de maximale diepte....
  <sub>src/data/landings/microneedling-rotterdam.ts:88</sub>

**Inhoud: oxygeneo-rotterdam** (1)
...
- De behandelaar beoordeelt vooraf of je huid er rustig genoeg voor is, en kiest de gel op wat je huid op dat moment nodig heeft.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:153</sub>

**Inhoud: pigment** (1)

- wordt het hier onderschat een heldere junidag met de helft, en op een pagina over pigment is dat precies de verkeerde kant om je te vergissen. Daarom staat ZONJAAR_KANTTEKENING hieronder op het scherm, en niet alleen in dit commentaar. [GEGEVEN-NODIG: maandwaarden UV-index Nederland uit een noemb...
  <sub>src/data/pigment.ts:43</sub>

**Inhoud: skinboosters-rotterdam** (1)

- De behandelaar kiest het mengsel en de diepte, en stelt de U225 per zone in: rond de ogen anders dan op de wang.
  <sub>src/data/landings/skinboosters-rotterdam.ts:164</sub>
...
- De meting kost vijftig euro en dat is meteen het hele consult. Wat er daarna volgt hangt af van wat eruit komt en staat per behandeling op de tarievenpagina. Blijkt uit de meting dat je in balans zit, dan is ons advies om niets te doen en houdt het daar op.
  <sub>src/data/droge-huid.ts:186</sub>

**Inhoud: fotona-4d-rotterdam** (1)

- Een kuur van drie kost ${euro(KUUR_4D)}, tegen ${euro(3 * F4.prijs)} voor drie losse behandelingen. Het tarief voor Fotona 4D Men hoor je bij de intake.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:109</sub>

**Inhoud: gevoelige-huid** (1)
...
- De meting kost vijftig euro. Wat daarna volgt staat per behandeling op de tarievenpagina, en bij een gevoelige huid begint dat vaker met minder doen dan met meer. Als de uitkomst is dat je twee weken moet afbouwen, dan hoor je dat in het consult en kost het je verder niets.
  <sub>src/data/gevoelige-huid.ts:237</sub>
...
- De meting kost vijftig euro; de trajecten daarna staan met hun tarief op de tarievenpagina. Blijkt uit de meting dat het pigment diep zit, dan raden we behandelen af en houdt het daar op.
  <sub>src/data/melasma.ts:183</sub>

**Inhoud: snurken** (1)

- Het tarief voor NightLase staat op de tarievenpagina zodra het vastligt.
  <sub>src/data/snurken.ts:170</sub>

### BESLUIT-OKAN (3)

Een keuze die niet aan de bouwer is maar aan de kliniek.
...
- Die blijven in je eigen dossier als beginpunt. Ze worden niet gebruikt op onze site of in advertenties tenzij je daar apart en schriftelijk toestemming voor geeft, en die kun je altijd intrekken.
  <sub>src/data/intake.ts:228</sub>
...
- Merk je dat we ons hier niet aan houden, zeg het dan tegen degene die je behandelt of laat het ons weten. Een verbond dat je niet kunt aanspreken is een advertentie.
  <sub>src/data/verbond.ts:123</sub>
- Komt er iets bij, dan komt het erbij. Wat er staat halen we er niet af zonder het te vermelden.
  <sub>src/data/verbond.ts:145</sub>

### BEELD-NODIG (1)

Hier hoort een foto die er nog niet is.
...
- Net zo talgrijk als de rug, en vaak buiten beeld omdat het onder kleding zit. Zweet, kleding die schuurt en haren of producten die over je borst vallen houden het in stand.
  <sub>src/data/acne-zones.ts:72</sub>
- Kin en kaaklijn samen is het klassieke beeld. Vaak in golven, vaak rond een vast moment in de maand, vaak diepere plekjes die langer blijven zitten.
  <sub>src/data/acne-zones.ts:101</sub>
- Zit het alleen op je wangen, dan kan het iets zijn dat je huid raakt: telefoon, kussensloop, mondkapje, sportband. Maar net zo vaak speelt er hormonaal iets mee, en dat zie je van buiten niet.
  <sub>src/data/acne-zones.ts:126</sub>
- De romp heeft veel talgklieren, en zweet en wrijving van kleding houden het daar in stand. Vaak speelt sport of een warm beroep mee.
  <sub>src/data/acne-zones.ts:137</sub>
...
- Pigment dat dieper in de huid zit. In gewoon licht is dat nauwelijks zichtbaar, en juist die diepte bepaalt wat er mogelijk is.
  <sub>src/data/apparatuur.ts:220</sub>
- [ De EVE-M legt je huid vast en meet. Je gezicht komt in een vaste houder, zodat de afstand en de hoek bij elke opname gelijk zijn, en de belichting komt uit het apparaat zelf en niet uit de kamer., Een telefoonfoto onder ander licht en vanaf een andere afstand kun je niet met een vorige vergelij...
  <sub>src/data/apparatuur.ts:232</sub>
- De EVE-M brengt de conditie van je huid in kaart en maakt zichtbaar wat met het blote oog niet altijd te zien is: beginnende pigmentatie, vochttekort, poriestructuur en tekenen van huidveroudering. Verschillende huidlagen worden geanalyseerd, en door de meting te herhalen wordt voortgang objectie...
  <sub>src/data/apparatuur.ts:241</sub>
- Een manier om de Er:YAG aan te sturen waarbij de energie in een reeks trage pulsen komt in plaats van één harde. Het weefsel warmt daardoor op zonder dat de opperhuid wordt weggenomen: het wordt verwarmd en niet verdampt.
  <sub>src/data/apparatuur.ts:283</sub>
- [ De TimeWalker draagt twee lasers in één kast. Een Er:YAG op 2940 nanometer, die vrijwel volledig door water wordt opgenomen en daardoor aan de oppervlakte blijft. En een Nd:YAG op 1064 nanometer, die veel minder door water wordt tegengehouden en dus dieper komt., Het bijzondere zit in de manier...
  <sub>src/data/apparatuur.ts:298</sub>
- Een laserplatform dat huidveroudering op meerdere niveaus aanpakt: van binnenuit door de mondholte en van buitenaf over de huid. Elke behandeling op dit apparaat mikt op één ding, en daarom er meerdere namen op staan.
  <sub>src/data/apparatuur.ts:309</sub>
- [ Haargroei. Daar staat een ander apparaat voor, Werken op een gebruinde huid
  <sub>src/data/apparatuur.ts:318</sub>
- De alexandriet op 755 nanometer wordt sterk opgenomen door het pigment in een haar, en dat maakt hem gericht op de haarwortel. De Nordlys werkt met een band in plaats van één golflengte en is daardoor breder maar minder precies op haar. Welke je krijgt hangt af van je huidtype en de zone.
  <sub>src/data/apparatuur.ts:383</sub>
- De spotgrootte en de pulsduur worden per zone gekozen, en de huid is niet overal even dik of even gevoelig. Op een kleine, gevoelige zone gaat de behandelaar met een andere instelling te werk dan op een groot vlak.
  <sub>src/data/apparatuur.ts:393</sub>
- Dat hangt af van de instelling. Bij meer pigment in de huid is de marge kleiner, dus beoordeelt de behandelaar het vooraf. Is het niet verantwoord, dan doen we het niet.
  <sub>src/data/apparatuur.ts:398</sub>
- [ De Gentle-serie van Candela werkt met een alexandrietlaser op 755 nanometer. Die golflengte wordt sterk opgenomen door melanine, het pigment dat een haar zijn kleur geeft. Daardoor loopt de energie langs de haarschacht naar de wortel en blijft de huid eromheen relatief onberoerd., De pulsduur i...
  <sub>src/data/apparatuur.ts:404</sub>
- Een laser die ongewenste haargroei bij de kern aanpakt, ingegroeide haren en irritatie vermindert en zorgt voor een langdurig gladde en rustige huid. Wat de energie opneemt warmt op, de rest niet.
  <sub>src/data/apparatuur.ts:414</sub>
- [ Haargroei op vrijwel elke zone van het lichaam, Ingegroeide haren en irritatie van scheren verminderen, Instelbaar op verschillende huidtypes
  <sub>src/data/apparatuur.ts:418</sub>
- [ Pigmentvlekken of textuur. Dat zijn andere apparaten, Grijs of heel licht haar, want daar zit te weinig pigment in
  <sub>src/data/apparatuur.ts:422</sub>
- [ Pigmentvlekken of textuur. Dat zijn andere apparaten, Grijs of heel licht haar, want daar zit te weinig pigment in , Een gebruinde huid
  <sub>src/data/apparatuur.ts:423</sub>
- Dat hoort erbij. Het pigment komt naar de oppervlakte voordat het vervaagt, en dat duurt een aantal dagen. Het betekent niet dat het erger wordt.
  <sub>src/data/apparatuur.ts:473</sub>
- IPL werkt over een groot vlak en dat is juist zijn sterke kant. Of het bij jouw klacht past hangt af van wat er zit en hoe diep.
  <sub>src/data/apparatuur.ts:483</sub>
- IPL stuurt geen enkele golflengte de huid in maar een bereik, met een filter dat het grofste eruit haalt. Daardoor raakt het meerdere doelen tegelijk: roodheid, zichtbare vaatjes en oppervlakkig pigment. Het komt gemiddeld minder diep dan een laser.
  <sub>src/data/apparatuur.ts:499</sub>
- [ Wat diep zit. Daar komt het licht niet, Eén specifiek plekje; daar is een laser preciezer voor, Elk huidtype
  <sub>src/data/apparatuur.ts:508</sub>
- Elke golflengte komt tot een andere diepte. Blauw blijft in de bovenste lagen, rood komt tot in de lederhuid en nabij-infrarood komt het verst, omdat die kleur het minst door de huid wordt tegengehouden.
  <sub>src/data/apparatuur.ts:558</sub>
- Bij roodheid en rosacea plannen mensen het als losse reeks. Verder zetten we het in naast een andere behandeling, waar het de huid tot rust brengt en het herstel ondersteunt.
  <sub>src/data/apparatuur.ts:563</sub>
- Licht werkt cumulatief, dus het verschil ontstaat over een reeks met een paar dagen tot een week ertussen. Hoeveel sessies dat zijn hoor je na de huidanalyse.
  <sub>src/data/apparatuur.ts:573</sub>
- [ LED werkt anders dan een laser of IPL. Die verwarmen een doelwit in de huid, pigment of een vaatje of water, en het resultaat komt uit het herstel dat daarop volgt. LED verwarmt niets: het licht wordt door de huid opgenomen en doet zijn werk in de cel zelf., In elke cel zitten mitochondriën, de...
  <sub>src/data/apparatuur.ts:578</sub>
- [ LED werkt anders dan een laser of IPL. Die verwarmen een doelwit in de huid, pigment of een vaatje of water, en het resultaat komt uit het herstel dat daarop volgt. LED verwarmt niets: het licht wordt door de huid opgenomen en doet zijn werk in de cel zelf., In elke cel zitten mitochondriën, de...
  <sub>src/data/apparatuur.ts:579</sub>
- LED werkt anders dan een laser of IPL. Die verwarmen een doelwit in de huid, pigment of een vaatje of water, en het resultaat komt uit het herstel dat daarop volgt. LED verwarmt niets: het licht wordt door de huid opgenomen en doet zijn werk in de cel zelf., In elke cel zitten mitochondriën, de o...
  <sub>src/data/apparatuur.ts:581</sub>
...
- Een apparaat dat in één behandeling reinigt, de bovenste laag losmaakt, poriën leegzuigt en er daarna werkzame stoffen in brengt. Het blijft aan de oppervlakte, en juist daarom zie je het meteen en merk je er verder niets van.
  <sub>src/data/apparatuur.ts:672</sub>
- Het handstuk beweegt een capsule met een gel over de huid. Die twee reageren met elkaar en er ontstaan kleine CO2-belletjes op de huid. De huid reageert daarop door meer zuurstofrijk bloed naar de plek te sturen, terwijl de capsule de buitenste laag losmaakt en de stoffen uit de gel inbrengt. Het...
  <sub>src/data/apparatuur.ts:724</sub>
- CO2 dat vrijkomt als de capsule met de gel reageert. Je huid reageert daarop met een betere doorbloeding, en dat is precies de bedoeling.
  <sub>src/data/apparatuur.ts:771</sub>
- [ De capsule bevat een bicarbonaat en een zuur. Op de huid, met de gel, ontstaat daaruit CO2. Dat verhoogt tijdelijk het CO2-gehalte in de huid, en het lichaam antwoordt daarop met meer zuurstofrijk bloed naar die plek.
  <sub>src/data/apparatuur.ts:780</sub>
- Omdat die bepaalt in welke laag het kanaaltje eindigt. Ondiep raakt de opperhuid en heelt binnen een dag; drie millimeter komt in het bindweefsel en vraagt langer.
  <sub>src/data/apparatuur.ts:798</sub>
- [ Een microneedling-pen zet een cartridge met naalden in een snelle op-en-neerbeweging. De SkinPen heeft er veertien, en de diepte is instelbaar van een kwart millimeter tot drie millimeter. Dat bereik loopt van net door de hoornlaag tot in het bindweefsel., De diepte is de enige instelling die e...
  <sub>src/data/apparatuur.ts:813</sub>
- Met fijne naalden worden kanaaltjes tot in de bovenste lederhuid gemaakt. De huid reageert daarop met herstel en collageenaanmaak; dat herstel is het doel, de prikjes zijn de aanleiding. Daarom duurt het weken voor je iets ziet.
  <sub>src/data/apparatuur.ts:824</sub>
- [ Kleur op zichzelf, Eén sessie met resultaat, Een huid met actieve ontsteking
  <sub>src/data/apparatuur.ts:833</sub>
- Dat hangt af van de zone en de diepte die daar past, niet van welke beter is. De Dermapen werkt sneller een vlak af en heeft voorgeprogrammeerde standen, waaronder een litteken-instelling op de maximale diepte.
  <sub>src/data/apparatuur.ts:873</sub>
- Een tot drie dagen, ongeveer als een stevige zonnegloed. De eerste vierentwintig uur laat je je huid met rust.
  <sub>src/data/apparatuur.ts:888</sub>
- [ Dezelfde techniek als de SkinPen, met een ander motorontwerp. De Dermapen 4 haalt tot 1920 prikken per seconde en heeft hetzelfde diepteberereik van 0,25 tot 3,0 millimeter, in stappen instelbaar per zone van je gezicht., Het verschil dat je merkt zit in de snelheid waarmee een vlak wordt afgew...
  <sub>src/data/apparatuur.ts:894</sub>
- Een microneedlingapparaat dat met minuscule, trillende naaldjes microscopisch kleine kanaaltjes in de huid maakt om het natuurlijke herstelproces te stimuleren. Dat stimuleert de collageenaanmaak, waardoor de huid steviger, gladder en egaler wordt.
  <sub>src/data/apparatuur.ts:904</sub>
- [ Kleur op zichzelf, Eén sessie met resultaat, Een huid die net iets anders heeft ondergaan
  <sub>src/data/apparatuur.ts:913</sub>
- Dat bepaalt de behandeling en niet het apparaat. Het kan een skinbooster zijn of een mesotherapie-mengsel, en die keuze hoort bij de behandelaar.
  <sub>src/data/apparatuur.ts:963</sub>
- [ De U225 is een injector, geen laser en geen apparaat dat op de huid werkt. Een luchtdruksysteem duwt een instelbare hoeveelheid vloeistof door een fijne naald, op een diepte tussen één en tien millimeter, tot acht keer per seconde., Wat hem onderscheidt van met de hand injecteren is dat alleen ...
  <sub>src/data/apparatuur.ts:974</sub>
- Bij mesotherapie worden werkzame stoffen direct in de huid gebracht. De U225 doet dat automatisch en regelmatig; de naald zit los van de spuit gemonteerd, wat de precisie van de toediening verbetert. Er zijn verschillende skinboosters, ook een depigmentatiebooster voor gezicht, hals en décolleté.
  <sub>src/data/apparatuur.ts:984</sub>
- [ Volume opbouwen zoals een filler dat doet, Haargroei verwijderen, Zwangerschap en borstvoeding
  <sub>src/data/apparatuur.ts:993</sub>
- Vaak wel, want er komen geen zuren aan te pas. Bij actieve ontstekingen of een beschadigde barrière doen we het niet.
  <sub>src/data/apparatuur.ts:1049</sub>
- Dode huidcellen en donshaartjes worden verwijderd met een chirurgisch mesje onder een hoek van 45 graden. Er komen geen zuren aan te pas, waardoor het ook kan bij een gevoelige, droge of allergische huid en tijdens de zwangerschap. Het is pijnloos en het resultaat is meteen zichtbaar.
  <sub>src/data/apparatuur.ts:1066</sub>
- Bij een lichte peeling meestal niet, bij een sterkere wel. Dat hoor je vooraf, want het bepaalt wanneer je dit het beste inplant.
  <sub>src/data/apparatuur.ts:1126</sub>
- Bij pigment liever niet, en bij de sterkere lijnen ook niet. Zon na een peeling is precies de combinatie die het resultaat kost.
  <sub>src/data/apparatuur.ts:1131</sub>
- [ Een peeling is geen apparaat maar een vloeistof, en wat hij doet hangt af van drie dingen: welk zuur erin zit, hoe geconcentreerd het is en hoe zuur het mengsel als geheel is. Die drie samen bepalen hoe diep het komt., Fruitzuren blijven in de hoornlaag en spoelen er na een paar minuten weer af...
  <sub>src/data/apparatuur.ts:1137</sub>
- De kliniek werkt met peelings van Skin Tech Pharma, Dermaceutic, ADO en Mesoestetic, in drie niveaus. Welke er gekozen wordt hangt af van hoe je huid er op dat moment voor staat. De inwerktijd wordt daarop afgemeten: te lang is niet beter maar schadelijker.
  <sub>src/data/apparatuur.ts:1147</sub>
- [ Littekens dieper dan de opperhuid, Zwangerschap en borstvoeding
  <sub>src/data/apparatuur.ts:1155</sub>
- [ Littekens dieper dan de opperhuid, Zwangerschap en borstvoeding , Vlak voor veel zon
  <sub>src/data/apparatuur.ts:1156</sub>
...
- Een chemische peeling is een behandeling waarbij een zuur de verbinding tussen de buitenste huidcellen losmaakt, zodat die laag sneller wordt vervangen. Bij Diba Clinics in Rotterdam werken we met vier merken in drie sterktes. Een peeling kost vanaf ${euro(PE.prijs)} en duurt ${PE.duurMinuten} mi...
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:46</sub>
- [ Je huid vervangt zijn bovenste laag voortdurend, maar niet altijd even snel. Blijven de oude cellen te lang zitten, dan voelt je huid ruw, ziet hij er dof uit, raken poriën verstopt en blijft oppervlakkige verkleuring langer staan dan nodig.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:70</sub>
- [ Je huid vervangt zijn bovenste laag voortdurend, maar niet altijd even snel. Blijven de oude cellen te lang zitten, dan voelt je huid ruw, ziet hij er dof uit, raken poriën verstopt en blijft oppervlakkige verkleuring langer staan dan nodig. , Een peeling maakt de verbinding tussen die buitenst...
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:71</sub>
- [ We werken met peelings van [Skin Tech Pharma, Dermaceutic, ADO en Mesoestetic](/apparatuur/peelinglijnen), in drie niveaus. De lichtste werken op de bovenlaag en laten je meestal niet zichtbaar vervellen. De sterkste, zoals de TCA-peeling van Dermaceutic in 12 tot 20 procent, gaan dieper en vra...
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:86</sub>
- [ We werken met peelings van [Skin Tech Pharma, Dermaceutic, ADO en Mesoestetic](/apparatuur/peelinglijnen), in drie niveaus. De lichtste werken op de bovenlaag en laten je meestal niet zichtbaar vervellen. De sterkste, zoals de TCA-peeling van Dermaceutic in 12 tot 20 procent, gaan dieper en vra...
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:87</sub>
- [ We werken met peelings van [Skin Tech Pharma, Dermaceutic, ADO en Mesoestetic](/apparatuur/peelinglijnen), in drie niveaus. De lichtste werken op de bovenlaag en laten je meestal niet zichtbaar vervellen. De sterkste, zoals de TCA-peeling van Dermaceutic in 12 tot 20 procent, gaan dieper en vra...
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:88</sub>
- Peelings werken meestal in een reeks van vier tot zes, met twee tot vier weken ertussen. Hoeveel het er bij jou worden, hoor je na de meting.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:111</sub>
- [ Oppervlakkige verkleuring, en pigment dat na een puistje is achtergebleven, Een ruwe huid en een doffe textuur, Verstopte poriën, doordat de bovenlaag sneller vernieuwt, Ontstoken acne, met de kruidenpeel of een peeling die daarop is afgestemd
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:125</sub>
- [ Littekens die dieper zitten dan de opperhuid. Daarvoor kies je microneedling, Hardnekkig pigment of melasma. Daar zijn Cosmelan en Dermamelan de zwaardere trajecten
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:129</sub>
- [ Littekens die dieper zitten dan de opperhuid. Daarvoor kies je microneedling, Hardnekkig pigment of melasma. Daar zijn Cosmelan en Dermamelan de zwaardere trajecten , Peelen vlak voor veel zon, of bij pigment in de zomermaanden
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:130</sub>
- [ Littekens die dieper zitten dan de opperhuid. Daarvoor kies je microneedling, Hardnekkig pigment of melasma. Daar zijn Cosmelan en Dermamelan de zwaardere trajecten , Peelen vlak voor veel zon, of bij pigment in de zomermaanden , Tijdens een zwangerschap of in de periode dat je borstvoeding geeft
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:131</sub>
- Een zuur maakt de bovenlaag los. Drie sterktes, van nauwelijks vervellen tot een paar dagen schilferen., ), vergelijkingsrij( kruidenpeel, Kruiden in plaats van zuur. Remt de ontsteking en werkt antibacterieel, en daarom vooral bij ontstoken acne.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:150</sub>
- Reinigt en zuigt poriën leeg, zonder zuur en zonder vervellen. Minder effect op verkleuring, en het resultaat zie je meteen., ), vergelijkingsrij( skinpen, Werkt met naalden in de lederhuid, dieper dan een peeling. Voor littekens en structuur.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:158</sub>
- Bij een lichte peeling meestal niet, bij een sterkere wel. Reken bij de sterkere varianten op twee tot vijf dagen droog en schilferig. Dat hoor je vooraf, want het bepaalt wanneer je de behandeling het beste inplant.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:194</sub>
- Bij pigment liever niet, en bij de sterkere peelings ook niet. Zon op een huid die net gepeeld is, is precies de combinatie die het resultaat kost. Een lichte peeling voor de textuur kan soms wel, met strikte zonbescherming.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:199</sub>
- Meestal een reeks van vier tot zes, met twee tot vier weken ertussen. Hoeveel het er bij jou worden, hangt af van je huid en van hoe die reageert; dat meten we tussendoor.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:204</sub>
- Ja, peelings zijn bij acne een van de belangrijkste middelen. Bij ontstoken acne werken we met chemische peelings en met de kruidenpeel, die ook antibacterieel werkt. Littekens pakken we pas aan als de huid rustig is.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:209</sub>
- Bij oppervlakkige verkleuring wel, zoals de vlekken die na een puistje achterblijven. Zit het pigment dieper of is het melasma, dan is een traject als Cosmelan of Dermamelan het passender antwoord. Welke van de twee het is, stellen we vast met een meting.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:214</sub>
- Ja, en het vraagt een andere aanpak. Bij huidtype IV tot VI is de kans op nieuwe pigmentvlekken door de behandeling groter, dus kiezen we de sterkte voorzichtiger en bouwen we trager op. Dat bespreken we vooraf.
  <sub>src/data/landings/chemische-peeling-rotterdam.ts:219</sub>

**Inhoud: cosmelan-dermamelan-rotterdam** (24)

- Cosmelan en Dermamelan zijn trajecten van ongeveer zes maanden tegen hardnekkig pigment: een masker in de kliniek, en daarna een vaste routine met producten thuis. Dermamelan is de sterkste van de twee en wordt vaker bij melasma ingezet. Bij Diba Clinics in Rotterdam kost Cosmelan ${euro(CO.prijs...
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:50</sub>
- [ Pigment wordt aangemaakt door cellen in de onderste laag van de opperhuid. Bij hardnekkig pigment staan die cellen als het ware harder aan dan nodig, door zon, hormonen en aanleg. Haal je alleen weg wat er zit, dan maken ze het in de maanden erna gewoon opnieuw aan.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:74</sub>
- [ Pigment wordt aangemaakt door cellen in de onderste laag van de opperhuid. Bij hardnekkig pigment staan die cellen als het ware harder aan dan nodig, door zon, hormonen en aanleg. Haal je alleen weg wat er zit, dan maken ze het in de maanden erna gewoon opnieuw aan. , Cosmelan en Dermamelan wer...
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:75</sub>
- [ Pigment wordt aangemaakt door cellen in de onderste laag van de opperhuid. Bij hardnekkig pigment staan die cellen als het ware harder aan dan nodig, door zon, hormonen en aanleg. Haal je alleen weg wat er zit, dan maken ze het in de maanden erna gewoon opnieuw aan. , Cosmelan en Dermamelan wer...
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:76</sub>
- [ Cosmelan is de lichtere van de twee. Hij wordt vaker gekozen bij zonschade en losse pigmentvlekken: scherp afgebakende vlekken op de plekken waar de zon komt. Voor dat soort pigment is hij sterk genoeg.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:90</sub>
- [ Cosmelan is de lichtere van de twee. Hij wordt vaker gekozen bij zonschade en losse pigmentvlekken: scherp afgebakende vlekken op de plekken waar de zon komt. Voor dat soort pigment is hij sterk genoeg. , Dermamelan is intensiever en wordt vaker ingezet bij melasma: symmetrische, wolkachtige vl...
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:91</sub>
- [ Cosmelan is de lichtere van de twee. Hij wordt vaker gekozen bij zonschade en losse pigmentvlekken: scherp afgebakende vlekken op de plekken waar de zon komt. Voor dat soort pigment is hij sterk genoeg. , Dermamelan is intensiever en wordt vaker ingezet bij melasma: symmetrische, wolkachtige vl...
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:92</sub>
- Liever in het najaar, zodat je maanden met weinig zon voor je hebt. Tussen mei en augustus beginnen we geen pigmenttraject. Plan de start ook niet vlak voor een vakantie of een drukke week, want na een paar dagen ga je vervellen.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:124</sub>
- [ Hardnekkig pigment waar losse behandelingen op stuklopen
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:137</sub>
- [ Hardnekkig pigment waar losse behandelingen op stuklopen , Melasma, met Dermamelan, waarbij beheersen het eerlijke doel is
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:138</sub>
- [ Hardnekkig pigment waar losse behandelingen op stuklopen , Melasma, met Dermamelan, waarbij beheersen het eerlijke doel is , Zonschade en losse pigmentvlekken, met Cosmelan
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:139</sub>
- [ Hardnekkig pigment waar losse behandelingen op stuklopen , Melasma, met Dermamelan, waarbij beheersen het eerlijke doel is , Zonschade en losse pigmentvlekken, met Cosmelan , Donkere verkleuring in de lies- en bikinizone, met Dermamelan Intimate
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:140</sub>
- [ Zonder het schema thuis. Dat is het grootste deel van het traject, en zonder loopt het vast, Starten in de zomer. Tussen mei en augustus beginnen we niet
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:144</sub>
- [ Zonder het schema thuis. Dat is het grootste deel van het traject, en zonder loopt het vast, Starten in de zomer. Tussen mei en augustus beginnen we niet , Zonder dagelijkse zonbescherming. Zon brengt het pigment terug, Een belofte dat melasma voorgoed weggaat. Het blijft iets dat terug kan komen
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:146</sub>
- Het lichtere traject van zes maanden, vaker bij zonschade en losse vlekken., ), vergelijkingsrij( dermamelan, Het intensievere traject, vaker bij melasma, met een strakker schema thuis.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:165</sub>
- Het intensievere traject, vaker bij melasma, met een strakker schema thuis. , ), vergelijkingsrij( nordlys-pigment, Licht op scherp afgebakende vlekken, in een reeks losse behandelingen. Niet de eerste keuze bij melasma.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:169</sub>
- Licht op scherp afgebakende vlekken, in een reeks losse behandelingen. Niet de eerste keuze bij melasma. , ), vergelijkingsrij( peelings, Een zuur op de bovenlaag, voor oppervlakkige verkleuring, in een reeks.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:173</sub>
- Een zuur op de bovenlaag, voor oppervlakkige verkleuring, in een reeks. , ), vergelijkingsrij( skinboosters, De depigmentatiebooster brengt stoffen in de huid, meestal als kuur van drie.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:177</sub>
- Dezelfde opzet, een andere sterkte en een ander doel. Cosmelan is de lichtere en wordt vaker gekozen bij zonschade en losse pigmentvlekken; Dermamelan is intensiever en wordt vaker ingezet bij melasma. Welke bij jou past, stelt de behandelaar vast bij de intake.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:197</sub>
- Ja. Na een paar dagen gaat je huid vervellen en is hij rood. Plan het begin daarom niet vlak voor een vakantie of een belangrijke datum.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:207</sub>
- Omdat je dan maanden tegen de zon in werkt. Pigmentcellen die net zijn aangepakt reageren extra fel op UV, en dan betaal je voor een resultaat dat je in september kwijt bent. Tussen mei en augustus beginnen we daarom geen pigmenttraject.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:212</sub>
- Niet voorgoed. Melasma blijft iets dat terug kan komen, vooral na de zomer. Dermamelan kan het rustig krijgen, en met zonbescherming en het schema thuis houd je het zo. Beheersen is bij melasma het eerlijke doel.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:217</sub>
- Vaak wel, en het vraagt een andere aanpak. Bij huidtype IV tot VI is de kans op nieuwe pigmentvlekken groter, dus kijken we vooraf extra goed en bouwen we voorzichtig op. Dat bespreken we bij de intake.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:222</sub>
- Nee, tijdens een zwangerschap en in de periode dat je borstvoeding geeft beginnen we er niet aan. Pigment verandert in die tijd bovendien vaak vanzelf, en dan is wachten de beste keuze.
  <sub>src/data/landings/cosmelan-dermamelan-rotterdam.ts:227</sub>
...
**Inhoud: dermaplaning-rotterdam** (13)

- Dermaplaning is een behandeling waarbij een chirurgisch mesje onder een vaste hoek dode huidcellen en donshaartjes van je gezicht haalt. Er komen geen zuren aan te pas. Bij Diba Clinics in Rotterdam duurt een behandeling ${DP.duurMinuten} minuten en kost hij ${euro(DP.prijs)}; je huid is meteen g...
  <sub>src/data/landings/dermaplaning-rotterdam.ts:34</sub>
- [ De buitenste laag van je huid bestaat uit dode cellen die vanzelf loslaten, maar niet altijd even vlot. Daartussen zitten de fijne, lichte donshaartjes die bijna iedereen op het gezicht heeft. Samen maken ze het oppervlak ruwer dan het hoeft te zijn, en make-up blijft er eerder in hangen dan da...
  <sub>src/data/landings/dermaplaning-rotterdam.ts:58</sub>
- [ De buitenste laag van je huid bestaat uit dode cellen die vanzelf loslaten, maar niet altijd even vlot. Daartussen zitten de fijne, lichte donshaartjes die bijna iedereen op het gezicht heeft. Samen maken ze het oppervlak ruwer dan het hoeft te zijn, en make-up blijft er eerder in hangen dan da...
  <sub>src/data/landings/dermaplaning-rotterdam.ts:60</sub>
- [ Scheren en dermaplaning veranderen de haarschacht niet, alleen het uiteinde. Een haar dat nog nooit is afgesneden heeft een dunne, zachte punt. Na het afsnijden is die punt recht, en een recht uiteinde voelt de eerste dagen stugger aan. Dat is wat mensen voor dikker haar aanzien., Het haar groe...
  <sub>src/data/landings/dermaplaning-rotterdam.ts:76</sub>
- Dermaplaning gaat goed samen met een behandeling die daarna op een gladde huid werkt, zoals een peeling of een HydraFacial. Wat er in jouw geval bij past, bespreken we bij de intake.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:93</sub>
- [ Pigment of littekens die dieper zitten. Daarvoor kies je laser of microneedling, Blijvend minder haar. De donshaartjes groeien terug zoals ze waren, Een huid met actieve ontstekingen of een beschadigde barrière. Dan doen we het niet
  <sub>src/data/landings/dermaplaning-rotterdam.ts:112</sub>
- [ Pigment of littekens die dieper zitten. Daarvoor kies je laser of microneedling, Blijvend minder haar. De donshaartjes groeien terug zoals ze waren, Een huid met actieve ontstekingen of een beschadigde barrière. Dan doen we het niet , Verschil dat blijft. Het effect duurt tot de laag dode celle...
  <sub>src/data/landings/dermaplaning-rotterdam.ts:113</sub>
- Reinigt en zuigt poriën leeg met onderdruk en brengt stoffen terug. Werkt ook op wat er in de porie zit., ), vergelijkingsrij( oxygeneo, Maakt de bovenlaag los met een gel en een capsule, waarbij je huid een prikkel krijgt voor de doorbloeding.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:136</sub>
- Maakt de bovenlaag los met een gel en een capsule, waarbij je huid een prikkel krijgt voor de doorbloeding. , ), vergelijkingsrij( peelings, Een zuur maakt de bovenlaag los en gaat dieper. Meer effect op verkleuring, en meer reactie van je huid.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:140</sub>
- Nee. Je voelt het mesje in korte halen over je huid gaan, en je hoort vooral een zacht schrapen. Het is een van de rustigste behandelingen die we doen.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:172</sub>
- Los, of elke vier tot zes weken als onderhoud. In die tijd is de laag dode cellen weer opgebouwd en staan de donshaartjes er weer.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:182</sub>
- Meestal wel, want er komen geen zuren of andere middelen aan te pas. Vertel het ons wel bij de intake, dan houden we er rekening mee bij wat er verder op je huid komt.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:187</sub>
- Vaak wel, want er komen geen zuren aan te pas. Bij actieve ontstekingen of een beschadigde barrière doen we het niet. Of het bij jou kan, bepaalt de behandelaar bij de intake.
  <sub>src/data/landings/dermaplaning-rotterdam.ts:192</sub>

**Inhoud: doffe-huid** (12)
...
- De bovenste laag vernieuwt trager dan vroeger, waardoor er cellen blijven liggen die het licht verstrooien in plaats van weerkaatsen. Dit is de meest voorkomende oorzaak.
  <sub>src/data/doffe-huid.ts:63</sub>
- Een huid met te weinig water in de bovenste laag ligt niet glad, en een oneffen oppervlak oogt dof. Los van hoeveel talg je maakt.
  <sub>src/data/doffe-huid.ts:76</sub>
- Eerst de barrière herstellen. Blijft de huid dof, dan microneedling: dat zet de vernieuwing van opperhuid en lederhuid in gang, en daar krijgt een uitgedroogde huid zijn glans van terug.
  <sub>src/data/doffe-huid.ts:78</sub>
- Pigment dat ongelijkmatig verdeeld ligt. Je oog leest een ongelijke tint als vermoeid, ook al is er nergens een vlek aan te wijzen.
  <sub>src/data/doffe-huid.ts:90</sub>
- Doorbloeding en herstel lopen terug bij slaaptekort, roken en te weinig drinken, en dat zie je het eerst aan je gezicht.
  <sub>src/data/doffe-huid.ts:103</sub>
- [ Eerst uitzoeken of het om cellen, vocht, kleur of leefstijl gaat, want dat scheelt een traject, De vernieuwing op gang helpen met een peeling of microneedling, in een tempo dat je huid aankan, Eerlijk zeggen dat het effect van een gezichtsbehandeling op dofheid vaak tijdelijk is, Zonbescherming...
  <sub>src/data/doffe-huid.ts:143</sub>
- [ Dagelijks scrubben. Je haalt de barrière weg, en een beschadigde barrière oogt doffer
  <sub>src/data/doffe-huid.ts:147</sub>
- [ Dagelijks scrubben. Je haalt de barrière weg, en een beschadigde barrière oogt doffer , Een lang traject starten terwijl een aanpassing in verzorging of gewoonten voldoende kan zijn, Een vette huid uitdrogen om hem minder dof te maken. Die reageert met meer talg
  <sub>src/data/doffe-huid.ts:149</sub>
- Het effect van een behandeling op dofheid zakt na verloop van tijd. Dat is normaal en geen reden om steeds dieper te gaan. Wie die trap opgaat houdt een geïrriteerde huid over die juist doffer oogt.
  <sub>src/data/doffe-huid.ts:164</sub>
...
- Bij dofheid is het effect vaak direct zichtbaar en meestal een aantal weken merkbaar. Dat is geen tekortkoming zolang je het weet: eens in de zoveel weken glans kopen is een legitieme keuze. Het wordt pas een probleem als je denkt een oorzaak te behandelen.
  <sub>src/data/doffe-huid.ts:177</sub>
...
- De barrière lekt water én mist het vet om dat tegen te houden. Vaak is er een aanjager: koud weer, te warm douchen, of een routine die te stevig is geworden.
  <sub>src/data/droge-huid.ts:73</sub>
- [ Meer actieve stoffen stapelen omdat het niet beter wordt. Dat is bij een lekkende barrière de snelste weg naar erger., Scrubben tegen schilfers. Je haalt het laagje weg dat het water nog binnenhield., Elke week iets nieuws proberen. Een huid heeft weken nodig, dus je meet steeds het vorige prod...
  <sub>src/data/droge-huid.ts:139</sub>
...
- Door de kapotte barrière komen stoffen naar binnen die er normaal niet doorheen komen, en het afweersysteem reageert daarop.
  <sub>src/data/eczeem.ts:64</sub>
- [ Naar de huisarts bij aanhoudende jeuk, kloofjes of plekken die terugkomen. Dit is een aandoening met behandeling, en die begint daar., Dagelijks blijven insmeren, ook op de dagen dat er niets te zien is. Dat is bij eczeem de basis en geen bijzaak.
  <sub>src/data/eczeem.ts:109</sub>
- [ Wachten met de huisarts omdat je eerst een crème wilt proberen. Hoe langer de cirkel draait, hoe moeilijker hij te doorbreken is., Stoppen met een voorgeschreven zalf zodra het beter gaat, zonder dat met je arts te overleggen., Zeep en heet water gebruiken op een plek die al kapot is., Zelf dië...
  <sub>src/data/eczeem.ts:118</sub>
- Bij kinderen verdwijnt het vaak grotendeels. Bij volwassenen gaat het meestal in periodes, met rustige tijden en opvlammingen. Dat betekent niet dat er niets aan te doen is, wel dat het beheerd wordt.
  <sub>src/data/eczeem.ts:150</sub>
- Je bent overdag afgeleid en s avonds niet, en de huid is dan ook warmer. Daar komt bij dat je in je slaap krabt zonder het te merken.
  <sub>src/data/eczeem.ts:159</sub>
...
**Inhoud: elektrische-epilatie-rotterdam** (13)

- Elektrische epilatie is een ontharingsmethode waarbij een dun naaldje langs de haar de wortel bereikt en die met een korte stroomstoot uitschakelt, haar voor haar. Omdat kleur er niet toe doet, werkt het ook op grijs, wit en licht blond haar waar de laser niet op reageert. Bij Diba Clinics in Rot...
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:45</sub>
- [ De laser mikt op het pigment in de haarwortel. Zit daar geen pigment meer, zoals bij grijs, wit en heel licht blond haar, dan is er niets om op te mikken. Dat ligt niet aan het apparaat of aan de instelling; zo werkt laserontharing.
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:69</sub>
- [ De laser mikt op het pigment in de haarwortel. Zit daar geen pigment meer, zoals bij grijs, wit en heel licht blond haar, dan is er niets om op te mikken. Dat ligt niet aan het apparaat of aan de instelling; zo werkt laserontharing. , Bij elektrische epilatie gaat er een dun naaldje langs de ha...
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:70</sub>
- [ De laser mikt op het pigment in de haarwortel. Zit daar geen pigment meer, zoals bij grijs, wit en heel licht blond haar, dan is er niets om op te mikken. Dat ligt niet aan het apparaat of aan de instelling; zo werkt laserontharing. , Bij elektrische epilatie gaat er een dun naaldje langs de ha...
...
- [ Grote vlakken zoals benen of rug. Daar is laserontharing sneller en voordeliger, Een vol gebied in weinig sessies. Het gaat per haar, dus het vraagt meer tijd, Resultaat na één afspraak. Het bouwt op over de reeks, Een huid die op dat moment geïrriteerd of ontstoken is
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:124</sub>
- Haar voor haar, via de wortel. Werkt op elke haarkleur, en daardoor ook op grijs en wit., ), vergelijkingsrij( laserontharing, Licht op het pigment in de wortel. Snel over een groot vlak, maar alleen op haar met kleur.
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:143</sub>
- Je voelt per haar een korte prik, en daarna een warm gevoel op die plek. Het is goed te doen, maar omdat het haar voor haar gaat, is een langere sessie wel merkbaar.
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:172</sub>
- Een haar waarvan de wortel goed is uitgeschakeld, komt niet terug. Omdat haren niet allemaal tegelijk in de groeifase zitten, heb je wel een reeks afspraken nodig om een gebied rustig te krijgen. Hoeveel verschilt per persoon.
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:177</sub>
- De behandelde plekjes zijn een paar uur rood en kunnen wat opstaan, vergelijkbaar met na het harsen. Bij de meeste mensen is dat dezelfde dag weg.
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:192</sub>
- Voor de lichte haren die de laser niet ziet, ja. Bij PCOS blijft je lichaam nieuwe haren aanmaken, dus bij laser en bij epilatie hoort dan onderhoud. Meer daarover staat op onze pagina over PCOS.
  <sub>src/data/landings/elektrische-epilatie-rotterdam.ts:197</sub>

**Inhoud: fitzpatrick-huidtype** (22)

- Verbranden gaat hier sneller dan verkleuren. Zonbescherming is het aandachtspunt, voor en na een behandeling.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:43</sub>
- Weinig kans dat er pigment achterblijft na een behandeling. De huid wordt wel snel rood en dat trekt weer weg.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:44</sub>
- Vanaf hier telt je voorgeschiedenis mee: bleef er eerder een vlek achter na een puist of een wondje, zeg dat dan.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:45</sub>
- De kans op nieuw pigment na een behandeling is groter. We bouwen de sterkte trager op en beginnen lager.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:46</sub>
- IPL is hier vaak niet de juiste keuze, omdat de huid zelf te veel licht opneemt. Laser en peeling gaan met beleid.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:47</sub>
- Energie en sterkte gaan omlaag en een proefplek hoort erbij. Wat hier telt is geduld en niet meer vermogen.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:48</sub>
- Het Fitzpatrick-huidtype is een indeling in zes types die zegt hoe je huid op zon reageert: type I verbrandt vrijwel altijd en wordt nauwelijks bruin, type VI verbrandt zelden. Voor laser, IPL en peelings bepaalt je type niet óf iets kan, maar met welke golflengte, welke energie en hoe voorzichti...
  <sub>src/data/landings/fitzpatrick-huidtype.ts:70</sub>
- [ De schaal is in 1975 bedacht door de Amerikaanse dermatoloog Thomas Fitzpatrick, en hij is er gekomen omdat een behandeling met licht anders uitpakt bij de ene huid dan bij de andere. De vraag was dus niet hoe iemand eruitziet, maar hoeveel licht zijn huid opneemt en wat er daarna gebeurt.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:94</sub>
- [ De schaal is in 1975 bedacht door de Amerikaanse dermatoloog Thomas Fitzpatrick, en hij is er gekomen omdat een behandeling met licht anders uitpakt bij de ene huid dan bij de andere. De vraag was dus niet hoe iemand eruitziet, maar hoeveel licht zijn huid opneemt en wat er daarna gebeurt. , Je...
  <sub>src/data/landings/fitzpatrick-huidtype.ts:95</sub>
- [ De schaal is in 1975 bedacht door de Amerikaanse dermatoloog Thomas Fitzpatrick, en hij is er gekomen omdat een behandeling met licht anders uitpakt bij de ene huid dan bij de andere. De vraag was dus niet hoe iemand eruitziet, maar hoeveel licht zijn huid opneemt en wat er daarna gebeurt. , Je...
  <sub>src/data/landings/fitzpatrick-huidtype.ts:96</sub>
- [ Een ontharingslaser zoekt het pigment in de haarwortel. Het licht moet daar komen zonder onderweg te veel te worden opgenomen door de huid erboven. Bij een lichte huid is dat verschil groot en gaat vrijwel alle energie naar de wortel; bij een donkere huid is het verschil kleiner en moet de golf...
  <sub>src/data/landings/fitzpatrick-huidtype.ts:111</sub>
- [ Een ontharingslaser zoekt het pigment in de haarwortel. Het licht moet daar komen zonder onderweg te veel te worden opgenomen door de huid erboven. Bij een lichte huid is dat verschil groot en gaat vrijwel alle energie naar de wortel; bij een donkere huid is het verschil kleiner en moet de golf...
  <sub>src/data/landings/fitzpatrick-huidtype.ts:114</sub>
- [ Welke golflengte bij ontharen de veilige en de efficiënte keuze is, Hoe voorzichtig de sterkte van een peeling wordt opgebouwd
  <sub>src/data/landings/fitzpatrick-huidtype.ts:128</sub>
- [ Welke golflengte bij ontharen de veilige en de efficiënte keuze is, Hoe voorzichtig de sterkte van een peeling wordt opgebouwd , Hoe groot de kans is dat er na een behandeling pigment achterblijft
  <sub>src/data/landings/fitzpatrick-huidtype.ts:129</sub>
- [ Welke golflengte bij ontharen de veilige en de efficiënte keuze is, Hoe voorzichtig de sterkte van een peeling wordt opgebouwd , Hoe groot de kans is dat er na een behandeling pigment achterblijft , Of een proefplek vooraf hoort, en hoe lang we die laten staan
  <sub>src/data/landings/fitzpatrick-huidtype.ts:130</sub>
- [ Of een behandeling kan. Op elk type wordt hier behandeld, met een andere instelling, Hoe gevoelig, droog of vet je huid is. Dat is iets anders en dat meten we apart, Hoeveel sessies je nodig hebt. Dat hangt vooral af van de zone en van je haar, Wat je huid vandaag aankan. Een gebruinde huid van...
  <sub>src/data/landings/fitzpatrick-huidtype.ts:136</sub>
- Door twee vragen te beantwoorden over de eerste zon van het jaar: verbrand je, en word je daarna bruin? Verbrand je altijd en word je nooit bruin, dan zit je bij type I of II. Verbrand je zelden en word je makkelijk bruin, dan bij type IV of hoger. Twijfel je, dan is dat geen probleem: bij de int...
  <sub>src/data/landings/fitzpatrick-huidtype.ts:167</sub>
- Ja, de GentleMax Pro werkt op type I tot en met VI. Je type bepaalt niet of het kan, maar met welke golflengte, welke energie en welke koeling er gewerkt wordt. Bij de donkere types gaat dat met de Nd:YAG en met een proefplek vooraf.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:172</sub>
- Je type zelf niet, je huid op dat moment wel. Een gebruinde huid bevat verse kleur die licht opneemt, en dan wordt er anders ingesteld of even gewacht. Hoeveel weken dat vraagt hoor je bij de intake, want dat verschilt per huid.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:182</sub>
- Bij type IV tot en met VI is de kans groter dat er na een peeling pigment achterblijft. Daarom kiezen we de sterkte voorzichtiger, bouwen we trager op en bespreken we vooraf wat je huid eerder deed na een ontsteking of een wondje.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:187</sub>
- Vaak niet. IPL stuurt een bundel golflengtes tegelijk, en een huid met veel eigen pigment neemt daar te veel van op. Bij een donkere huid kiezen we daarom meestal een andere behandeling, en wat dat is hangt af van waarvoor je komt.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:192</sub>
- Omdat de schaal een indeling is en geen meting van jouw huid. Twee mensen van hetzelfde type kunnen anders reageren op dezelfde energie. Een proefplek laat zien wat jouw huid doet, en dat weegt zwaarder dan het getal.
  <sub>src/data/landings/fitzpatrick-huidtype.ts:202</sub>

**Inhoud: fotona-4d-rotterdam** (16)

- Fotona 4D is een laserbehandeling in vier stappen in één sessie: eerst van binnenuit door de wang, daarna op diepte in de huid, en tot slot een lichte laserpeeling. Samen werken ze op verslapping, textuur en kleur, zonder naalden. Bij Diba Clinics in Rotterdam duurt een behandeling ${F4.duurMinut...
  <sub>src/data/landings/fotona-4d-rotterdam.ts:45</sub>
- [ Met de jaren maakt je huid minder collageen aan, het bindweefsel dat hem stevig houdt. Dat zie je als verslapping langs de kaaklijn, fijne lijntjes en een huid die minder egaal is. Die veranderingen zitten op verschillende diepten, en daarom werkt Fotona 4D ook op verschillende diepten.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:69</sub>
- [ Met de jaren maakt je huid minder collageen aan, het bindweefsel dat hem stevig houdt. Dat zie je als verslapping langs de kaaklijn, fijne lijntjes en een huid die minder egaal is. Die veranderingen zitten op verschillende diepten, en daarom werkt Fotona 4D ook op verschillende diepten. , Het b...
  <sub>src/data/landings/fotona-4d-rotterdam.ts:70</sub>
- [ Met de jaren maakt je huid minder collageen aan, het bindweefsel dat hem stevig houdt. Dat zie je als verslapping langs de kaaklijn, fijne lijntjes en een huid die minder egaal is. Die veranderingen zitten op verschillende diepten, en daarom werkt Fotona 4D ook op verschillende diepten. , Het b...
  <sub>src/data/landings/fotona-4d-rotterdam.ts:71</sub>
- [ In de kast zitten twee lasers. Een Er:YAG op 2940 nanometer, die bijna volledig door water wordt opgenomen en daardoor aan de oppervlakte blijft. En een Nd:YAG op 1064 nanometer, die veel minder door water wordt tegengehouden en dus dieper komt. Samen dekken ze een bereik dat één laser niet haa...
  <sub>src/data/landings/fotona-4d-rotterdam.ts:86</sub>
- [ In de kast zitten twee lasers. Een Er:YAG op 2940 nanometer, die bijna volledig door water wordt opgenomen en daardoor aan de oppervlakte blijft. En een Nd:YAG op 1064 nanometer, die veel minder door water wordt tegengehouden en dus dieper komt. Samen dekken ze een bereik dat één laser niet haa...
  <sub>src/data/landings/fotona-4d-rotterdam.ts:87</sub>
- [ Beginnende verslapping, vooral langs de kaaklijn en rond de mond
  <sub>src/data/landings/fotona-4d-rotterdam.ts:126</sub>
- [ Huid die echt is gaan hangen. Daarvoor is chirurgie het antwoord
  <sub>src/data/landings/fotona-4d-rotterdam.ts:132</sub>
- [ Huid die echt is gaan hangen. Daarvoor is chirurgie het antwoord , Resultaat in één keer. Het effect bouwt zich op over de reeks, Een dag waarop je er meteen weer onberispelijk uit moet zien. Reken op een paar uur tot een dag rood en warm
  <sub>src/data/landings/fotona-4d-rotterdam.ts:134</sub>
- Hetzelfde protocol met de hals en de kaaklijn erbij, in een afspraak van twee uur., ), vergelijkingsrij( vectorlift, Laser op het voorhoofd en rond de wenkbrauw, voor wie vooral daar verslapping ziet.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:158</sub>
- Laser rond de oogcontour, voor kraaienpootjes en fijne lijntjes., ), vergelijkingsrij( skinboosters, Werkzame stoffen in de huid met naalden. Werkt op vocht en stevigheid, zonder warmte.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:166</sub>
- Het is warm. De eerste stap gebeurt in je mond en voelt warm tegen je wang; daarna loopt de warmte aan de buitenkant op tot net voor het ongemakkelijke. De behandelaar vraagt tijdens de sessie hoe het voelt en stelt het apparaat daarop bij. De laatste stap voelt als korte tikjes.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:191</sub>
- Weinig. Je bent een paar uur tot een dag rood en warm, alsof je te lang in de zon hebt gezeten. Bij het volledige pakket kan de huid door de afsluitende peeling een paar dagen ruw aanvoelen.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:196</sub>
- Direct na de sessie ziet de huid er voller uit door de warmte, maar dat is nog geen resultaat. De opbouw van collageen kost weken; het verschil bouwt zich over de reeks op.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:201</sub>
- Los te doen of als kuur van drie, met vier tot zes weken ertussen. Bij het volledige pakket volgt na de kuur meestal een keer per jaar onderhoud. Wat bij jou past, hoor je bij de intake.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:206</sub>
- Nee. Fotona 4D werkt op beginnende verslapping, textuur en kleur, zonder naalden en zonder snijden. Voor huid die echt is gaan hangen is chirurgie het antwoord, en dat zeggen we je dan ook.
  <sub>src/data/landings/fotona-4d-rotterdam.ts:211</sub>
...
- Openen met een steriele naald en de inhoud eruit lichten. Dat duurt per bolletje enkele seconden en er blijft niets van te zien.
  <sub>src/data/gerstekorrels.ts:52</sub>
...
- Niets. Dit hoort bij je huisarts en gaat vaak vanzelf over met warme kompressen. Wij prikken hier niet in.
  <sub>src/data/gerstekorrels.ts:65</sub>
...
- [ Eerst vaststellen of het een wit korreltje is of een ontsteking, want dat scheelt de huisarts of ons, Milia openen met een steriele naald, per stuk, in een behandeling van minuten
  <sub>src/data/gerstekorrels.ts:99</sub>
...
- Een ontstoken kliertje aan de ooglidrand hoort bij de huisarts, en gaat vaak vanzelf over. Wij prikken daar niet in; de kans op verergering is klein maar de plek is te belangrijk om die kans te nemen.
  <sub>src/data/gerstekorrels.ts:115</sub>
- Omdat er geen opening naartoe is. Een mee-eter heeft een poriegang naar buiten; een milium zit volledig ingesloten onder een laagje huid. Knijpen beschadigt daarom alleen het weefsel eromheen.
  <sub>src/data/gerstekorrels.ts:128</sub>
- Je voelt een prikje per bolletje, vergelijkbaar met een splinter eruit halen. Er is geen verdoving nodig en je kunt daarna gewoon weg.
  <sub>src/data/gerstekorrels.ts:133</sub>
- De behandelde bolletjes niet. Wel kunnen er nieuwe ontstaan, en dan kijken we of er een aanleiding is: bij sommige mensen is dat een te rijke oogcrème, bij anderen jarenlange zonschade.
  <sub>src/data/gerstekorrels.ts:138</sub>
- Meestal alles wat er zit, in een afspraak. Zijn het er veel, dan spreiden we het soms om de huid rust te geven. Dat hoor je vooraf en niet halverwege.
  <sub>src/data/gerstekorrels.ts:143</sub>
...
- Bouw af voordat je iets nieuws probeert, en zeker voordat je een behandeling boekt. Op een kapotte barrière reageert je huid feller en levert dezelfde behandeling minder op.
  <sub>src/data/gevoelige-huid.ts:134</sub>
- }, }; export const BOTSING_UITLEG = Deze combinatie werkt op dezelfde laag en op hetzelfde moment. Los van elkaar kan het prima, samen op één dag is het meestal te veel voor de barrière. ;
  <sub>src/data/gevoelige-huid.ts:139</sub>
- Soms, maar lang niet altijd. Veel mensen krijgen het pas na jaren, en dan is er meestal iets veranderd in wat ze gebruiken of hoe vaak. Aanleg wordt vaak pas zichtbaar als de rest is weggehaald.
  <sub>src/data/gevoelige-huid.ts:217</sub>
- Nee. Dat is een hardnekkig verhaal en het klopt niet. Een lichte tinteling bij bepaalde stoffen kan normaal zijn, maar branden en aanhoudend prikken zijn een signaal om te stoppen.
  <sub>src/data/gevoelige-huid.ts:227</sub>

**Inhoud: hoeveel-sessies** (14)

- Hoeveel sessies je nodig hebt hangt af van de behandeling en van je huid. Een gezichtsbehandeling kan los, microneedling en peelings gaan meestal in een reeks van drie tot zes met vier tot zes weken ertussen, en laserontharing vraagt er zes tot tien, verspreid over maanden, omdat haar in cycli gr...
  <sub>src/data/landings/hoeveel-sessies.ts:45</sub>
- [ De bovenste laag van je huid vernieuwt zichzelf in ongeveer vier weken. Een behandeling die daar werkt, zoals een gezichtsbehandeling of een oppervlakkige peeling, doet zijn werk binnen die ene cyclus. Het resultaat is er meteen en het loopt in de weken erna weer terug naar het uitgangspunt, en...
  <sub>src/data/landings/hoeveel-sessies.ts:69</sub>
- [ De bovenste laag van je huid vernieuwt zichzelf in ongeveer vier weken. Een behandeling die daar werkt, zoals een gezichtsbehandeling of een oppervlakkige peeling, doet zijn werk binnen die ene cyclus. Het resultaat is er meteen en het loopt in de weken erna weer terug naar het uitgangspunt, en...
  <sub>src/data/landings/hoeveel-sessies.ts:70</sub>
- [ De bovenste laag van je huid vernieuwt zichzelf in ongeveer vier weken. Een behandeling die daar werkt, zoals een gezichtsbehandeling of een oppervlakkige peeling, doet zijn werk binnen die ene cyclus. Het resultaat is er meteen en het loopt in de weken erna weer terug naar het uitgangspunt, en...
  <sub>src/data/landings/hoeveel-sessies.ts:71</sub>
- [ Wat een behandeling doet, hangt af van hoe jouw huid erop reageert, en dat is vooraf een inschatting. Bij de een is de textuur na drie sessies waar hij zijn moet, bij de ander vraagt hetzelfde doel er zes. Een getal dat vooraf vastligt is dus een belofte over iemand anders zijn huid., Daarom me...
  <sub>src/data/landings/hoeveel-sessies.ts:89</sub>
- [ Herstel dat zich over weken opbouwt, zoals bij microneedling en laser
  <sub>src/data/landings/hoeveel-sessies.ts:105</sub>
- [ Herstel dat zich over weken opbouwt, zoals bij microneedling en laser , Haar dat in cycli groeit, waardoor er per keer maar een deel te raken is
  <sub>src/data/landings/hoeveel-sessies.ts:106</sub>
- [ Een resultaat dat na één keer al vaststaat. Dan is een tweede sessie er een te veel, Een klacht die niet reageert. Blijft de meting gelijk, dan verandert de aanpak, Een huid die op dat moment ontstoken of geïrriteerd is. Die brengen we eerst tot rust
  <sub>src/data/landings/hoeveel-sessies.ts:113</sub>
- Meestal zes tot tien, verspreid over maanden. Dat komt doordat een laser alleen het haar raakt dat op dat moment in de groeifase zit; de rest komt in de weken erna aan de beurt. Het aantal hangt af van de zone, van je huidtype en van je haar, en je hoort bij de intake wat er in jouw geval realist...
  <sub>src/data/landings/hoeveel-sessies.ts:157</sub>
- Meestal een reeks van drie tot zes, met vier tot zes weken ertussen. Die tijd is er niet voor de agenda maar voor je huid: nieuw collageen bouwt zich over weken op, en elke sessie legt daar een laag bij. Bij littekens en bij diepere textuur liggen er vaker zes dan drie.
  <sub>src/data/landings/hoeveel-sessies.ts:162</sub>
- Omdat je huid die tijd nodig heeft om af te maken wat de vorige sessie in gang zette. Eerder behandelen betekent op een huid werken die nog bezig is; veel later betekent dat een deel van de winst alweer is teruggelopen.
  <sub>src/data/landings/hoeveel-sessies.ts:167</sub>
- Bij een gezichtsbehandeling meestal meteen, want die werkt aan de oppervlakte. Bij microneedling, laser en peelings zie je na de eerste sessie vaak iets in de textuur, maar het doel waarvoor je komt vraagt de hele reeks.
  <sub>src/data/landings/hoeveel-sessies.ts:172</sub>
- Dan houd je het resultaat van een halve reeks, en dat is iets anders dan de helft van het resultaat. Bij ontharen is dat het duidelijkst: het haar dat tijdens de gemiste sessies in de groeifase zat, is niet geraakt en groeit gewoon door.
  <sub>src/data/landings/hoeveel-sessies.ts:177</sub>
- Bij een gezichtsbehandeling meestal elke vier tot zes weken, omdat het effect uit zichzelf terugloopt. Bij een traject dat herstel opbouwt is onderhoud een controle per half jaar tot een jaar, afhankelijk van wat we meten.
  <sub>src/data/landings/hoeveel-sessies.ts:192</sub>

**Inhoud: home-faq** (1)

- Niet altijd. Wanneer een huidscan waarde toevoegt, leggen we uit wat we meten en waarom.
  <sub>src/data/home-faq.ts:49</sub>

**Inhoud: huidanalyse-rotterdam** (5)

- [ Twee mensen met dezelfde vlekken kunnen iets heel anders hebben. Pigment kan in de opperhuid zitten of dieper, en die diepte bepaalt welke behandeling er iets aan doet. Roodheid kan van een vaatje komen of van een ontsteking. In gewoon licht zie je dat verschil vaak niet, en dan behandel je op ...
  <sub>src/data/landings/huidanalyse-rotterdam.ts:67</sub>
- [ Twee mensen met dezelfde vlekken kunnen iets heel anders hebben. Pigment kan in de opperhuid zitten of dieper, en die diepte bepaalt welke behandeling er iets aan doet. Roodheid kan van een vaatje komen of van een ontsteking. In gewoon licht zie je dat verschil vaak niet, en dan behandel je op ...
  <sub>src/data/landings/huidanalyse-rotterdam.ts:68</sub>
- [ Een diagnose stellen. Voor een plek of aandoening kijkt een arts mee
  <sub>src/data/landings/huidanalyse-rotterdam.ts:129</sub>
- [ Een diagnose stellen. Voor een plek of aandoening kijkt een arts mee , Behandelen. Er gebeurt tijdens de meting niets met je huid, Voorspellen wat een behandeling gaat opleveren, Een moedervlek beoordelen die verandert. Daarvoor ga je naar je huisarts
  <sub>src/data/landings/huidanalyse-rotterdam.ts:132</sub>
- Pigment, ook als het dieper in de huid zit, roodheid, poriën, vocht en tekenen van huidveroudering. De opnames worden onder vast licht en ook onder UV gemaakt, zodat ze bij een volgende meting te vergelijken zijn.
  <sub>src/data/landings/huidanalyse-rotterdam.ts:199</sub>

**Inhoud: huidtherapeut-rotterdam** (9)

- [ Een huidtherapeut behandelt de huid op een medisch-cosmetische manier: klachten die je dagelijks ziet en voelt, maar waarvoor je niet naar het ziekenhuis hoeft. Denk aan acne en de littekens die het achterlaat, pigmentvlekken, couperose en rosacea, ongewenste haargroei, littekens na een operati...
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:77</sub>
- Huidtherapie zit niet in de basisverzekering, maar bij de meeste verzekeraars wel in het aanvullende pakket. Dan moet er een medische reden zijn, en vaak een verwijzing van je huisarts vóór de eerste behandeling. Hoe dat per stap zit, staat op [de pagina over vergoedingen](/vergoedingen).
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:132</sub>
- [ Een diagnose stellen. Twijfel je over een plek die verandert, dan ga je naar je huisarts
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:153</sub>
- [ Een diagnose stellen. Twijfel je over een plek die verandert, dan ga je naar je huisarts , Medicijnen voorschrijven. Antibiotica, de pil of isotretinoïne lopen via je huisarts of dermatoloog, Een ontsteking die koorts geeft of snel erger wordt. Dan bel je dezelfde dag je huisarts
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:155</sub>
- [ Arts, daarna de specialisatie tot dermatoloog, Ja, in het BIG-register, Een diagnose, huidziekten, verdachte plekken en medicijnen. Meestal via je huisarts
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:184</sub>
- [ Een vakopleiding, meestal op mbo-niveau, Nee, Verzorgende behandelingen: reinigen, verzorgen en ontspannen
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:192</sub>
- Soms. Huidtherapie zit niet in de basisverzekering, maar bij de meeste verzekeraars wel in het aanvullende pakket. Dan moet er een medische reden zijn, en vaak een verwijzing van je huisarts die er is vóór de eerste behandeling. Een cosmetische behandeling wordt niet vergoed.
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:232</sub>
- Een dermatoloog is een arts. Die stelt diagnoses, behandelt huidziekten en schrijft medicijnen voor, en je komt er meestal via je huisarts. Een huidtherapeut is een paramedicus die huidklachten behandelt met apparatuur, peelings en begeleiding, en je kunt er rechtstreeks terecht. Ben je onder beh...
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:242</sub>
- De opleiding en de titel. Huidtherapeut is een beschermde titel met een hbo-opleiding van vier jaar; schoonheidsspecialist is geen beschermde titel. In de praktijk zie je het verschil vooral bij behandelingen waarbij de instelling per huid telt, zoals laser, microneedling en sterkere peelings.
  <sub>src/data/landings/huidtherapeut-rotterdam.ts:247</sub>

**Inhoud: huiduitslag** (11)
...
- De kleur komt van bloed dat nog in de vaatjes zit. Dat past bij veel gewone oorzaken, van een allergische reactie tot een virus.
  <sub>src/data/huiduitslag.ts:35</sub>
- Dat kan betekenen dat er bloed buiten de vaatjes zit. In combinatie met ziek zijn, koorts, sufheid, nekpijn of snelle verspreiding is dat een reden om niet af te wachten.
  <sub>src/data/huiduitslag.ts:46</sub>
- }, }; export const GLASTEST_UITLEG = Druk de zijkant van een doorzichtig glas stevig op de vlekken en kijk er dwars doorheen. Deze test is geen diagnose en sluit niets uit: een uitslag die wél wegdrukt kan nog steeds ernstig zijn. Hij helpt je alleen inschatten of je vandaag belt of dat het tot e...
  <sub>src/data/huiduitslag.ts:54</sub>
- Uitslag bij een baby, of bij iemand met een verminderde afweer, ] as const; export const ALARM_SLOT = Herken je hier iets van, dan is bellen het enige goede antwoord. Hoe de uitslag eruitziet weegt dan niet meer mee. ;
  <sub>src/data/huiduitslag.ts:67</sub>
- Huisarts. Bij zwelling van lippen of keel: bel 112.
  <sub>src/data/huiduitslag.ts:114</sub>
- [ Letten op hoe ziek iemand zich voelt. Dat weegt zwaarder dan hoe de uitslag eruitziet, en het bepaalt of je vandaag belt of morgen.
  <sub>src/data/huiduitslag.ts:126</sub>
- Niet betrouwbaar. Uitslag die er onschuldig uitziet kan alsnog ernstig zijn, en op een donkere huid is het verschil sowieso moeilijk te zien. Hoe ziek iemand zich voelt weegt zwaarder: koorts, sufheid, nekpijn of benauwdheid zijn redenen om direct te bellen.
  <sub>src/data/huiduitslag.ts:163</sub>
- Bulten die opkomen en binnen een dag verdwijnen, soms elders terug. Dat patroon hoort bij galbulten, en dan telt wat eraan voorafging.
  <sub>src/data/huiduitslag.ts:205</sub>
- Plekken die blijven staan en langzaam veranderen. Dat wijst eerder op iets met de huidbarrière dan op een reactie van dat moment.
  <sub>src/data/huiduitslag.ts:209</sub>
- Een scherpe rand die de vorm volgt van een bandje, een sieraad of een boord. De vorm verraadt dan de oorzaak, en die is meestal contact.
  <sub>src/data/huiduitslag.ts:213</sub>
- Begonnen op een punt en van daaruit uitgebreid. Dat verloop hoort bij een andere groep oorzaken dan iets wat overal tegelijk opkwam.
  <sub>src/data/huiduitslag.ts:217</sub>

**Inhoud: huidverkleuring** (4)
...
- Meer pigment dan de huid eromheen. De vraag die telt is niet hoe donker maar waaróm het er zit, want dat bepaalt wat er mogelijk is.
  <sub>src/data/huidverkleuring.ts:39</sub>
- Bloed in de vaatjes, of ontsteking. Rood is bijna altijd iets dat leeft en beweegt, en dat is precies waarom het anders reageert dan bruin.
  <sub>src/data/huidverkleuring.ts:68</sub>
- Minder pigment dan de huid eromheen. Dit is de lastigste categorie, want verloren pigment komt zelden terug en een deel hoort bij de huisarts.
  <sub>src/data/huidverkleuring.ts:102</sub>
- Meestal iets dat door de huid heen schemert, of pigment dat dieper zit dan gewoonlijk. De kleur zegt hier vooral iets over de diepte.
  <sub>src/data/huidverkleuring.ts:124</sub>
...
- Elastine en collageen nemen af, waardoor de huid trager terugveert. Dit is het vroegste stadium en het stadium waarin een behandeling het meeste oplevert.
  <sub>src/data/huidverslapping.ts:52</sub>
- De huid houdt de contour niet meer strak, terwijl er onder nog weinig is veranderd. Dit is de klacht waarmee de meeste mensen hier binnenkomen.
  <sub>src/data/huidverslapping.ts:66</sub>
- Vetkussens in het gezicht nemen af en verplaatsen, en bot trekt zich terug. Dat is geen huidprobleem, ook al zie je het aan je huid.
  <sub>src/data/huidverslapping.ts:79</sub>
- Weefsel dat werkelijk is losgelaten en niet alleen minder stevig. Geen apparaat zet dit terug, hoe vaak je ook komt.
  <sub>src/data/huidverslapping.ts:92</sub>
- [ Eerst vaststellen of het om stevigheid gaat, om volume, of om huid die echt is losgelaten, De diepere lagen aanspannen met laser, in een reeks met weken ertussen, Een huidanalyse, want verandering over maanden zie je in de spiegel niet en op een meting wel, Dagelijkse zonbescherming, omdat uv-s...
  <sub>src/data/huidverslapping.ts:133</sub>
- [ Chirurgie nabootsen. Wat is losgelaten wordt hier niet vastgezet
  <sub>src/data/huidverslapping.ts:137</sub>
- [ Chirurgie nabootsen. Wat is losgelaten wordt hier niet vastgezet , Volume opvullen. Wij werken niet met fillers, en bij een smaller geworden gezicht is dat vaak wel het antwoord, Een behandelreeks starten terwijl de beoordeling laat zien dat weinig verbetering te verwachten is, Resultaat belove...
  <sub>src/data/huidverslapping.ts:140</sub>
- Chirurgie nabootsen. Wat is losgelaten wordt hier niet vastgezet , Volume opvullen. Wij werken niet met fillers, en bij een smaller geworden gezicht is dat vaak wel het antwoord, Een behandelreeks starten terwijl de beoordeling laat zien dat weinig verbetering te verwachten is, Resultaat beloven ...
  <sub>src/data/huidverslapping.ts:141</sub>
- Kun je een plooi vastpakken die blijft hangen, dan gaat het om weefsel dat verwijderd of verplaatst moet worden. Dat is chirurgie. Een reeks van drie verkopen aan iemand die een lift zoekt is het duurste nee dat wij kunnen uitstellen.
  <sub>src/data/huidverslapping.ts:149</sub>
- Nee. Aanspannen van de huid en het verwijderen van weefsel zijn twee verschillende dingen, en wij doen alleen het eerste. Wat wij doen werkt in het stadium daarvoor, en op het moment dat dat stadium voorbij is zeggen we dat.
  <sub>src/data/huidverslapping.ts:162</sub>
- Leeftijd zegt hier weinig. Waar het om gaat is hoeveel je huid nog terugveert, en dat stelt de behandelaar in het consult vast. Is er weinig te winnen, dan hoor je dat, en dan is dat het advies.
  <sub>src/data/huidverslapping.ts:167</sub>
- Het proces zelf gaat door, dus het is geen eindpunt maar een verschuiving. Hoe lang dat merkbaar blijft verschilt sterk per persoon; we spreken vooraf af wanneer we opnieuw meten in plaats van dat we een getal noemen.
  <sub>src/data/huidverslapping.ts:172</sub>
- Je voelt warmte en soms korte prikjes. De meeste mensen omschrijven het als goed te doen, en er is geen verdoving nodig. Wat je erna merkt hangt af van de behandeling en staat op de behandelpagina.
  <sub>src/data/huidverslapping.ts:177</sub>

**Inhoud: hydrafacial-rotterdam** (15)

- [ Je huid maakt voortdurend nieuwe cellen aan en laat de oude aan de buitenkant los. Dat loslaten gaat niet bij iedereen even vlot. Blijven die cellen te lang zitten, dan hopen ze zich samen met talg en resten van make-up op in je poriën. Dat is wat je ziet als je huid dof staat en je poriën grot...
  <sub>src/data/landings/hydrafacial-rotterdam.ts:73</sub>
- [ Littekens en pigment dat dieper in de huid zit. Daar werkt microneedling of laser op, want die komen in de laag waar het probleem zit.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:126</sub>
- [ Littekens en pigment dat dieper in de huid zit. Daar werkt microneedling of laser op, want die komen in de laag waar het probleem zit. , Blijvend verschil in de structuur van je huid. Een HydraFacial is onderhoud; het effect houdt dagen tot weken aan en bouwt niet op.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:127</sub>
- [ Littekens en pigment dat dieper in de huid zit. Daar werkt microneedling of laser op, want die komen in de laag waar het probleem zit. , Blijvend verschil in de structuur van je huid. Een HydraFacial is onderhoud; het effect houdt dagen tot weken aan en bouwt niet op. , Actieve, ontstoken acne....
  <sub>src/data/landings/hydrafacial-rotterdam.ts:128</sub>
- [ Littekens en pigment dat dieper in de huid zit. Daar werkt microneedling of laser op, want die komen in de laag waar het probleem zit. , Blijvend verschil in de structuur van je huid. Een HydraFacial is onderhoud; het effect houdt dagen tot weken aan en bouwt niet op. , Actieve, ontstoken acne....
  <sub>src/data/landings/hydrafacial-rotterdam.ts:129</sub>
- Haalt eruit wat erin zit en brengt in dezelfde beweging stoffen terug. Je ziet het meteen., ), vergelijkingsrij( oxygeneo, Maakt de bovenste laag los met een gel in plaats van met onderdruk, waarbij er in de huid zuurstof vrijkomt. Rustiger aan je huid, minder gericht op het legen van poriën.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:148</sub>
- Schraapt de dode laag en het donshaar er met een mesje af. Vooral voor een gladde huid onder make-up; het doet niets aan wat er in de porie zit., ), vergelijkingsrij( peelings, Werkt met zuren en gaat dieper. Meer effect op pigment en op de structuur, en daardoor ook meer reactie van je huid na a...
  <sub>src/data/landings/hydrafacial-rotterdam.ts:156</sub>
- Werkt met zuren en gaat dieper. Meer effect op pigment en op de structuur, en daardoor ook meer reactie van je huid na afloop. , ), vergelijkingsrij( skinpen, Maakt met naalden kleine kanaaltjes in de lederhuid, zodat je huid zelf collageen gaat aanmaken. Voor littekens en structuur, met een paar...
  <sub>src/data/landings/hydrafacial-rotterdam.ts:160</sub>
- Nee. Je huid is na afloop roze en voelt strak aan, en dat trekt meestal binnen een uur weg. Make-up kan dezelfde dag nog. Je kunt er direct na de afspraak weer mee de deur uit.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:190</sub>
- Los te doen, of maandelijks als onderhoud. Een startreeks is meestal drie tot zes behandelingen. Wat er in jouw geval zinvol is, hangt af van je huid en van wat je ermee wilt; dat bespreken we bij de intake.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:195</sub>
- Ja, dat is een van de redenen dat mensen deze behandeling kiezen: het effect is er meteen en er is geen dag waarop je binnen moet blijven. Heb je hem nog nooit gehad, plan hem dan minstens een week van tevoren, zodat je weet hoe je huid erop reageert voordat het erop aankomt.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:200</sub>
- Bij een klassieke gezichtsbehandeling gebeuren reinigen, uitdrukken en verzorgen na elkaar en met de hand. Bij een HydraFacial gebeurt het in één doorgang met één mondstuk, waarbij onderdruk het werk doet in plaats van vingers. Dat is gelijkmatiger over je gezicht en je huid raakt er minder van g...
  <sub>src/data/landings/hydrafacial-rotterdam.ts:205</sub>
- Bij verstopte poriën en meeëters kan het helpen, want dat is precies wat er weggehaald wordt. Bij actieve, ontstoken acne is het niet de eerste stap: dan begin je met het acnetraject, waar we de huid eerst tot rust brengen. Wat bij jou past bepaalt de behandelaar na de meting.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:210</sub>
- Vaak wel. Er komen geen zuren aan te pas en de behandeling blijft aan de oppervlakte, waardoor je huid er weinig van te verduren krijgt. Bij actieve rosacea of een ontstoken huid brengen we die eerst tot rust. Of het bij jou kan, bepaalt de meting tijdens de intake.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:215</sub>
- Nee. Een HydraFacial is een onderhoudsbehandeling zonder medische noodzaak en valt daarmee buiten het stelsel. Heeft je klacht wel een medische reden, bijvoorbeeld bij acne of een litteken, dan is er soms een route naar vergoeding; die staat uitgelegd op onze pagina over vergoedingen.
  <sub>src/data/landings/hydrafacial-rotterdam.ts:220</sub>
...
- Fotos onder vaste belichting en op vaste afstand, plus metingen van kleur, structuur en vocht. Het apparaat doet niets met je huid; het kijkt alleen.
  <sub>src/data/intake.ts:40</sub>
- Geen zonvakantie of zonnebank in de weken ervoor. Een verse kleur maakt de meting onbetrouwbaar en behandelen daarna onverstandig.
  <sub>src/data/intake.ts:169</sub>

**Inhoud: ipl-rotterdam** (18)

- IPL is een behandeling met intens gepulst licht dat pigment en kleine vaatjes in de huid opzoekt, zodat vlekken vervagen en roodheid wegtrekt. Bij Diba Clinics in Rotterdam werken we met de Nordlys van Candela. Een behandeling duurt ${IPL.duurMinuten} minuten en kost ${euro(IPL_TARIEF.laag)} voor...
  <sub>src/data/landings/ipl-rotterdam.ts:47</sub>
- [ IPL stuurt geen enkele golflengte de huid in maar een band, met een filter dat het grofste eruit haalt. Die band raakt daardoor meerdere dingen tegelijk: oppervlakkig pigment, zichtbare vaatjes en een huid die structureel rood staat. Het licht komt gemiddeld minder diep dan een laser, en dat is...
  <sub>src/data/landings/ipl-rotterdam.ts:74</sub>
- [ IPL stuurt geen enkele golflengte de huid in maar een band, met een filter dat het grofste eruit haalt. Die band raakt daardoor meerdere dingen tegelijk: oppervlakkig pigment, zichtbare vaatjes en een huid die structureel rood staat. Het licht komt gemiddeld minder diep dan een laser, en dat is...
  <sub>src/data/landings/ipl-rotterdam.ts:75</sub>
- [ IPL stuurt geen enkele golflengte de huid in maar een band, met een filter dat het grofste eruit haalt. Die band raakt daardoor meerdere dingen tegelijk: oppervlakkig pigment, zichtbare vaatjes en een huid die structureel rood staat. Het licht komt gemiddeld minder diep dan een laser, en dat is...
  <sub>src/data/landings/ipl-rotterdam.ts:76</sub>
- IPL werkt in een reeks van drie tot zes behandelingen, met vier weken ertussen. Bij rosacea hoort daarna onderhoud, omdat de roodheid kan terugkomen.
  <sub>src/data/landings/ipl-rotterdam.ts:109</sub>
- [ Melasma. Dat pigment reageert vaak juist op warmte, en daar is IPL niet de eerste keuze
  <sub>src/data/landings/ipl-rotterdam.ts:126</sub>
- [ Melasma. Dat pigment reageert vaak juist op warmte, en daar is IPL niet de eerste keuze , Pigment in de zomermaanden. Tussen mei en augustus behandelen we pigment niet
  <sub>src/data/landings/ipl-rotterdam.ts:127</sub>
- [ Melasma. Dat pigment reageert vaak juist op warmte, en daar is IPL niet de eerste keuze , Pigment in de zomermaanden. Tussen mei en augustus behandelen we pigment niet , Rosacea genezen. IPL haalt de zichtbare roodheid weg, en die kan terugkomen
  <sub>src/data/landings/ipl-rotterdam.ts:128</sub>
- [ Melasma. Dat pigment reageert vaak juist op warmte, en daar is IPL niet de eerste keuze , Pigment in de zomermaanden. Tussen mei en augustus behandelen we pigment niet , Rosacea genezen. IPL haalt de zichtbare roodheid weg, en die kan terugkomen , Elk huidtype. Bij een donkere huid is de kans o...
  <sub>src/data/landings/ipl-rotterdam.ts:129</sub>
- Licht op het bloed in de vaatjes. Voor couperose, losse vaatjes en rosacea., ), vergelijkingsrij( cosmelan, Een traject van zes maanden dat de aanmaak van pigment remt, voor hardnekkig pigment waar losse behandelingen op stuklopen.
  <sub>src/data/landings/ipl-rotterdam.ts:152</sub>
- Een traject van zes maanden dat de aanmaak van pigment remt, voor hardnekkig pigment waar losse behandelingen op stuklopen. , ), vergelijkingsrij( peelings, Een zuur op de bovenlaag. Werkt op oppervlakkige verkleuring, zonder warmte.
  <sub>src/data/landings/ipl-rotterdam.ts:156</sub>
- Een zuur op de bovenlaag. Werkt op oppervlakkige verkleuring, zonder warmte. , ), vergelijkingsrij( led-therapie, Licht dat de huid rustiger maakt, zonder warmte en zonder hersteltijd. Vaak naast een andere behandeling bij roodheid.
  <sub>src/data/landings/ipl-rotterdam.ts:160</sub>
- Dat hoort erbij. Het pigment komt naar de oppervlakte voordat het vervaagt, en dat duurt een aantal dagen. Het betekent niet dat het erger wordt.
  <sub>src/data/landings/ipl-rotterdam.ts:185</sub>
...
- Voor pigment niet. Tussen mei en augustus behandelen we pigment niet, omdat een huid die net behandeld is extra fel op zon reageert. Voor roodheid en vaatjes ligt dat anders; dat bespreken we per geval.
  <sub>src/data/landings/ipl-rotterdam.ts:200</sub>
- Het haalt losse vaatjes weg en maakt een gebied dat structureel rood staat rustiger. Rosacea geneest het niet: de zichtbare roodheid gaat weg, en die kan terugkomen. Daarom hoort er bij rosacea onderhoud bij.
  <sub>src/data/landings/ipl-rotterdam.ts:205</sub>
...
- Hier loopt de behandeling via je arts of dermatoloog. Wij beoordelen mee en stemmen af, want een te stevige prikkel maakt een keloid groter.
  <sub>src/data/keloiden.ts:74</sub>
...
- Bij keloid is de kans daarop reeel, en dat is precies waarom het bij een arts hoort. Wat de kans is in jouw geval, hoor je daar.
  <sub>src/data/keloiden.ts:122</sub>
...
- Verhoorning rond de haarzakjes: er vormt zich een propje hoorncellen boven elk haartje. Onschuldig, grotendeels erfelijk, en het wordt bij veel mensen met de jaren minder.
  <sub>src/data/keratosis-pilaris.ts:53</sub>
...
- Eerlijk zeggen dat dit niet te genezen is, en wat er dan wel kan, De bovenlaag geleidelijk soepeler maken, met een tempo dat de huid aankan, Onderhoud dat je zelf volhoudt, want zonder dat komt het beeld terug, De roodheid apart aanpakken, want die stoort vaak meer dan de bultjes zelf , Meewegen ...
  <sub>src/data/keratosis-pilaris.ts:135</sub>
...
- [ Schuren. De propjes zitten rond het haarzakje en niet aan de oppervlakte; je maakt alleen de roodheid erger , Uitknijpen of pulken. Daar houd je donkere vlekjes en soms kuiltjes aan over, Een kuur als definitieve oplossing presenteren Keratosis pilaris vraagt meestal om blijvende verzorging en ...
  <sub>src/data/keratosis-pilaris.ts:141</sub>
- Schuren. De propjes zitten rond het haarzakje en niet aan de oppervlakte; je maakt alleen de roodheid erger , Uitknijpen of pulken. Daar houd je donkere vlekjes en soms kuiltjes aan over, Een kuur als definitieve oplossing presenteren Keratosis pilaris vraagt meestal om blijvende verzorging en on...
  <sub>src/data/keratosis-pilaris.ts:142</sub>
- Keratosis pilaris is grotendeels erfelijk en niet te genezen. Wat wij kunnen is de huid soepeler en de roodheid minder maken, met onderhoud erbij. Wie hier een reeks van zes tegenover zet verkoopt hoop en levert een teleurstelling.
  <sub>src/data/keratosis-pilaris.ts:150</sub>
- Genezen kan niet, maar bij veel mensen wordt het met de jaren vanzelf minder, vaak vanaf een jaar of dertig. In de tussentijd is het beeld wel te verzachten. Dat is geen mooi verhaal, en het is wel het eerlijke.
  <sub>src/data/keratosis-pilaris.ts:163</sub>
...
- Koude lucht en binnenverwarming drogen de huid uit, en een drogere huid maakt de verhoorning zichtbaarder en ruwer. Bij bijna iedereen is het in de zomer minder. Dat is het seizoen en geen terugval.
  <sub>src/data/keratosis-pilaris.ts:178</sub>
...
- Bij uitrekken worden doorschijnende bloedvaatjes verder uit elkaar getrokken en verbleekt de kleur. Pigment zit in de huid zelf en verandert niet mee.
  <sub>src/data/kringen.ts:67</sub>
- De overgang tussen je onderooglid en je wang ligt iets dieper, en licht van boven maakt daar een schaduw van. De huid zelf heeft geen afwijkende kleur.
  <sub>src/data/kringen.ts:123</sub>
- Er zit meer kleur in de huid onder je oog. Dat kan erfelijk zijn, kan volgen op eczeem of op wrijven, en komt vaker voor bij een donkere huid.
  <sub>src/data/kringen.ts:134</sub>
- De huid onder je oog is de dunste van je lichaam. Bij sommige mensen schemert het bloedvatennetwerk eronder erdoorheen, wat een blauwpaarse tint geeft.
  <sub>src/data/kringen.ts:145</sub>
- Een behandeling boeken voordat duidelijk is welk type je hebt. Bij één van de drie levert dat niets op en bij een tweede maar de helft., Agressief werken op de dunne huid onder het oog. Dat geeft daar juist een grotere kans op meer pigment., Denken dat het aan slaap ligt. Slaap maakt het wisselen...
  <sub>src/data/kringen.ts:172</sub>
- De huid daar is de dunste van je lichaam. We gaan er trager te werk dan elders, ook als dat betekent dat je meer sessies nodig hebt.
  <sub>src/data/kringen.ts:185</sub>
- Waarschijnlijk niet. Zowel de vorm van de oogkas als de neiging tot pigment op deze plek zit in de familie. Dat verandert niets aan wat er mogelijk is, maar het verklaart wel waarom ze er al vroeg waren.
  <sub>src/data/kringen.ts:203</sub>
- Ja. Pigment onder het oog komt vaker voor bij een donkere huid, en tegelijk is de kans op ongewenste verkleuring na een te stevige behandeling daar groter. Rustiger werken is dan geen voorzichtigheid maar noodzaak.
  <sub>src/data/kringen.ts:208</sub>
...
- De wond is dicht maar de huid is nog aan het opruimen. Rood, soms verheven, vaak gevoelig. Er komen nieuwe bloedvaten bij en er wordt collageen aangelegd zonder ordening.
  <sub>src/data/littekens.ts:51</sub>
- Het collageen wordt herschikt. Het litteken kan in deze periode nog alle kanten op: platter en lichter, of juist dikker als de aanmaak doorschiet.
  <sub>src/data/littekens.ts:65</sub>
- Het litteken is uitgerijpt. De bloedvaten zijn grotendeels verdwenen en het collageen ligt in zijn eindstand. Er verandert van nature bijna niets meer.
  <sub>src/data/littekens.ts:93</sub>
...
- Nee. Een litteken is blijvend weefsel; wat we doen is het minder opvallend maken. Bij verse littekens is dat verschil groot, bij oude klein. We zeggen vooraf in welke categorie het jouwe valt.
  <sub>src/data/littekens.ts:230</sub>
- Bij verse littekens kan siliconen iets doen, vooral bij verheven littekens. Bij witte striae en oude littekens niet. De prijs zegt daar niets over.
  <sub>src/data/littekens.ts:245</sub>
...
- De sterkste van de drie, en de enige die je volledig zelf in de hand hebt. Ook winterlicht en licht door een autoruit telt mee.
  <sub>src/data/melasma.ts:93</sub>
- Zwangerschap, de pil en hormoonspiralen spelen mee. Dit is de reden dat melasma vaker bij vrouwen voorkomt en soms vanzelf wegtrekt na een bevalling.
  <sub>src/data/melasma.ts:100</sub>
- Sauna, hete douches, een warme keuken, en ook de warmte van een behandeling zelf. Dit is de aanjager die het vaakst over het hoofd wordt gezien.
  <sub>src/data/melasma.ts:107</sub>
- Een agressieve laser of stevige peeling. Bij melasma is dat de bekendste manier om het erger te maken dan het was., In de zomer beginnen. Dan werk je tegen de aanjager in die je net probeert uit te zetten., Stoppen met beschermen zodra het lichter wordt. Dan is het binnen een seizoen terug en heb...
  <sub>src/data/melasma.ts:127</sub>
- Hoe verleidelijk ook, agressief werken geeft hier vaak meer pigment in plaats van minder. Dat is bij melasma een bekend en pijnlijk patroon.
  <sub>src/data/melasma.ts:145</sub>
- Meestal niet uit zichzelf, en behandelen maakt het lichter zonder het weg te nemen. Na een zwangerschap trekt het soms grotendeels weg; dat is dan het hormonale deel dat wegvalt en niet iets wat een behandeling deed.
  <sub>src/data/melasma.ts:158</sub>
- Beschermen wel, behandelen niet. We wachten tot na de zwangerschap en de borstvoeding, ook omdat een deel dan vanzelf terugloopt.
  <sub>src/data/melasma.ts:168</sub>
- Ja, in twee richtingen. Melasma komt vaker voor, en de kans dat een te stevige behandeling juist meer pigment achterlaat is groter. Rustiger werken is dan geen voorzichtigheid maar noodzaak.
  <sub>src/data/melasma.ts:173</sub>

**Inhoud: microneedling-rotterdam** (16)

- Microneedling is een behandeling waarbij fijne naalden heel veel kleine kanaaltjes in de huid maken, zodat je huid zelf nieuw collageen gaat aanmaken. Bij Diba Clinics in Rotterdam werken we met de SkinPen en de Dermapen 4. Een behandeling van het gezicht kost ${euro(SP.prijs)} en duurt ${SP.duur...
  <sub>src/data/landings/microneedling-rotterdam.ts:46</sub>
- [ Onder de opperhuid ligt de lederhuid, en daar zit het bindweefsel dat je huid stevig en glad houdt. Bij een litteken, een grove porie of een huid die met de jaren minder veerkracht heeft, is dat bindweefsel ongelijk of dunner geworden. Een crème komt daar niet; die laag ligt te diep.
  <sub>src/data/landings/microneedling-rotterdam.ts:70</sub>
- [ Onder de opperhuid ligt de lederhuid, en daar zit het bindweefsel dat je huid stevig en glad houdt. Bij een litteken, een grove porie of een huid die met de jaren minder veerkracht heeft, is dat bindweefsel ongelijk of dunner geworden. Een crème komt daar niet; die laag ligt te diep. , Micronee...
  <sub>src/data/landings/microneedling-rotterdam.ts:71</sub>
- [ Onder de opperhuid ligt de lederhuid, en daar zit het bindweefsel dat je huid stevig en glad houdt. Bij een litteken, een grove porie of een huid die met de jaren minder veerkracht heeft, is dat bindweefsel ongelijk of dunner geworden. Een crème komt daar niet; die laag ligt te diep. , Micronee...
  <sub>src/data/landings/microneedling-rotterdam.ts:72</sub>
- [ De [SkinPen](/apparatuur/skinpen-cit) heeft veertien naalden en werkt iets bedaarder. De [Dermapen 4](/apparatuur/dermapen-4) haalt tot 1920 prikken per seconde en werkt een vlak daardoor sneller af, met voorgeprogrammeerde standen, waaronder een instelling voor littekens op de maximale diepte....
  <sub>src/data/landings/microneedling-rotterdam.ts:87</sub>
- [ Littekens die door verlies van structuur zijn ontstaan, zoals de ondiepe kuiltjes na acne, Fijne lijntjes en een ongelijke textuur, Grove poriën en een huid die dof is geworden, Pigment dat na een puistje of wondje is achtergebleven
  <sub>src/data/landings/microneedling-rotterdam.ts:119</sub>
- [ Zonschade en losse pigmentvlekken. Daarvoor kies je laser of IPL
  <sub>src/data/landings/microneedling-rotterdam.ts:122</sub>
- [ Zonschade en losse pigmentvlekken. Daarvoor kies je laser of IPL , Een huid met actieve, ontstoken acne. Die brengen we eerst tot rust
  <sub>src/data/landings/microneedling-rotterdam.ts:123</sub>
- [ Zonschade en losse pigmentvlekken. Daarvoor kies je laser of IPL , Een huid met actieve, ontstoken acne. Die brengen we eerst tot rust , Een enkele sessie. Wat je na één keer ziet is zwelling; het resultaat komt over de reeks, Diepe of ingetrokken littekens met alleen microneedling. Die vragen ...
  <sub>src/data/landings/microneedling-rotterdam.ts:125</sub>
- Meer prikken per seconde en sneller over een groot vlak, met een vaste stand voor littekens., ), vergelijkingsrij( fotona-scar-repair, Laser in plaats van naalden. Voor diepere of ingetrokken littekens, vaak samen met microneedling.
  <sub>src/data/landings/microneedling-rotterdam.ts:148</sub>
- Laser in plaats van naalden. Voor diepere of ingetrokken littekens, vaak samen met microneedling. , ), vergelijkingsrij( peelings, Werkt met zuren op de bovenlaag. Minder diep, en meer effect op oppervlakkige verkleuring en ruwheid.
  <sub>src/data/landings/microneedling-rotterdam.ts:152</sub>
- Een tot drie dagen, ongeveer als een stevige zonnegloed. De eerste vierentwintig uur laat je je huid met rust: geen make-up en niet sporten tot je flink zweet.
  <sub>src/data/landings/microneedling-rotterdam.ts:183</sub>
- Meestal drie tot zes, met vier tot zes weken ertussen. Hoeveel het er bij jou worden hangt af van je klacht en van hoe je huid reageert. Dat meten we tussendoor, en een vast aantal vooraf beloven we niet.
  <sub>src/data/landings/microneedling-rotterdam.ts:188</sub>
- Niet na de eerste keer; wat je dan ziet is zwelling. Het collageen dat je huid aanmaakt bouwt zich over weken op, dus het verschil zie je in de loop van de reeks en het duidelijkst een paar maanden na de laatste behandeling.
  <sub>src/data/landings/microneedling-rotterdam.ts:193</sub>
- Bij littekens die door verlies van structuur zijn ontstaan, zoals de ondiepe kuiltjes na acne, kan het goed helpen. Diepe of ingetrokken littekens vragen vaak een combinatie met laser. Zolang de acne nog actief is, beginnen we er niet aan: de huid moet eerst rustig zijn.
  <sub>src/data/landings/microneedling-rotterdam.ts:203</sub>
...
- Grootte op zichzelf zegt weinig. Het telt vooral mee naast de andere punten, en een klein plekje dat verandert is belangrijker dan een groot plekje dat al jaren hetzelfde is.
  <sub>src/data/moedervlekken.ts:74</sub>
- Dit is het belangrijkste punt van de vijf. Verandering weegt zwaarder dan hoe het plekje eruitziet, ook als de andere vier je niets opvallends laten zien.
  <sub>src/data/moedervlekken.ts:84</sub>
- De moedervlekken van één persoon lijken meestal op elkaar. Eentje die er duidelijk uitspringt is daarom de moeite van het nakijken waard, ook als hij op zichzelf niets bijzonders lijkt.
  <sub>src/data/moedervlekken.ts:96</sub>
- Iets laten weghalen dat verandert, waar dan ook. Wat weg is kan niet meer onderzocht worden. Dat is de enige stap die je niet kunt inhalen., Zelf wegbranden of wegvriezen met iets uit de winkel. Hetzelfde bezwaar, met meer schade., Wachten tot het pijn doet. De meeste verdachte plekjes doen nerge...
  <sub>src/data/moedervlekken.ts:130</sub>
...
- Zonlicht speelt een rol bij het ontstaan van nieuwe plekjes en bij het risico op huidkanker. Hoe groot die rol precies is verschilt per persoon en dat is niet iets waar wij een getal aan hangen.
  <sub>src/data/moedervlekken.ts:172</sub>
- Eén keer per maand is een veelgebruikt advies en vooral praktisch: vaak genoeg om verandering op te merken, zeldzaam genoeg om vol te houden. Vraag je huisarts wat in jouw geval verstandig is.
  <sub>src/data/moedervlekken.ts:177</sub>
...
- Geen mee-eter maar de normale inhoud van een werkende porie: talg met wat cellen. Iedereen heeft ze, en ze zijn binnen weken terug omdat ze horen terug te komen.
  <sub>src/data/onzuivere-huid.ts:51</sub>
- Een porie die is volgelopen en waarvan de inhoud aan de lucht is verkleurd. Het donker is geoxideerde talg en geen vuil; poetsen doet er niets aan.
  <sub>src/data/onzuivere-huid.ts:64</sub>
...
- [ Poriestrips en zuigapparaten. Ze halen talgfilamenten weg die binnen weken terug zijn, en rekken intussen de porie op , Dagelijks scrubben. Je haalt de barrière weg en de huid reageert met meer talg, Alcoholtoners die je huid laten trekken. Een uitgedroogde huid maakt meer talg, niet minder
  <sub>src/data/onzuivere-huid.ts:138</sub>
- Poriestrips en zuigapparaten. Ze halen talgfilamenten weg die binnen weken terug zijn, en rekken intussen de porie op , Dagelijks scrubben. Je haalt de barrière weg en de huid reageert met meer talg, Alcoholtoners die je huid laten trekken. Een uitgedroogde huid maakt meer talg, niet minder , Zel...
  <sub>src/data/onzuivere-huid.ts:140</sub>
- Ze horen bij een werkende porie en ze komen terug, hoe grondig je ook te werk gaat. Wij verkopen daar geen reeks voor. Wat we wel doen is uitleggen waarom je neus er over drie weken weer zo uitziet, zodat je stopt met een gevecht dat niet te winnen is.
  <sub>src/data/onzuivere-huid.ts:148</sub>
- Omdat het in de meeste gevallen geen mee-eters zijn maar talgfilamenten. Die horen in een werkende porie thuis en vullen zich binnen enkele weken opnieuw. Dat is geen falen van je verzorging; het is hoe een porie werkt.
  <sub>src/data/onzuivere-huid.ts:161</sub>
- Ze halen er iets uit, en dat voelt bevredigend. Wat eruit komt is meestal normale porie-inhoud, die terugkomt, en het lostrekken rekt de porie-opening op. Dus: kortstondig zichtbaar effect, op de lange duur geen winst.
  <sub>src/data/onzuivere-huid.ts:166</sub>
- Nee, en dat onderscheid is niet cosmetisch. Bij onzuiverheden gaat het om verstopping zonder veel ontsteking; bij acne is de ontsteking het probleem. De aanpak en de volgorde zijn anders.
  <sub>src/data/onzuivere-huid.ts:171</sub>
- Bijna nooit. Wie een vette huid streng behandelt houdt een uitgedroogde huid over die meer talg maakt, en dan is het beeld na een maand slechter in plaats van beter.
  <sub>src/data/onzuivere-huid.ts:176</sub>
...
- Pigment dat zich na jaren zonblootstelling op een plek heeft opgehoopt. Onschuldig, en het meest voorkomende beeld op deze pagina.
  <sub>src/data/ouderdomsvlekken.ts:50</sub>
...
- Hier doet licht niets: het pigment zit in weefsel dat boven de huid uitsteekt. Verwijderen kan wel, maar dat gebeurt eerst na beoordeling.
  <sub>src/data/ouderdomsvlekken.ts:66</sub>
- Een ander mechanisme dan een zonnevlek: hormonaal aangestuurd en veel gevoeliger voor licht en warmte. Verkeerd behandelen maakt het aantoonbaar erger.
  <sub>src/data/ouderdomsvlekken.ts:78</sub>
- Dat kunnen wij niet beoordelen. Alles wat verandert hoort bekeken te worden voordat er iets mee gebeurt.
  <sub>src/data/ouderdomsvlekken.ts:91</sub>
- [ Eerst beoordelen of een plek onschuldig is, en bij twijfel doorsturen in plaats van behandelen, Een huidanalyse onder UV-licht, want daar zie je pigment dat er al zit en nog niet zichtbaar is, Zonbescherming, elke dag en het hele jaar. Zonder dat komen de vlekken terug en werkt de rest niet
  <sub>src/data/ouderdomsvlekken.ts:102</sub>
...
- [ Alles wat bruin is wegbranden. Een plek die verandert hoort eerst beoordeeld te worden , Melasma behandelen alsof het een zonnevlek is. Dat maakt het erger en niet beter
  <sub>src/data/ouderdomsvlekken.ts:108</sub>
...
- Alles wat bruin is wegbranden. Een plek die verandert hoort eerst beoordeeld te worden , Melasma behandelen alsof het een zonnevlek is. Dat maakt het erger en niet beter , Bleekcrèmes met hydrochinon op eigen houtje. Dat hoort onder begeleiding , Behandelen in de zomer zonder afspraken over zon. ...
  <sub>src/data/ouderdomsvlekken.ts:111</sub>
- Groeit iets, verschiet het van kleur, of heeft het een rafelige rand? Dan gaat het eerst naar de huisarts. Wegbranden maakt niet alleen de plek weg maar ook de mogelijkheid om hem te beoordelen, en dat is een fout die niet te herstellen is.
  <sub>src/data/ouderdomsvlekken.ts:119</sub>
- Ga je binnen een paar weken naar de zon of op wintersport, dan wachten we daarmee. Pigment komt na blootstelling terug en dan heb je voor niets betaald.
  <sub>src/data/ouderdomsvlekken.ts:124</sub>
- Een gewone zonnevlek is onschuldig. Andere plekjes lijken er in het begin op, en die zijn niet onschuldig altijd. Daarom is de eerste vraag hier niet hoe je ervan afkomt maar of het is wat je denkt.
  <sub>src/data/ouderdomsvlekken.ts:132</sub>
- De behandelde vlek komt niet terug, maar er kunnen nieuwe bij komen zolang je huid zon blijft vangen. Daarom is het advies dat zonbescherming hier geen advies achteraf is maar onderdeel van de behandeling.
  <sub>src/data/ouderdomsvlekken.ts:137</sub>
- Omdat pigment dieper in de huid begint dan waar je het ziet. De meting maakt zichtbaar wat er al ligt, en dat is soms confronterend. Het is ook nuttig: het verklaart waarom er zonder bescherming steeds nieuwe bij lijken te komen.
  <sub>src/data/ouderdomsvlekken.ts:142</sub>
- Ja, en dat is vaak de plek waar mensen het het eerst storend vinden. De huid daar is dunner en herstelt langzamer, dus we gaan er voorzichtiger te werk dan in het gezicht.
  <sub>src/data/ouderdomsvlekken.ts:147</sub>

**Inhoud: oxygeneo-rotterdam** (17)

- OxyGeneo is een gezichtsbehandeling waarbij een capsule op de huid met een gel reageert: de bovenste laag wordt losgemaakt, werkzame stoffen gaan erin, en de huid krijgt een prikkel om meer zuurstofrijk bloed naar het oppervlak te sturen. Bij Diba Clinics in Rotterdam duurt de behandeling ${OX.du...
  <sub>src/data/landings/oxygeneo-rotterdam.ts:34</sub>
- [ Een huid die dof staat, heeft vaak een laag dode cellen die te lang blijft zitten, en een oppervlak dat weinig licht terugkaatst. Crèmes komen door die laag slecht heen. Wat helpt is de laag losmaken en tegelijk iets teruggeven, en dat is precies wat deze behandeling in één doorgang doet.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:58</sub>
- [ Een huid die dof staat, heeft vaak een laag dode cellen die te lang blijft zitten, en een oppervlak dat weinig licht terugkaatst. Crèmes komen door die laag slecht heen. Wat helpt is de laag losmaken en tegelijk iets teruggeven, en dat is precies wat deze behandeling in één doorgang doet. , Het...
  <sub>src/data/landings/oxygeneo-rotterdam.ts:59</sub>
- [ Een huid die dof staat, heeft vaak een laag dode cellen die te lang blijft zitten, en een oppervlak dat weinig licht terugkaatst. Crèmes komen door die laag slecht heen. Wat helpt is de laag losmaken en tegelijk iets teruggeven, en dat is precies wat deze behandeling in één doorgang doet. , Het...
  <sub>src/data/landings/oxygeneo-rotterdam.ts:60</sub>
- [ Eerst gaan make-up en talg eraf, anders werkt de rest op een laagje in plaats van op je huid. Daarna gaat de gel op en beweegt de behandelaar het handstuk in banen over je gezicht. De gel en de capsule reageren met elkaar en dat bruist licht; je hoort het meer dan dat je het voelt., Erna is je ...
  <sub>src/data/landings/oxygeneo-rotterdam.ts:76</sub>
- Wil je het effect vasthouden, dan plan je het elke vier tot zes weken als onderhoud. Hoe vaak dat bij jou zin heeft, bespreken we bij de intake.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:93</sub>
- [ Littekens of pigment dat dieper zit. Daar is microneedling of laser voor
  <sub>src/data/landings/oxygeneo-rotterdam.ts:110</sub>
- [ Littekens of pigment dat dieper zit. Daar is microneedling of laser voor , Een huid die op dat moment ontstoken of geïrriteerd is. Die brengen we eerst tot rust
  <sub>src/data/landings/oxygeneo-rotterdam.ts:111</sub>
- [ Littekens of pigment dat dieper zit. Daar is microneedling of laser voor , Een huid die op dat moment ontstoken of geïrriteerd is. Die brengen we eerst tot rust , Blijvend verschil. Het effect houdt dagen aan, dus het is onderhoud
  <sub>src/data/landings/oxygeneo-rotterdam.ts:112</sub>
- Een mesje haalt dode cellen en donshaar weg. Voor een gladde huid onder make-up., ), vergelijkingsrij( led-therapie, Licht dat de huid rustiger maakt, zonder warmte. Vaak als toevoeging aan een andere behandeling.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:140</sub>
- Licht dat de huid rustiger maakt, zonder warmte. Vaak als toevoeging aan een andere behandeling. , ), vergelijkingsrij( peelings, Een zuur maakt de bovenlaag los en gaat dieper. Meer effect op verkleuring, en meer reactie van je huid.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:144</sub>
- CO2 dat vrijkomt als de capsule met de gel reageert. Je huid reageert daarop met een betere doorbloeding, en dat is precies de bedoeling.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:171</sub>
- Het effect houdt dagen aan, geen weken. Veel mensen plannen deze behandeling daarom vlak voor een gelegenheid, of elke vier tot zes weken als onderhoud.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:181</sub>
- Allebei werken ze op de bovenste laag en zonder hersteltijd. Een HydraFacial zuigt met onderdruk poriën leeg en brengt serum terug; OxyGeneo maakt de laag los met een capsule en een gel, waarbij je huid een prikkel krijgt om meer zuurstofrijk bloed naar het oppervlak te sturen. Voor verstopte por...
  <sub>src/data/landings/oxygeneo-rotterdam.ts:186</sub>
- Meestal wel. De behandelaar beoordeelt dat tijdens de intake; bij actieve rosacea of ontstoken acne brengen we eerst je huid tot rust.
  <sub>src/data/landings/oxygeneo-rotterdam.ts:191</sub>
...
- Naast acne is dit wat we het vaakst behandelen. Een verse plek trekt deels vanzelf weg; wat na maanden blijft staan, reageert goed op behandeling, en zonbescherming houdt het licht.
  <sub>src/data/pigment.ts:239</sub>
- Microneedling, want dat brengt de vernieuwing op gang in de laag waar het pigment zit. Zit het dieper of blijft het hardnekkig, dan komen daar peelings of een pigmenttraject bij. Altijd met zonbescherming, anders komt het terug.
  <sub>src/data/pigment.ts:241</sub>
- Tussen mei en augustus behandelen we pigment niet, hoe graag je ook wilt. Het resultaat is dan niet te houden. We meten wel, zodat we in september klaarstaan.
  <sub>src/data/pigment.ts:266</sub>
...
- Ja, en het vraagt een andere aanpak. Bij huidtype IV tot VI is de kans op nieuwe pigmentvlekken door de behandeling zelf groter, dus gaan we voorzichtiger en trager. Dat bespreken we vooraf.
  <sub>src/data/pigment.ts:299</sub>
- Een vlek die verandert van vorm of kleur, of die bloedt, laat je beoordelen door je huisarts. Dat is geen paniekverhaal maar de juiste route. We kijken er wel naar en verwijzen door als dat nodig is.
  <sub>src/data/pigment.ts:304</sub>
...
- Dit wordt vrijwel altijd voor schimmel aangezien en dan met het verkeerde middel behandeld. Nagelafwijkingen hangen bovendien samen met een grotere kans op gewrichtsklachten.
  <sub>src/data/psoriasis.ts:60</sub>
- Hier niet mee wachten. Schade aan een gewricht is blijvend, en juist daarom telt het als je er vroeg bij bent. Noem het bij je huisarts, ook als de huidplekken meevallen.
  <sub>src/data/psoriasis.ts:71</sub>
- [ Naar de huisarts bij scherp begrensde, schilferende plekken die niet weggaan. Er bestaat behandeling voor en die begint daar., Gewrichtsklachten meteen noemen, ook als je huid meevalt. Dit is het enige onderdeel waar wachten blijvende schade kan geven.
  <sub>src/data/psoriasis.ts:86</sub>
- [ Naar de huisarts bij scherp begrensde, schilferende plekken die niet weggaan. Er bestaat behandeling voor en die begint daar., Gewrichtsklachten meteen noemen, ook als je huid meevalt. Dit is het enige onderdeel waar wachten blijvende schade kan geven. , Je nagels laten zien tijdens dat gesprek...
  <sub>src/data/psoriasis.ts:88</sub>
- Actieve psoriasisplekken behandelen wij niet met huidbeschadigende of intensief exfoliërende behandelingen. Beschadiging kan op die plek juist een nieuwe plek uitlokken.
  <sub>src/data/psoriasis.ts:109</sub>
- Dat is genoeg reden om het te laten bekijken. Nagelafwijkingen zijn vaak het eerste of enige teken en worden bijna altijd voor schimmel aangezien.
  <sub>src/data/psoriasis.ts:132</sub>
...
- De huid heeft op die plek collageen en elasticiteit verloren en vouwt niet meer terug. Dit is waar een huidbehandeling werkt.
  <sub>src/data/rimpels.ts:83</sub>
- Niet een lijn maar de hele structuur die meegeeft: minder elasticiteit, minder steun, en zwaartekracht die zijn werk doet.
  <sub>src/data/rimpels.ts:96</sub>
- Aanspannen van de diepere lagen met laser, in een reeks. Wat losgelaten huid is wordt hier niet vastgezet; dat is chirurgie.
  <sub>src/data/rimpels.ts:98</sub>
- [ Eerst vaststellen of de lijn in de huid of in de spier zit, want die twee vragen om iets anders, Collageenopbouw op gang brengen, in een reeks over maanden en niet in een sessie, Zonbescherming, elke dag. Dit is verreweg de grootste factor in hoe snel er nieuwe lijnen bij komen
...
- [ Injectables. Wij werken er niet mee, en voor sommige lijnen is dat juist wel de logische route, Beloven dat lijnen verdwijnen. Minder diep en minder zichtbaar is realistisch
  <sub>src/data/rimpels.ts:113</sub>
- [ Injectables. Wij werken er niet mee, en voor sommige lijnen is dat juist wel de logische route, Beloven dat lijnen verdwijnen. Minder diep en minder zichtbaar is realistisch , Een reeks starten voor lijntjes die door droogte komen. Die zijn met verzorging weg, Losgelaten huid behandelen alsof h...
  <sub>src/data/rimpels.ts:115</sub>
- Injectables. Wij werken er niet mee, en voor sommige lijnen is dat juist wel de logische route, Beloven dat lijnen verdwijnen. Minder diep en minder zichtbaar is realistisch , Een reeks starten voor lijntjes die door droogte komen. Die zijn met verzorging weg, Losgelaten huid behandelen alsof het...
  <sub>src/data/rimpels.ts:116</sub>
- Botox en fillers horen niet bij wat wij doen. Bij een zuivere mimieklijn is dat vaak wél het antwoord, en dan zeggen we dat in plaats van je iets anders aan te bieden dat minder past.
  <sub>src/data/rimpels.ts:124</sub>
- Kijk een week lang op verschillende momenten. Een droogtelijntje verandert met de dag, het seizoen en je verzorging; een echte rimpel staat er elke ochtend hetzelfde bij.
  <sub>src/data/rimpels.ts:137</sub>
- Er is geen leeftijd. Wat er wel toe doet is of er iets te winnen valt: bij een huid die nog stevig is levert een reeks weinig op, en dan is zonbescherming de hele behandeling.
  <sub>src/data/rimpels.ts:147</sub>
...
- Rosacea is een chronische aandoening. Beheersing is het doel en dat noemen wij geen mislukking. Genezing beloven we daarom niet.
  <sub>src/data/rosacea.ts:268</sub>
- Nee, rosacea is chronisch. Wat wél kan: minder opvlammingen, minder zichtbare adertjes en een rustiger basiskleur. Bij de meeste mensen is dat een groot verschil in hoe ze zich voelen.
  <sub>src/data/rosacea.ts:286</sub>
- Het snelste onderscheid: bij acne zitten er mee-eters, bij rosacea niet. Rosacea zit ook meer in het midden van je gezicht en gaat samen met blozen. Zeker weten doe je het pas na een beoordeling.
  <sub>src/data/rosacea.ts:291</sub>
- Bij zichtbare vaatjes levert behandeling doorgaans het meeste op van alles wat we doen. Nieuwe vaatjes kunnen wel ontstaan zolang de triggers doorgaan, dus onderhoud hoort erbij.
  <sub>src/data/rosacea.ts:301</sub>

**Inhoud: skinboosters-rotterdam** (18)

- Een skinbooster is een behandeling waarbij werkzame stoffen, zoals hyaluronzuur en vitamines, met heel fijne prikjes ín de huid worden gebracht in plaats van erop. Bij Diba Clinics in Rotterdam gebeurt dat met de U225, die elke prik op dezelfde diepte zet. Een losse behandeling kost ${euro(LOS)} ...
  <sub>src/data/landings/skinboosters-rotterdam.ts:43</sub>
- [ Wat je op je huid smeert, komt voor het grootste deel niet verder dan de buitenste laag. Die laag is er juist om dingen tegen te houden. Voor vocht en stevigheid moeten stoffen als hyaluronzuur dieper zitten, in de huid zelf, en daar kom je met een crème niet.
  <sub>src/data/landings/skinboosters-rotterdam.ts:67</sub>
- [ Wat je op je huid smeert, komt voor het grootste deel niet verder dan de buitenste laag. Die laag is er juist om dingen tegen te houden. Voor vocht en stevigheid moeten stoffen als hyaluronzuur dieper zitten, in de huid zelf, en daar kom je met een crème niet. , Bij een skinbooster gaat een men...
  <sub>src/data/landings/skinboosters-rotterdam.ts:68</sub>
- [ Wat je op je huid smeert, komt voor het grootste deel niet verder dan de buitenste laag. Die laag is er juist om dingen tegen te houden. Voor vocht en stevigheid moeten stoffen als hyaluronzuur dieper zitten, in de huid zelf, en daar kom je met een crème niet. , Bij een skinbooster gaat een men...
  <sub>src/data/landings/skinboosters-rotterdam.ts:69</sub>
- [ Een filler brengt volume op één plek: een plooi opvullen, een lip voller maken, een contour veranderen. Een skinbooster doet dat niet. Hij wordt dun over het hele vlak verdeeld en werkt op de kwaliteit van je huid, niet op de vorm van je gezicht. Fillers zetten we hier niet.
  <sub>src/data/landings/skinboosters-rotterdam.ts:83</sub>
- [ Een filler brengt volume op één plek: een plooi opvullen, een lip voller maken, een contour veranderen. Een skinbooster doet dat niet. Hij wordt dun over het hele vlak verdeeld en werkt op de kwaliteit van je huid, niet op de vorm van je gezicht. Fillers zetten we hier niet. , Wat hier het vers...
  <sub>src/data/landings/skinboosters-rotterdam.ts:85</sub>
- Een kuur van drie kost ${euro(KUUR)}, tegen ${euro(3 * LOS)} voor drie losse behandelingen. Omdat de huid tussen de sessies het werk doet, is de kuur meestal ook de zinvolle keuze.
  <sub>src/data/landings/skinboosters-rotterdam.ts:102</sub>
- [ Een huid die vocht en stevigheid mist, over het hele vlak, Fijne lijntjes, ook rond de ogen met een booster die daarvoor bedoeld is, Pigment, zonneschade en melasma, met de depigmentatiebooster
  <sub>src/data/landings/skinboosters-rotterdam.ts:117</sub>
- [ Volume of een andere vorm. Dat is filler, en dat doen we niet, Diepe lijnen of plooien. Die haalt een skinbooster niet weg
  <sub>src/data/landings/skinboosters-rotterdam.ts:122</sub>
- Werkzame stoffen in de huid, verdeeld over het vlak met de U225. Werkt op vocht en stevigheid., ), vergelijkingsrij( rrs-hyalift, Een van de mengsels die we als skinbooster gebruiken: hyaluronzuur, vitamines en aminozuren.
  <sub>src/data/landings/skinboosters-rotterdam.ts:143</sub>
- Een van de mengsels die we als skinbooster gebruiken: hyaluronzuur, vitamines en aminozuren. , ), vergelijkingsrij( skinpen, Naalden zonder middel, zodat je huid zelf collageen aanmaakt. Meer voor structuur en littekens.
  <sub>src/data/landings/skinboosters-rotterdam.ts:147</sub>
- Naalden zonder middel, zodat je huid zelf collageen aanmaakt. Meer voor structuur en littekens. , ), vergelijkingsrij( fotona-4d, Laser in vier stappen, van binnenuit door de wang tot een afsluitende peeling. Werkt op verslapping, zonder naalden.
  <sub>src/data/landings/skinboosters-rotterdam.ts:151</sub>
- Laser in vier stappen, van binnenuit door de wang tot een afsluitende peeling. Werkt op verslapping, zonder naalden. , ), vergelijkingsrij( hydrafacial, Brengt serum in de bovenste laag, zonder naalden. Meteen zichtbaar, en korter van duur.
  <sub>src/data/landings/skinboosters-rotterdam.ts:155</sub>
- Een filler brengt volume op één plek en verandert een vorm. Een skinbooster wordt dun over het hele vlak verdeeld en werkt op het vocht en de stevigheid van de huid zelf. Fillers zetten we hier niet.
  <sub>src/data/landings/skinboosters-rotterdam.ts:182</sub>
- Vlak erna zie je kleine bultjes op de plek van elke prik; die zakken meestal binnen een dag. Blauwe plekjes kunnen, vooral rond de ogen, en die blijven langer. Plan het dus niet vlak voor een gelegenheid.
  <sub>src/data/landings/skinboosters-rotterdam.ts:192</sub>
- Omdat de huid tussen de sessies door het werk doet. Er zijn meerdere prikkels nodig voordat er iets wordt opgebouwd, met twee tot vier weken ertussen.
  <sub>src/data/landings/skinboosters-rotterdam.ts:197</sub>
- Je huid voelt vaak al snel vochtiger aan, maar het echte verschil bouwt zich over de kuur op. Hoe snel dat gaat, verschilt per huid.
  <sub>src/data/landings/skinboosters-rotterdam.ts:202</sub>
- Daar is een aparte booster voor, de depigmentatiebooster, voor gezicht, hals en decolleté bij pigment, zonneschade en melasma. Zonder dagelijkse zonbescherming loopt het pigment door, ook tijdens de kuur.
  <sub>src/data/landings/skinboosters-rotterdam.ts:207</sub>
...
- Het slappe weefsel achter in je mond trilt mee op de luchtstroom. Dit is de meest voorkomende bron en de enige waar een laser iets aan verandert.
  <sub>src/data/snurken.ts:57</sub>
- Een verstopte of scheve neus dwingt je tot ademen door je mond, en dan gaat het gehemelte pas meetrillen. De oorzaak zit dan een stuk eerder.
  <sub>src/data/snurken.ts:68</sub>
- De tong zakt in je slaap naar achteren en vernauwt de luchtweg. Dat is een ander mechanisme dan een trillend gehemelte.
  <sub>src/data/snurken.ts:79</sub>
- De ruimte achter in je keel is dan kleiner dan gemiddeld, ongeacht hoe strak het gehemelte staat.
  <sub>src/data/snurken.ts:90</sub>
- Eerst kijken waar het geluid vandaan komt, want dat bepaalt of dit bij jou iets oplevert, Doorsturen naar de huisarts als er ook maar één alarmsignaal is, ook als je hier al staat, NightLase als reeks van drie, met vooraf afgesproken momenten om te kijken of het werkt, Eerlijk zeggen dat het effe...
  <sub>src/data/snurken.ts:118</sub>
- [ Beginnen zonder te weten waar het geluid zit. Dan verkoop je een reeks en geen oplossing, Behandelen bij een vermoeden van slaapapneu. Daar hoort eerst slaaponderzoek bij
  <sub>src/data/snurken.ts:122</sub>
- [ Beginnen zonder te weten waar het geluid zit. Dan verkoop je een reeks en geen oplossing, Behandelen bij een vermoeden van slaapapneu. Daar hoort eerst slaaponderzoek bij , Beloven dat het snurken helemaal verdwijnt. Minder is realistisch, weg niet altijd
  <sub>src/data/snurken.ts:123</sub>
- Zijn er ademstops, of ben je overdag ongewoon slaperig, dan sturen we je naar de huisarts voor slaaponderzoek. Snurken zachter maken terwijl er ademstops onder zitten is het alarm uitzetten en het probleem laten staan.
  <sub>src/data/snurken.ts:132</sub>
- Van weefsel dat meetrilt op je ademhaling. In je slaap ontspannen de spieren in je keel, waardoor het zachte gehemelte en de huig gaan wapperen op de luchtstroom. Hoe nauwer de doorgang, hoe harder het geluid.
  <sub>src/data/snurken.ts:145</sub>
...
- Meestal drie, met ongeveer drie weken ertussen. Het effect bouwt over die reeks op; na de eerste sessie is er zelden al iets te horen.
  <sub>src/data/snurken.ts:160</sub>
- Niet vanzelf. Het weefsel geeft na verloop van tijd weer mee, en dan is een herhaling nodig. Definitief noemen we het daarom niet, en je hoort vooraf dat er een herhaling bij hoort.
  <sub>src/data/snurken.ts:165</sub>
...
- [ Elk plekje beoordelen voordat er iets mee gebeurt, ook als je precies weet wat je wil, Goedaardige steelwratjes weghalen, meestal in één afspraak, Per kwartier rekenen, zodat meerdere kleine plekjes tegelijk niet per stuk duurder worden, Doorsturen naar de huisarts bij alles wat verandert of ni...
  <sub>src/data/steelwratjes.ts:133</sub>
- [ Iets weghalen dat verandert. Dat hoort eerst door een arts beoordeeld te worden
  <sub>src/data/steelwratjes.ts:137</sub>
- [ Iets weghalen dat verandert. Dat hoort eerst door een arts beoordeeld te worden , Iets weghalen dat verandert. Dan is er niets meer over om te onderzoeken
  <sub>src/data/steelwratjes.ts:138</sub>
- [ Iets weghalen dat verandert. Dat hoort eerst door een arts beoordeeld te worden , Iets weghalen dat verandert. Dan is er niets meer over om te onderzoeken , Zelf afbinden met een draadje of afknippen met een nagelschaar. Dat gaat vaak lang goed en één keer niet, Beloven dat er nooit meer nieuwe...
  <sub>src/data/steelwratjes.ts:140</sub>
- Ook niet als je zeker weet wat het is en er speciaal voor bent gekomen. Wat weg is kan niet meer bekeken worden, en dat is een fout die niet te herstellen valt. Het kost twee minuten om er eerst naar te kijken.
  <sub>src/data/steelwratjes.ts:148</sub>
- Een moedervlek die stoort halen we weg. Verandert er iets aan de vorm, de kleur of het gevoel, dan gaat hij eerst langs je huisarts: die kan weefsel laten onderzoeken en dat kan achteraf niet meer.
  <sub>src/data/steelwratjes.ts:153</sub>
- Op die plekken schuurt huid over huid, en dat is de plek waar dit soort uitstulpinkjes ontstaan. Kleding, een ketting of een bh-bandje versnellen het. Aanleg speelt ook mee: bij sommige mensen komen ze met tientallen tegelijk.
  <sub>src/data/steelwratjes.ts:161</sub>
- Liever niet, en dat is geen omzetargument. Het gaat vaak lang goed en één keer niet, en die ene keer is een ontsteking in een hals of een litteken op een ooglid. Bovendien knip je dan iets weg dat niemand meer heeft bekeken.
  <sub>src/data/steelwratjes.ts:166</sub>
- Een verwijderd steelwratje komt niet terug, maar er kunnen nieuwe ontstaan op andere plekken. De aanleg en de wrijving veranderen niet door een behandeling.
  <sub>src/data/steelwratjes.ts:171</sub>
...
- Nee. Wat wel kan, is dat ze minder opvallen: minder rood, vlakker en minder voelbaar. Bij rode striae is er meer te halen dan bij witte.
  <sub>src/data/striae.ts:101</sub>
- Nee. We wachten tot na de bevalling en de borstvoeding, en beoordelen dan opnieuw. Vaak zijn ze op dat moment ook al lichter geworden.
  <sub>src/data/striae.ts:111</sub>
...
- Je gaf iets aan waarbij een arts hoort te kijken. Dat gaat vóór alles wat hieronder staat, en het is geen reden tot paniek maar wel om het niet te laten liggen. Bij ziek zijn met uitslag: bel vandaag.
  <sub>src/data/symptoomzoeker.ts:435</sub>
...
- Direct na een zonvakantie behandelen geeft een grotere kans op nieuwe pigmentvlekken. Dan wachten we, ook als dat je afspraak verzet.
  <sub>src/data/veroudering.ts:260</sub>
- Ja, maar anders. Een donkere huid vertoont minder snel lijntjes en meer pigmentverschuiving, en reageert feller op te agressieve behandeling. De instellingen en de volgorde zijn daarom anders.
  <sub>src/data/veroudering.ts:283</sub>
...
- Geen wal en geen kring, maar een dal. Door volumeverlies aan de rand van je oogkas valt er schaduw, en die lees je als donker.
  <sub>src/data/wallen.ts:100</sub>
- Geen wal maar een ophoping van vet (lipiden) in de huid van het ooglid. Het hangt vaak samen met een verhoogd cholesterol, en daarom is het ook iets voor je huisarts.
  <sub>src/data/wallen.ts:118</sub>
- [ Eerst vaststellen of het vocht, vet of schaduw is, want twee daarvan lossen we hier niet op, Bij vocht: afvoer stimuleren en de huid rond het oog steviger maken, in een reeks, Bij een pigmentwal, een bruine kleur onder het oog: de eye peel, vaak samen met RRS Eyes
  <sub>src/data/wallen.ts:155</sub>
- [ Eerst vaststellen of het vocht, vet of schaduw is, want twee daarvan lossen we hier niet op, Bij vocht: afvoer stimuleren en de huid rond het oog steviger maken, in een reeks, Bij een pigmentwal, een bruine kleur onder het oog: de eye peel, vaak samen met RRS Eyes , Zonbescherming rond de ogen,...
  <sub>src/data/wallen.ts:156</sub>
- Eerst vaststellen of het vocht, vet of schaduw is, want twee daarvan lossen we hier niet op, Bij vocht: afvoer stimuleren en de huid rond het oog steviger maken, in een reeks, Bij een pigmentwal, een bruine kleur onder het oog: de eye peel, vaak samen met RRS Eyes , Zonbescherming rond de ogen, w...
  <sub>src/data/wallen.ts:157</sub>
- [ Fillers onder het oog. Dat doen wij niet, en het is bij een echte wal ook zelden de oplossing, Agressieve behandelingen op de dunste huid van je gezicht
  <sub>src/data/wallen.ts:162</sub>
- Zit de bolling er s ochtends en s avonds hetzelfde bij, dan gaat het om het vetkussen achter je oog. Daar is een ingreep voor, en die hoort bij een cosmetisch arts of oogarts. Wij zouden je een reeks verkopen die niets verandert.
  <sub>src/data/wallen.ts:172</sub>
- Wij werken niet met injectables in dit gebied. Dat is een keuze en geen tekort: het is een lastige plek waar te veel of te ondiep spuiten jarenlang zichtbaar blijft.
  <sub>src/data/wallen.ts:177</sub>
- Een wal is volume: er zit iets, of het nu vocht of vet is. Een donkere kring is kleur: pigment of doorschijnende vaatjes in een dunne huid. Ze komen vaak samen voor en vragen om verschillende dingen. Gaat het bij jou vooral om kleur, lees dan verder op de pagina over donkere kringen.
  <sub>src/data/wallen.ts:185</sub>
- Bij vocht scheelt het, net als minder zout en minder alcohol voor het slapen. Bij vet of schaduw verandert er niets van, hoe goed je ook slaapt. Dat is precies waarom we eerst willen weten wat je hebt.
  <sub>src/data/wallen.ts:190</sub>
- Met je hoofd iets hoger slapen en koelen in de ochtend helpt tegen vocht, tijdelijk. Wrijven in je ogen is het enige dat je echt moet laten: de huid daar is de dunste van je lichaam en rekt makkelijk op.
  <sub>src/data/wallen.ts:195</sub>
...
- PCOS is een hormonale aandoening. Wij stellen die diagnose niet, behandelen die niet en nemen de oorzaak niet weg. Wat er op je huid van te zien is kunnen we wel aanpakken, en dat is iets anders.
  <sub>src/data/weigeren.ts:128</sub>
- De zichtbare gevolgen op je huid: overbeharing, acne en pigment. Wel met een eerlijke verwachting erbij, want zolang de hormonale oorzaak er is komen de klachten terug. Bij ontharing betekent dat onderhoud in plaats van een eindpunt.
  <sub>src/data/weigeren.ts:132</sub>

**Inhoud: zon-en-je-huid** (30)

- Licht en kleur zitten elkaar in de weg. Zit er verse kleur van zon of zonnebank in je huid, dan neemt die het licht van een laser of IPL op en gaat de energie naar de verkeerde plek; daarom wordt er op een gebruinde huid niet gelaserd. Na een behandeling is je huid juist gevoeliger voor zon, en d...
  <sub>src/data/landings/zon-en-je-huid.ts:35</sub>
- [ Onder invloed van UV maken de pigmentcellen in je opperhuid extra melanine. Dat pigment gaat als een laagje boven de celkernen liggen en vangt een deel van het licht op dat erna binnenkomt. Je huid doet dat om zichzelf te beschermen, en het is dus een teken dat er schade is opgetreden en niet d...
  <sub>src/data/landings/zon-en-je-huid.ts:59</sub>
- [ Onder invloed van UV maken de pigmentcellen in je opperhuid extra melanine. Dat pigment gaat als een laagje boven de celkernen liggen en vangt een deel van het licht op dat erna binnenkomt. Je huid doet dat om zichzelf te beschermen, en het is dus een teken dat er schade is opgetreden en niet d...
  <sub>src/data/landings/zon-en-je-huid.ts:60</sub>
- [ Onder invloed van UV maken de pigmentcellen in je opperhuid extra melanine. Dat pigment gaat als een laagje boven de celkernen liggen en vangt een deel van het licht op dat erna binnenkomt. Je huid doet dat om zichzelf te beschermen, en het is dus een teken dat er schade is opgetreden en niet d...
  <sub>src/data/landings/zon-en-je-huid.ts:61</sub>
- [ Onder invloed van UV maken de pigmentcellen in je opperhuid extra melanine. Dat pigment gaat als een laagje boven de celkernen liggen en vangt een deel van het licht op dat erna binnenkomt. Je huid doet dat om zichzelf te beschermen, en het is dus een teken dat er schade is opgetreden en niet d...
  <sub>src/data/landings/zon-en-je-huid.ts:62</sub>
- [ Kom je met verse kleur van zon of zonnebank, dan gaat een behandeling met licht niet door. Het licht mikt op pigment, en het pigment dat je net hebt opgebouwd ligt ervoor. De energie komt dan terecht in de bovenlaag in plaats van bij de haarwortel of de vlek, en dat geeft een kans op een brandp...
  <sub>src/data/landings/zon-en-je-huid.ts:76</sub>
- [ Kom je met verse kleur van zon of zonnebank, dan gaat een behandeling met licht niet door. Het licht mikt op pigment, en het pigment dat je net hebt opgebouwd ligt ervoor. De energie komt dan terecht in de bovenlaag in plaats van bij de haarwortel of de vlek, en dat geeft een kans op een brandp...
  <sub>src/data/landings/zon-en-je-huid.ts:78</sub>
- [ De meting en het advies, ook vlak voor vertrek, Behandelingen die niet met licht werken, in overleg met je behandelaar
  <sub>src/data/landings/zon-en-je-huid.ts:94</sub>
- [ Laser of IPL op een huid met verse kleur van zon of zonnebank
  <sub>src/data/landings/zon-en-je-huid.ts:99</sub>
- [ Laser of IPL op een huid met verse kleur van zon of zonnebank , Een peeling vlak voor een week in de volle zon
  <sub>src/data/landings/zon-en-je-huid.ts:100</sub>
- [ Nee. Het licht mikt op pigment, en verse kleur ligt ervoor.
  <sub>src/data/landings/zon-en-je-huid.ts:119</sub>
- [ Nee. Het licht mikt op pigment, en verse kleur ligt ervoor. , De behandelde zone uit de volle zon houden en beschermen.
  <sub>src/data/landings/zon-en-je-huid.ts:120</sub>
- [ Nee. IPL stuurt meer golflengtes tegelijk en is hier nog gevoeliger voor.
  <sub>src/data/landings/zon-en-je-huid.ts:127</sub>
- [ Nee. IPL stuurt meer golflengtes tegelijk en is hier nog gevoeliger voor. , Dagelijks beschermen, anders komt de verkleuring terug.
  <sub>src/data/landings/zon-en-je-huid.ts:128</sub>
- [ Meestal niet, en anders in een lagere sterkte.
  <sub>src/data/landings/zon-en-je-huid.ts:135</sub>
- [ Meestal niet, en anders in een lagere sterkte. , Vervellen laten gebeuren, niet plukken, dagelijks SPF 50.
  <sub>src/data/landings/zon-en-je-huid.ts:136</sub>
- [ Vaak wel, mits je huid niet verbrand is.
  <sub>src/data/landings/zon-en-je-huid.ts:143</sub>
- [ Vaak wel, mits je huid niet verbrand is. , Een paar dagen rood, daarna beschermen tegen UV.
  <sub>src/data/landings/zon-en-je-huid.ts:144</sub>
- [ Nee, en we starten sowieso niet tussen mei en augustus., Vervellen, en daarna het hele jaar door beschermen.
  <sub>src/data/landings/zon-en-je-huid.ts:152</sub>
- [ Niet op een gebruinde huid; het blijft een laser.
  <sub>src/data/landings/zon-en-je-huid.ts:159</sub>
- [ Niet op een gebruinde huid; het blijft een laser. , Een dag rood en warm, daarna beschermen.
  <sub>src/data/landings/zon-en-je-huid.ts:160</sub>
- [ Ja, tenzij je huid verbrand is.
  <sub>src/data/landings/zon-en-je-huid.ts:175</sub>
- Tot je huid haar eigen kleur terug heeft. Hoeveel weken dat duurt hoor je bij de intake, want het hangt af van je huidtype, van hoeveel kleur er is en van de zone. Wat je zelf ziet in de spiegel loopt meestal voor op wat er in je huid nog aan pigment zit.
  <sub>src/data/landings/zon-en-je-huid.ts:193</sub>
- De behandelde zone hoort in de eerste dagen uit de volle zon, en daarna beschermd. Een huid die net behandeld is reageert heftiger op UV, en dan kan er een verkleuring achterblijven die er eerst niet was. Bedekken werkt beter dan insmeren alleen.
  <sub>src/data/landings/zon-en-je-huid.ts:198</sub>
- Ja, precies zo. Een zonnebank maakt hetzelfde pigment aan als de zon, en dat pigment ligt op dezelfde manier in de weg bij een behandeling met licht. Zeg het dus ook als je kleur van een zonnebank komt.
  <sub>src/data/landings/zon-en-je-huid.ts:203</sub>
- SPF 50, elke dag, ook als het bewolkt is. Bij een peeling en bij een pigmenttraject is dat geen bijzaak maar een deel van de behandeling: zonder bescherming loopt het resultaat binnen een seizoen terug.
  <sub>src/data/landings/zon-en-je-huid.ts:208</sub>
- Omdat een traject als Cosmelan of Dermamelan maanden duurt en je huid in die tijd extra gevoelig is voor UV. In de zomerse maanden werkt de zon de behandeling tegen, en dan betaal je voor een resultaat dat meteen weer terugloopt. We starten daarom buiten de maanden mei tot en met augustus.
  <sub>src/data/landings/zon-en-je-huid.ts:218</sub>
- Je eigen kleur is iets anders dan verse kleur van de zon. Op elk huidtype wordt hier behandeld, met een instelling die daarbij past. Waar het om gaat is de kleur die er sinds kort bij is gekomen, want daar is de instelling niet op afgestemd.
  <sub>src/data/landings/zon-en-je-huid.ts:223</sub>
- Bij een pigmenttraject en in de weken na een peeling wel, elke dag. UV komt ook door bewolking en door glas heen, en pigmentcellen reageren daar het hele jaar op. Buiten die trajecten is het vooral een kwestie van gewoonte: wat je in de winter overslaat, sla je in maart ook over.
  <sub>src/data/landings/zon-en-je-huid.ts:233</sub>
- Bij pigment is het het grootste deel van het werk. Een vlek die lichter is gemaakt, komt terug zodra er weer UV op valt, en dat gaat sneller dan de behandeling hem lichter maakte. Dagelijks beschermen is daarmee goedkoper dan opnieuw behandelen.
  <sub>src/data/landings/zon-en-je-huid.ts:238</sub>

**Inhoud: zwanger-of-borstvoeding** (37)

- Tijdens een zwangerschap en in de periode dat je borstvoeding geeft doen we een deel van de behandelingen niet: voor peelings, microneedling, skinboosters en de pigmenttrajecten ontbreekt het onderzoek om te kunnen zeggen dat het veilig is. Wat wel kan is meten, adviseren en de rustige gezichtsbe...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:38</sub>
- [ Zwangere vrouwen worden om begrijpelijke redenen niet in onderzoek naar huidbehandelingen opgenomen. Daardoor is er voor een deel van wat wij doen geen enkel bewijs dat het veilig is, en ook niet dat het schadelijk is. Als die twee allebei ontbreken, is het niet doen de enige keuze die te verde...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:62</sub>
- [ Zwangere vrouwen worden om begrijpelijke redenen niet in onderzoek naar huidbehandelingen opgenomen. Daardoor is er voor een deel van wat wij doen geen enkel bewijs dat het veilig is, en ook niet dat het schadelijk is. Als die twee allebei ontbreken, is het niet doen de enige keuze die te verde...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:63</sub>
- [ Zwangere vrouwen worden om begrijpelijke redenen niet in onderzoek naar huidbehandelingen opgenomen. Daardoor is er voor een deel van wat wij doen geen enkel bewijs dat het veilig is, en ook niet dat het schadelijk is. Als die twee allebei ontbreken, is het niet doen de enige keuze die te verde...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:64</sub>
- [ Zwangere vrouwen worden om begrijpelijke redenen niet in onderzoek naar huidbehandelingen opgenomen. Daardoor is er voor een deel van wat wij doen geen enkel bewijs dat het veilig is, en ook niet dat het schadelijk is. Als die twee allebei ontbreken, is het niet doen de enige keuze die te verde...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:65</sub>
- [ De meting kan altijd. Je huid wordt in kaart gebracht, je hoort wat er speelt en wat er straks bij past, en die opname is het vertrekpunt waarmee je na de borstvoeding meteen kunt beginnen. Voor wie in deze periode juist verandering in haar huid ziet, is dat vaak het nuttigste wat er nu te doen...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:81</sub>
- [ De meting kan altijd. Je huid wordt in kaart gebracht, je hoort wat er speelt en wat er straks bij past, en die opname is het vertrekpunt waarmee je na de borstvoeding meteen kunt beginnen. Voor wie in deze periode juist verandering in haar huid ziet, is dat vaak het nuttigste wat er nu te doen...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:82</sub>
- [ De meting kan altijd. Je huid wordt in kaart gebracht, je hoort wat er speelt en wat er straks bij past, en die opname is het vertrekpunt waarmee je na de borstvoeding meteen kunt beginnen. Voor wie in deze periode juist verandering in haar huid ziet, is dat vaak het nuttigste wat er nu te doen...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:83</sub>
- [ De huidanalyse en het advies, in elke maand, Dermaplaning en een rustige gezichtsbehandeling, in overleg
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:101</sub>
- [ Peelings met zuren, ook de mildere sterktes
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:106</sub>
- [ Peelings met zuren, ook de mildere sterktes , Microneedling, op het gezicht en op het lichaam
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:107</sub>
- [ Peelings met zuren, ook de mildere sterktes , Microneedling, op het gezicht en op het lichaam , Skinboosters en alles wat met een naald de huid in gaat
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:108</sub>
- [ Peelings met zuren, ook de mildere sterktes , Microneedling, op het gezicht en op het lichaam , Skinboosters en alles wat met een naald de huid in gaat , De pigmenttrajecten Cosmelan en Dermamelan
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:109</sub>
- [ Kan. Geen zuren, alleen de buitenste laag.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:135</sub>
- [ Kan. Geen zuren, alleen de buitenste laag. , Kan.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:136</sub>
- [ Meestal wel, met aangepaste producten.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:143</sub>
- [ Meestal wel, met aangepaste producten. , Meestal wel.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:144</sub>
- [ Nee. Staat als contra-indicatie bij de peelinglijnen.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:151</sub>
- [ Nee. Staat als contra-indicatie bij de peelinglijnen. , Nee.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:152</sub>
- [ Nee, ook niet op het lichaam.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:159</sub>
- [ Nee, ook niet op het lichaam. , Nee.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:160</sub>
- [ Nee. Staat als contra-indicatie bij de U225.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:167</sub>
- [ Nee. Staat als contra-indicatie bij de U225. , Nee.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:168</sub>
- [ In overleg; meestal wachten we tot erna.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:175</sub>
- [ In overleg; meestal wachten we tot erna. , In overleg.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:176</sub>
- [ In overleg; pigment verandert nu toch.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:183</sub>
- [ In overleg; pigment verandert nu toch. , In overleg.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:184</sub>
- [ Nee. We beginnen er in deze periode niet aan., Nee.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:192</sub>
- Een rustige, reinigende behandeling kan meestal wel, met producten die daarop uitgezocht zijn. Dermaplaning kan ook, want daarbij komen geen zuren aan te pas. Wat er in jouw geval past, beoordeelt de behandelaar bij de afspraak.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:217</sub>
- Nee. We behandelen dan niet met microneedling, ook niet op het lichaam en ook niet in een lagere diepte. Na de borstvoeding beoordelen we opnieuw; bij striae is dat vaak ook het moment waarop ze uit zichzelf al lichter zijn geworden.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:222</sub>
- Nee. Zwangerschap en borstvoeding staan bij onze peelinglijnen als contra-indicatie, en dat geldt ook voor de mildere sterktes. Voor een huid die in deze periode ruw of dof staat, kijken we naar wat er zonder zuren mogelijk is.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:227</sub>
- Dat bespreken we per geval, en meestal wachten we tot erna. Er is geen onderzoek dat schade aantoont, maar er is ook geen onderzoek dat veiligheid aantoont, en daar komt bij dat haargroei door de hormonen toch verandert. Zeg het bij het boeken, dan kiezen we samen het moment.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:232</sub>
- Beschermen wel, behandelen niet. Vlekken die door de hormonen zijn opgekomen trekken na de zwangerschap vaak grotendeels weg, en behandelen terwijl de aanjager nog aan staat levert weinig blijvends op. Dagelijkse zonbescherming houdt ze in die tijd zo licht mogelijk.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:237</sub>
- Geef je geen borstvoeding, dan kan er na de bevalling weer gemeten en behandeld worden zodra je je er goed bij voelt. Geef je wel borstvoeding, dan wachten we daarmee tot die periode voorbij is. De meting kan intussen gewoon.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:242</sub>
- Nee. Retinol en de verwante vitamine A-zuren laat je in deze periode staan, en dat geldt ook voor de sterkere zuren uit je eigen routine. Wat er dan wel past is meestal een eenvoudiger schema: rustig reinigen, een vochtinbrenger en dagelijkse zonbescherming. Neem je producten mee naar de afspraak...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:256</sub>
- Binnen de grenzen hierboven wel. Wat in deze periode afvalt zijn de zuren, de medicatie en de behandelingen die de huid in gaan; wat overblijft is een rustige reiniging, een aangepaste thuisroutine en meekijken hoe het verloopt. Vaak zakt het na de bevalling weer, en dan pakken we op wat er dan n...
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:261</sub>
- Omdat voor een deel van de stoffen die bij een behandeling gebruikt worden niet onderzocht is wat er in de moedermelk terechtkomt. Dat is dezelfde reden als bij de zwangerschap: het ontbreken van onderzoek, en niet een aangetoond gevaar.
  <sub>src/data/landings/zwanger-of-borstvoeding.ts:266</sub>
