...
export const WEIGERINGEN: readonly Weigering[] = [
  {
    ...
    kost: "Onze teksten klinken voorzichtiger dan die van de buren. Dat scheelt klanten die op een groot getal afkomen.",
    zieOok: {
  ...
  },
  {
    ...
    kost: "Een deel van de mensen dat binnenkomt gaat weg zonder afspraak. Dat is geen omzet die we mislopen, dat is de bedoeling.",
    zieOok: {
      tekst: "Zie de littekenklok",
      pad: "/huidproblemen/littekens#hoe-oud",
    },
  },
  {
  ...
  },
  {
    ...
    kost: "Verzette afspraken, gaten in de agenda, en soms een teleurgestelde klant die er klaar voor dacht te zijn.",
    zieOok: {
      tekst: "Zie de stapelteller",
      pad: "/huidproblemen/gevoelige-huid#teller",
    },
  },
  {
    ...
    kost: "Een half jaar wachten in het drukste seizoen, met de kans dat iemand ondertussen ergens anders begint.",
  ...
  },
  {
    ...
    kost: "Vooruitbetaalde pakketten zijn de zekerste omzet die een kliniek kan hebben. Die zekerheid hebben wij niet.",
  ...
  },
  {
    ...
    zieOok: {
      ...
      pad: "/huidproblemen/porien#meten",
    },
  },
];
