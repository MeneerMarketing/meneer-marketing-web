          ...
          <ul className="mt-5 space-y-3">
            {kleur.routes.map((r) => (
              <li key={r.naam}>
                <Link
                  href={r.pad}
                  className="block rounded-[var(--r-sm)] border border-[var(--g-100)] bg-white p-5 transition-colors hover:border-[var(--g-300)] hover:bg-[var(--g-050)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--g-700)]"
                >
