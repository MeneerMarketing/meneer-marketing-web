...
import Pagina from "@/app/(nl)/kennisbank/[slug]/page";
import { generateMetadata as nlMeta } from "@/app/(nl)/kennisbank/[slug]/page";
import { generateStaticParams as nlParams } from "@/app/(nl)/kennisbank/[slug]/page";
...
/**
 * De en versie van /kennisbank/[slug], op het adres /en/knowledge/[slug].
 *
...
export async function generateMetadata(
  ...
  return vertaaldeMetadata(basis, "en", "/en/knowledge/[slug]");
}
