...
import Pagina from "@/app/(nl)/huidproblemen/littekens/page";
import { metadata as nlMetadata } from "@/app/(nl)/huidproblemen/littekens/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De en versie van /huidproblemen/littekens, op het adres /en/skin-concerns/scars.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("en");
  return vertaaldeMetadata(nlMetadata, "en", "/en/skin-concerns/scars");
}
