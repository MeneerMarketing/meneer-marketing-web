...
import Pagina from "@/app/(nl)/huidproblemen/gevoelige-huid/page";
import { metadata as nlMetadata } from "@/app/(nl)/huidproblemen/gevoelige-huid/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De en versie van /huidproblemen/gevoelige-huid, op het adres /en/skin-concerns/sensitive-skin.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return vertaaldeMetadata(
    nlMetadata,
    "en",
    "/en/skin-concerns/sensitive-skin",
  );
}
