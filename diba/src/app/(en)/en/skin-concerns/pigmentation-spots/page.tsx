...
import Pagina from "@/app/(nl)/huidproblemen/pigmentvlekken/page";
import { metadata as nlMetadata } from "@/app/(nl)/huidproblemen/pigmentvlekken/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De en versie van /huidproblemen/pigmentvlekken, op het adres /en/skin-concerns/pigmentation-spots.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return vertaaldeMetadata(
    nlMetadata,
    "en",
    "/en/skin-concerns/pigmentation-spots",
  );
}
