...
/**
 * De en versie van /huidproblemen/striae, op het adres /en/skin-concerns/stretch-marks.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("en");
  return vertaaldeMetadata(nlMetadata, "en", "/en/skin-concerns/stretch-marks");
}
