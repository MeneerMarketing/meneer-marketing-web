...
import Pagina from "@/app/(nl)/huidproblemen/steelwratjes/page";
import { metadata as nlMetadata } from "@/app/(nl)/huidproblemen/steelwratjes/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De en versie van /huidproblemen/steelwratjes, op het adres /en/skin-concerns/skin-tags.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("en");
  return vertaaldeMetadata(nlMetadata, "en", "/en/skin-concerns/skin-tags");
}
