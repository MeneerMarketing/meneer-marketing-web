...
/**
 * De en versie van /kwaliteit-en-registraties, op het adres /en/quality-and-registrations.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("en");
  return vertaaldeMetadata(nlMetadata, "en", "/en/quality-and-registrations");
}
