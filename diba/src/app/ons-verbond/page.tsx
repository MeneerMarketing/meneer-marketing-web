      ...
      <section className="bg-[var(--g-700)] text-[var(--on-dark)] px-5 sm:px-9 lg:px-[7.5vw]">
        <div className="py-14 lg:py-20">
          ...
          >
            ...
            <span className="text-[var(--on-dark-body)]">Ons verbond</span>
          </nav>

          <h1 className="diba-display-l mt-6 max-w-[21ch]">
            Tien dingen
            <br />
            <span className="diba-accent-on-dark">die wij niet doen.</span>
          </h1>
          ...
          <div className="mt-9">
            <Button variant="primair-op-donker" href="#weigeringen">
              Lees de tien
            </Button>
          </div>
        </div>
