        ...
        <div className="grid gap-10 py-14 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
          <div>
            ...
            >
              ...
              <span aria-hidden="true">/</span>
              <span className="text-[var(--on-dark-body)]">Psoriasis</span>
            </nav>

            <h1 className="diba-display-l mt-6">
              Psoriasis en <span className="diba-accent-on-dark">je huid</span>
            </h1>
            ...
            <div className="mt-9">
              <Button variant="primair-op-donker" href="#silhouet">
                Bekijk waar het zit
              </Button>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 text-[var(--t-strong)] sm:p-10">
            <Label>Waar je niet mee wacht</Label>
