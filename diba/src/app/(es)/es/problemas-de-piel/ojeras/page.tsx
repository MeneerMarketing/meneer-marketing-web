...
/**
 * De es versie van /huidproblemen/donkere-kringen, op het adres /es/problemas-de-piel/ojeras.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/problemas-de-piel/ojeras");
}
