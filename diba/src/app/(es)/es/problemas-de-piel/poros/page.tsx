...
import Pagina from "@/app/(nl)/huidproblemen/porien/page";
import { metadata as nlMetadata } from "@/app/(nl)/huidproblemen/porien/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De es versie van /huidproblemen/porien, op het adres /es/problemas-de-piel/poros.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/problemas-de-piel/poros");
}
