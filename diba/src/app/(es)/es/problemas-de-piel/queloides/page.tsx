...
import Pagina from "@/app/(nl)/huidproblemen/keloiden/page";
import { metadata as nlMetadata } from "@/app/(nl)/huidproblemen/keloiden/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De es versie van /huidproblemen/keloiden, op het adres /es/problemas-de-piel/queloides.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/problemas-de-piel/queloides");
}
