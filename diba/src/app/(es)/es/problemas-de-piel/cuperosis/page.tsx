...
/**
 * De es versie van /huidproblemen/couperose, op het adres /es/problemas-de-piel/cuperosis.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/problemas-de-piel/cuperosis");
}
