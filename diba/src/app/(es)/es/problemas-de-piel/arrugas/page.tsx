...
import Pagina from "@/app/(nl)/huidproblemen/rimpels/page";
import { metadata as nlMetadata } from "@/app/(nl)/huidproblemen/rimpels/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De es versie van /huidproblemen/rimpels, op het adres /es/problemas-de-piel/arrugas.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/problemas-de-piel/arrugas");
}
