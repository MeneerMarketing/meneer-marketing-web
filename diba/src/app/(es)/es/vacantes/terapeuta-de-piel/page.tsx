...
import Pagina from "@/app/(nl)/vacatures/huidtherapeut/page";
import { metadata as nlMetadata } from "@/app/(nl)/vacatures/huidtherapeut/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De es versie van /vacatures/huidtherapeut, op het adres /es/vacantes/terapeuta-de-piel.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/vacantes/terapeuta-de-piel");
}
