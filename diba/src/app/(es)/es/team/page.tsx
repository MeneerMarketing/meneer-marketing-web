...
import Pagina from "@/app/(nl)/team/page";
import { metadata as nlMetadata } from "@/app/(nl)/team/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De es versie van /team, op het adres /es/team.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/team");
}
