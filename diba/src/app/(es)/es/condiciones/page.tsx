...
import Pagina from "@/app/(nl)/algemene-voorwaarden/page";
import { metadata as nlMetadata } from "@/app/(nl)/algemene-voorwaarden/page";
import { zetTaal } from "@/lib/taalcontext";
import { vertaaldeMetadata } from "@/lib/vertaalde-metadata";

/**
 * De es versie van /algemene-voorwaarden, op het adres /es/condiciones.
 *
...
export async function generateMetadata(): Promise<Metadata> {
  zetTaal("es");
  return vertaaldeMetadata(nlMetadata, "es", "/es/condiciones");
}
