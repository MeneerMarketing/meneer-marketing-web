    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
      ...
      <section className="bg-[var(--g-700)] text-[var(--on-dark)] px-5 sm:px-9 lg:px-[7.5vw]">
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 sm:p-10 text-[var(--t-strong)]">
            <Label>{t("Wie dit beleid voert")}</Label>
            ...
            <p className="mt-5 text-[16px] leading-7 text-[var(--t-body)]">
              {t("Vragen over je gegevens gaan naar")}{" "}
              <a
              ...
              {t("of telefonisch naar")} {DIBA_TELEFOON}
              {t(
      ...
      <section className="bg-[var(--g-025)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          <div>
            <Label>{t("Vier plekken")}</Label>
            <h2 className="diba-display-m mt-4">
              {t("Waar je gegevens")}{" "}
              <span className="diba-accent">{t("wel terechtkomen.")}</span>
            </h2>
              ...
              >
                ...
                >
                  <span className="diba-label block text-[var(--t-label)]">
                    {t("Waar het heen gaat")}
                  </span>
                  <span className="mt-2 block">{tc(p.heen)}</span>
                </p>
              </li>
            ))}
          </ul>
            ...
            <table className="w-full border-collapse text-left">
              ...
              <tbody>
                {TERMIJNEN.map((t) => (
                  <tr
                    key={tc(t.wat)}
                    className="border-b border-[var(--g-100)]"
                  >
        ...
        <div className="mx-auto">
          <div className="rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-12 lg:p-14">
            <div className="max-w-[62ch]">
              <Label opDonker>{t("Wat je kunt vragen")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[20ch]">
                {t("Zes rechten,")}{" "}
                <span className="diba-accent-on-dark">
                  {" "}
                  {t("ongeacht waar iets ligt.")}
                </span>
              </h2>
            ...
            <ul className="mt-8 sm:mt-12 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {RECHTEN.map((r) => (
                <li
                  key={tc(r.kop)}
                  className="rounded-[var(--r-lg)] bg-white/10 p-6 sm:p-7"
                >
                  <p className="text-[18px] leading-7 font-medium">
                    {tc(r.kop)}
                  </p>
