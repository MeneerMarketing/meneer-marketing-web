    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-16">
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-[var(--r-lg)] rounded-bl-[4.5rem] bg-[var(--g-600)] sm:aspect-[16/10] lg:aspect-auto lg:h-[460px] lg:rounded-bl-[8rem]">
              <Image
                ...
                alt={tc(
                  "Laserbehandeling in de behandelkamer, met oogbescherming voor behandelaar en cliënt",
                )}
                fill
                priority
      ...
      <section className="bg-[var(--g-050)] px-5 py-10 sm:px-9 lg:px-[7.5vw] lg:py-12">
        <div className="mx-auto">
          <Label>{t("Waar wil je iets aan doen")}</Label>
          <div className="mt-5">
            <Wenskiezer />
          </div>
        </div>
      ...
      >
        <div className="mx-auto">
          <Label>{t("Alles op een rij")}</Label>
          <h2 className="diba-display-m mt-4 max-w-[20ch]">
            {t("Alle behandelingen,")}{" "}
            <span className="diba-accent">{t("op wat je wilt bereiken")}</span>
          </h2>
      ...
      <section className="bg-white px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-20">
        <div className="mx-auto">
          <Label>{t("Meest gevraagd")}</Label>
          <h2 className="diba-display-m mt-4 max-w-[20ch]">
            {t("Waar mensen het vaakst")}{" "}
            <span className="diba-accent">{t("voor komen")}</span>
          </h2>
      ...
      <section className="bg-[var(--g-050)] px-5 py-12 sm:py-20 sm:px-9 lg:px-[7.5vw] lg:py-28">
        <div className="mx-auto">
          <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end lg:gap-16">
            <div>
              <Label>{t("Vaak samen")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[16ch]">
                {t("Twee behandelingen,")}{" "}
                <span className="diba-accent">{t("één afspraak")}</span>
              </h2>
            </div>
          ...
          <p className="mt-8 max-w-[58ch] text-[15px] leading-7 text-[var(--t-muted)]">
            {t(
              "De tarieven van de combinaties staan bij de losse behandelingen op de",
            )}{" "}
            <Link
              href="/tarieven"
          ...
          >
            <div>
              ...
              <p className="mt-4 max-w-[62ch] text-[16px] leading-7 text-[var(--t-body)]">
                {t(
                  "Je weet wat je aan je huid wilt verbeteren, maar niet of daar een peeling, een laser of microneedling bij hoort. Vertel wat je stoort; de behandelaar kiest en legt uit waarom.",
                )}
              </p>
            </div>
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-20">
        <div className="mx-auto grid gap-8 rounded-[var(--r-lg)] bg-white p-8 sm:p-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-14 lg:p-12">
          <div>
            <Label>{t("Begin hier")}</Label>
            <h2 className="diba-display-s mt-3 max-w-[20ch]">
              {t("Weet je niet wat bij")}{" "}
              <span className="diba-accent">{t("jouw huid past?")}</span>
            </h2>
            ...
            <LeesVerder>
              <p className="mt-4 max-w-[54ch] text-[16px] leading-7 text-[var(--t-body)]">
                {t("Het consult kost")} {intakeBedrag}{" "}
                {t(
                  "en duurt dertig minuten. Wil je in dezelfde afspraak behandeld worden, boek dan een behandeling op advies; dat bedrag gaat er dan weer af.",
                )}
              </p>
            </LeesVerder>
          </div>
          <div className="diba-knoprij lg:justify-end">
            ...
            >
              <span className="sm:hidden">{t("Huidprofiel")}</span>
              <span className="max-sm:hidden">
                {t("Of maak eerst je huidprofiel")}
              </span>
            </Link>
          </div>
        </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:gap-16">
            <div>
              ...
              <h2 className="diba-display-m mt-4 max-w-[16ch]">
                {t("Waar het aankomt")}
                <br />
                <span className="diba-accent">{t("bepaalt de rest")}</span>
              </h2>
            </div>
      ...
      <section className="bg-[var(--g-025)] px-5 py-12 max-lg:hidden sm:py-20 sm:px-9 lg:px-[7.5vw] lg:py-28">
        <div className="mx-auto">
          <Label>{t("Of filter zelf")}</Label>
          <h2 className="diba-display-m mt-4 max-w-[20ch]">
            {t("Hoeveel hersteltijd")}{" "}
            <span className="diba-accent">{t("heb je eigenlijk?")}</span>
          </h2>
          <p className="mt-6 max-w-[58ch] text-[16px] leading-7 text-[var(--t-body)]">
            {t(
        ...
        <div className="mx-auto">
          <div className="relative overflow-hidden rounded-[var(--r-xl)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-14">
            ...
            <div className="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:gap-16">
              <div>
                <Label opDonker>{t("Beginnen")}</Label>
                <h2 className="diba-display-m mt-4 max-w-[16ch]">
                  {t("Zo kies je")}
                  <br />
                  <span className="diba-accent-on-dark">
              ...
              <div>
                ...
                <div className="mt-8 diba-knoprij">
                  ...
                  >
                    <span className="sm:hidden">{t("Huidprobleem")}</span>
                    <span className="max-sm:hidden">
                      {t("Of begin bij je huidprobleem")}
                    </span>
                  </Link>
                </div>
              </div>
