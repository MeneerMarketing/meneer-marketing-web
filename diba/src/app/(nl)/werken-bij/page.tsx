    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
          <div>
            ...
            <h1 className="diba-display-l mt-6 max-w-[21ch]">
              {t("Werken bij")}
              <br />
              <span className="diba-accent-on-dark">{t("Diba Clinics")}</span>
            </h1>

            <p className="mt-7 max-w-[54ch] text-[17px] leading-8 text-[var(--on-dark-body)]">
              {t("We zijn met")} {TEAM_AANTAL}
              {t(", waarvan")} {huidtherapeuten}{" "}
              {t(
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 sm:p-10 text-[var(--t-strong)]">
            ...
            <p className="mt-6 border-t border-[var(--g-050)] pt-5 text-[14px] leading-6 text-[var(--t-muted)]">
              {t("Solliciteren gaat per mail naar")} {DIBA_EMAIL}
              {t(
        ...
        <div className="mx-auto">
          <div className="rounded-[var(--r-lg)] bg-[var(--g-050)] p-8 text-[var(--t-strong)] sm:p-12 lg:p-14">
            <div className="max-w-[62ch]">
              <Label>{t("Voordat je solliciteert")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[20ch]">
                {t("Wat we van")}{" "}
                <span className="diba-accent">
                  {t("een nieuwe collega vragen")}
                </span>
              </h2>
            ...
            <div className="mt-8 sm:mt-12 grid gap-8 lg:grid-cols-2 lg:gap-14">
              <div>
                <Label>{t("Dit verwachten we wel")}</Label>
              ...
              <div>
                <Label>{t("Dit verwachten we niet")}</Label>
                <ul className="mt-5 space-y-4">
      ...
      <section className="px-5 py-10 sm:px-9 sm:py-14 lg:px-[7.5vw] lg:py-16">
        <div className="mx-auto">
          <BeeldVignet
            ...
            alt={tc("Twee behandelaars met koffie in de kliniek")}
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            <Label>{t("Solliciteren")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Hoe je bij ons")}
              <br />
              <span className="diba-accent">{t("solliciteert")}</span>
            </h2>
          </div>
          <div className="max-w-[58ch]">
            <p className="text-[17px] leading-8 text-[var(--t-body)]">
              {t("Stuur je cv naar")} {DIBA_EMAIL}{" "}
              {t(
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3">
              {VACATURES.map((v, i) => (
                ...
                >
                  {i === 0
                    ? t("Bekijk de vacature")
                    : t("Open sollicitatie sturen")}
                </a>
              ))}
            </div>
          </div>
