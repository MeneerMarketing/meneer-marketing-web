...
export const metadata: Metadata = zoekmachineVelden({
  pad: "/over-ons",
  /* "Over ons" en "Ons verhaal" droegen allebei dezelfde H1, "Een huidkliniek in
    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
          <div>
            ...
            <p className="mt-7 max-w-[54ch] text-[17px] leading-8 text-[var(--on-dark-body)]">
              ...
              {t(", aan de")} {DIBA_ADDRESS.street}
              {t(". Met")} {TEAM_AANTAL} {t("mensen,")} {APPARATUUR.length}{" "}
              {t("apparaten en")} {BEHANDELINGEN.length}{" "}
              {t("behandelingen waarvan de prijzen allemaal openbaar zijn.")}
            </p>
            <LeesVerder opDonker>
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 sm:p-10 text-[var(--t-strong)]">
            <Label>{t("Waar we vandaan komen")}</Label>
            ...
            <p className="mt-5 text-[16px] leading-7 text-[var(--t-body)]">
              {t("We zitten aan de noordkant van")} {DIBA_ADDRESS.city}
              {t(
        ...
        <div className="mx-auto">
          <div className="rounded-[var(--r-lg)] bg-[var(--g-050)] p-8 text-[var(--t-strong)] sm:p-12 lg:p-14">
            <div className="max-w-[62ch]">
              <Label>{t("Vier getallen")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[20ch]">
                {t("Wat klanten")}{" "}
                <span className="diba-accent">{t("over ons schrijven")}</span>
              </h2>
            ...
            <ul className="mt-8 sm:mt-12 grid gap-4 md:grid-cols-2">
              {cijfers().map((c) => (
                ...
                >
                  ...
                  <p className="diba-label mt-2">{tc(c.label)}</p>
      ...
      <section className="px-5 py-10 sm:px-9 sm:py-16 lg:px-[7.5vw] lg:py-20">
        <div className="mx-auto">
          <BeeldVignet
            ...
            alt={tc(
              "Behandelaar en client in een behandelkamer van Diba Clinics",
            )}
            ...
            {[
              ...
              >
                <p className="diba-display-s text-[var(--t-strong)]">
                  {k.getal}{" "}
                  <span className="text-[var(--t-muted)]">{tc(k.kop)}</span>
                </p>
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            <Label>{t("Waarom zo")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Waar deze kliniek")}
              <br />
              <span className="diba-accent">{t("voor staat")}</span>
            </h2>
          </div>
