    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
          <div>
            ...
            <h1 className="diba-display-l mt-6 max-w-[21ch]">
              {t("Wat er in een")}
              <br />
              <span className="diba-accent-on-dark">{t("intake gebeurt")}</span>
            </h1>
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 text-[var(--t-strong)] sm:p-10">
            ...
            <dl className="mt-6 space-y-4">
              {intakeFeiten().map((f) => (
                ...
                >
                  <dt className="diba-label">{tc(f.label)}</dt>
                  <dd className="diba-card-title text-right">
                    {tc(f.waarde, "Nog niet vastgesteld")}
                  </dd>
                </div>
              ))}
            </dl>
      ...
      <section className="px-5 py-10 sm:px-9 sm:py-14 lg:px-[7.5vw] lg:py-16">
        <div className="mx-auto">
          <BeeldVignet
            ...
            alt={tc(
              "Behandelaar bespreekt de uitkomst van een huidscan met een client",
            )}
      ...
      <section className="px-5 pt-10 sm:pt-14 sm:px-9 lg:px-[7.5vw] lg:pt-16">
        <div className="mx-auto">
          <div className="flex flex-wrap items-baseline justify-between gap-x-8 gap-y-2">
            <Label>{t("Twee manieren om te beginnen")}</Label>
            <p className="text-[15px] leading-7 text-[var(--t-muted)]">
              {t("Allebei beginnen ze met dezelfde meting.")}
            </p>
          </div>
          ...
          <div className="mt-6 grid gap-4 lg:grid-cols-2 lg:items-start">
            ...
            <div className="rounded-[var(--r-lg)] border border-[var(--g-100)] bg-white p-5 sm:p-7">
              ...
              <p className="mt-4 text-[16px] leading-7 text-[var(--t-body)]">
                {t("We reserveren er maximaal")} {INTAKE_MINUTEN}{" "}
                {t(
            ...
            <div className="rounded-[var(--r-lg)] bg-[var(--g-075)] p-5 sm:p-7">
              ...
              <p className="diba-card-title-lg mt-3 text-[var(--t-strong)]">
                {tc(COMBINATIE_AFSPRAAK.kop)}
              </p>
              <p className="mt-4 text-[16px] leading-7 text-[var(--t-body)]">
                {tc(COMBINATIE_AFSPRAAK.zin)}
              </p>
              <p className="mt-4 text-[15px] leading-7 text-[var(--warn-text)]">
                {tc(COMBINATIE_AFSPRAAK.voorwaarde)}
              </p>
              <p className="mt-3 text-[15px] leading-7 text-[var(--t-body)]">
                {tc(COMBINATIE_AFSPRAAK.voorbehoud)}
              </p>
              ...
              <p className="mt-4 border-t border-[var(--g-100)] pt-4 text-[15px] leading-7 text-[var(--t-muted)]">
                ...
                {t("minuten is minstens")} {ADVIES_MINUTEN.minimaalBehandelen}{" "}
                {t("minuten behandeltijd.")}
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="mx-auto">
          ...
          <div className={`mt-12 ${RASTER_GELIJK}`}>
            ...
            <div>
              <Label>{t("Afhankelijk van waarvoor je komt")}</Label>
              <MobielInklap className="mt-5" label="Toon de lijst">
                <ul className="space-y-3">
      ...
      <section className="px-5 py-12 sm:py-20 sm:px-9 lg:px-[7.5vw] lg:py-28">
        <div className="mx-auto">
          ...
          <Vertaaldnoot className="mt-8" />

          <ul className="mt-4 gap-4 sm:columns-2 xl:columns-3 [&>li]:mb-4 [&>li]:break-inside-avoid">
                  ...
                  <div className="mt-5 flex flex-wrap items-baseline gap-x-3 gap-y-1">
                    ...
                    {r.relativeDate ? (
                      <span className="text-[14px] leading-6 text-[var(--t-muted)]">
                        {relatieveDatum(r.relativeDate, taalNu())}
                      </span>
                    ) : null}
                  </div>
