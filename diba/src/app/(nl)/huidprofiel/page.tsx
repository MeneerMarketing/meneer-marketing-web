        ...
        <div className="mx-auto grid items-center gap-6 px-5 pt-10 pb-12 sm:px-9 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14 lg:px-[7.5vw] lg:pt-12 lg:pb-16">
          <div>
            ...
            <h1 className="diba-display-l mt-6 max-w-[15ch] text-[var(--on-dark)]">
              {t("Stel je huidprofiel")}
              <br />
              <span className="diba-accent-on-dark">{t("samen")}</span>
            </h1>
            ...
            <p className="mt-6 max-w-[50ch] text-[17px] leading-8 text-[var(--on-dark-body)]">
              ...
              {t("vragen, twee minuten. Dit weet je daarna:")}
            </p>
            ...
            <div className="mt-8 diba-knoprij">
              ...
              >
                <span className="sm:hidden">{t("Begin")}</span>
                <span className="max-sm:hidden">
                  {t("Begin bij de eerste vraag")}
                </span>
              </Link>
              <Link
                href="/intake"
              ...
              >
                <span className="sm:hidden">{t("Hoe het werkt")}</span>
                <span className="max-sm:hidden">
                  {t("Zo werkt het huidconsult")}
                </span>
              </Link>
            </div>
          </div>
          ...
          <BeeldVignet
            ...
            alt={tc(
              "Behandelaar bekijkt de uitkomst van een huidprofiel op een tablet",
            )}
