  ...
  return (
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)] max-lg:flex max-lg:flex-col">
        ...
        <div className="mx-auto grid gap-10 px-5 py-10 sm:py-14 sm:px-9 lg:grid-cols-[1.1fr_0.9fr] lg:px-[7.5vw] lg:py-20">
          <div>
            ...
            <h1 className="diba-display-l mt-6 max-w-[21ch] text-[var(--on-dark)]">
              {t("Alle tarieven")}
              <br />
              <span className="diba-accent-on-dark">{t("op één plek")}</span>
            </h1>
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 text-[var(--t-strong)] sm:p-10">
            <Label>{t("Waar een prijs begint")}</Label>
            <p className="diba-card-title mt-4 text-[var(--t-strong)]">
              {t("De intake kost")} {intakeCijfer} {t("euro")}
            </p>
      ...
      >
        <div className="mx-auto">
          <div>
            <Label>{t("Laserontharing per zone")}</Label>
            <h2 className="diba-display-m mt-4">
              {t("Elke zone,")}{" "}
              <span className="diba-accent">{t("met het tarief erbij.")}</span>
            </h2>
          </div>
          <div className="mt-10">
            <Prijslijst />
              ...
              <ul className="diba-label mt-6 space-y-2">
                ...
                <li>
                  <Link
                    ...
                    className="text-[var(--g-700)] underline underline-offset-4 transition-colors hover:text-[var(--g-800)]"
                  >
                    {t("Afzeggen, betalen en verzetten")}
                  </Link>
                </li>
              </ul>
            </div>
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          <div className="rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-12">
            <Label opDonker>{t("Wat het totaal bepaalt")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[22ch]">
              {t("Het aantal sessies")}{" "}
            ...
            <div className="mt-8 diba-knoprij">
              ...
              >
                <span className="sm:hidden">{t("Intake")}</span>
                <span className="max-sm:hidden">{t("Plan een intake")}</span>
              </Link>
              <Link
                href="/behandelingen"
              ...
              >
                <span className="sm:hidden">{t("Behandelingen")}</span>
                <span className="max-sm:hidden">
                  {t("Wat de behandelingen doen")}
                </span>
              </Link>
            </div>
          </div>
