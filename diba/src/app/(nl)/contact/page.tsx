    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:py-20">
          <div>
            ...
            >
              ...
              <span className="text-[var(--on-dark-body)]">{t("Contact")}</span>
            </nav>
            ...
            <div className="rounded-[var(--r-lg)] bg-white p-6 sm:p-8">
              ...
              <ul className="mt-5">
                {DIBA_OPENINGSTIJDEN.map((d, i) => (
                  ...
                  >
                    <span className="text-[var(--t-strong)]">
                      {tc(d.label)}
                    </span>
                    <span
                      className={
                    ...
                    >
                      {d.van ? `${d.van} ${t("tot")} ${d.tot}` : t("Gesloten")}
                    </span>
                  </li>
                ))}
              </ul>
      ...
      <section className="bg-[var(--g-050)] px-5 py-10 sm:px-9 sm:py-16 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          ...
          <h2 className="diba-display-m mt-4">
            {t("Afzeggen, verzetten")}{" "}
            <span className="diba-accent">{t("of te laat komen.")}</span>
          </h2>
          <p className="mt-6 max-w-[62ch] text-[17px] leading-8 text-[var(--t-body)]">
            {t(
          ...
          <ul className="mt-8 grid gap-4 sm:mt-12 lg:grid-cols-2 lg:items-start">
            ...
            {SITUATIES.map((s) => (
              ...
              >
                ...
                <MobielInklap label={tc(s.kop)} vorm="kop">
          ...
          <p className="mt-8 max-w-[70ch] text-[15px] leading-7 text-[var(--t-muted)]">
            {t("Deze vier staan voluit in de")}{" "}
            <Link
            ...
            {t(", samen met wat er gebeurt als wij moeten afzeggen.")}
          </p>
        </div>
      </section>
      ...
      <section className="px-5 py-10 sm:px-9 sm:py-16 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          ...
          <div className="mt-8 grid gap-6 sm:mt-12 lg:grid-cols-2 lg:gap-10">
            ...
            <div>
              <p className="text-[17px] leading-8 text-[var(--t-body)]">
                {t("De kliniek zit aan de noordkant van")} {DIBA_ADDRESS.city}
                {t(
                  ", in een woonwijk. Rustig dus, en je parkeert in de straat in plaats van in een garage.",
                )}
              </p>
          ...
          <BeeldVignet
            ...
            alt={tc(
              "Een client krijgt koffie aangereikt bij binnenkomst in de kliniek",
            )}
