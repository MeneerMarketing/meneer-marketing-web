    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
          <div>
            ...
            <h1 className="diba-display-l mt-6 max-w-[21ch]">
              {t("Welke cookies")}
              <br />
              <span className="diba-accent-on-dark">{t("we gebruiken")}</span>
            </h1>
            ...
            {COOKIES.map((c) => (
              ...
              >
                <p className="diba-label text-[var(--t-label)]">
                  {c.altijd ? t("Altijd aan") : t("Alleen met akkoord")}
                </p>
                ...
                <p className="mt-5 rounded-[var(--r-md)] bg-[var(--g-050)] p-5 text-[15px] leading-7 text-[var(--t-body)]">
                  ...
                  <span className="mt-2 block">{tc(c.wanneer)}</span>
                </p>
              </li>
            ))}
          </ul>
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            <Label>{t("Hoe je keuze bewaard wordt")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Per browser,")}
              <br />
              <span className="diba-accent">{t("op dit apparaat.")}</span>
            </h2>
          </div>
      ...
      <section className="bg-[var(--g-025)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            ...
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Stel ze")} <span className="diba-accent">{t("gewoon.")}</span>
            </h2>
          </div>
          <div className="max-w-[58ch]">
            <p className="text-[17px] leading-8 text-[var(--t-body)]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3">
              ...
              >
                {t("Naar het privacybeleid")}
              </Link>
            </div>
            <p className="mt-8 text-[14px] leading-6 text-[var(--t-muted)]">
              {t("Dit beleid gaat over")} {DIBA_SITE.domain}.
            </p>
          </div>
        </div>
      </section>
