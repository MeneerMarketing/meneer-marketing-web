...
export async function generateMetadata({
  ...
  return zoekmachineVelden({
    ...
    titel: `${tc(a.naam)}: ${t("het apparaat")}`,
    omschrijving: tc(a.kort),
...
export default async function ApparaatPage({ params }: PageProps) {
  ...
  const woord =
    a.soort === "productlijn" ? t("deze productlijn") : t("dit apparaat");
    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        >
          <div className="flex flex-col">
            ...
            >
              ...
              <span aria-hidden="true">/</span>
              <span className="text-[var(--on-dark-body)]">{tc(a.naam)}</span>
            </nav>

            <div className="mt-8">
              {a.merk ? <Label opDonker>{tc(a.merk)}</Label> : null}
              ...
              {a.merk && a.merkUrl ? (
                ...
                >
                  {t("Meer over")} {woord} {t("bij")} {a.merk}
                  <span aria-hidden="true">›</span>
                </a>
              ) : null}
            </div>
            ...
            <div className="mt-auto rounded-[var(--r-lg)] bg-[var(--g-800)] p-7 pt-10 sm:p-9">
              <Label opDonker>{t("Wat we ermee doen")}</Label>
              {behandelingen.length > 0 ? (
                ...
                <p className="mt-5 text-[15px] leading-7 text-[var(--on-dark-body)]">
                  {t("Nog niet gekoppeld aan een behandeling op deze site.")}
                </p>
              )}
          ...
          {a.foto ? (
            <BeeldVignet
              src={a.foto.src}
              alt={tc(a.foto.alt)}
              onderschrift={a.merk ? `${tc(a.naam)}, ${a.merk}` : a.naam}
              priority
      ...
      <section className="px-5 pb-10 sm:pb-16 sm:px-9 lg:px-[7.5vw] lg:pb-24">
        <div className="mx-auto">
          ...
          {a.techniek?.length ? (
            <div>
              <Label>{t("De techniek")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[24ch]">
                {t("Wat")} {woord}{" "}
                <span className="diba-accent">{t("precies doet")}</span>
              </h2>
      ...
      <section className="bg-[var(--g-050)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          ...
          <h2 className="diba-display-m mt-4 max-w-[22ch]">
            {t("Waar")} {woord}{" "}
            <span className="diba-accent">{t("voor bedoeld is")}</span>
          </h2>
          ...
          <div className="mx-auto">
            <div>
              ...
              <h2 className="diba-display-m mt-4">
                {t("Wat er anders is dan")}{" "}
                <span className="diba-accent">
                  {t("de andere apparaten hier")}
                </span>
              </h2>
      ...
      {problemen.length ? (
        <section className="bg-[var(--g-050)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
          <div className="mx-auto">
            <div>
              <Label>{t("Waar het bij helpt")}</Label>
              <h2 className="diba-display-m mt-4">
                {t("De problemen waar")}{" "}
                <span className="diba-accent">
                  {woord} {t("bij past.")}
              ...
              <p className="max-w-[62ch] mt-6 text-[17px] leading-8 text-[var(--t-body)]">
                {t("Op elke pagina hieronder staat ook waar")} {woord}{" "}
                {t("niet voor is, en of wij die klacht wel behandelen.")}
              </p>
            </div>
      ...
      {/* ── Vragen ──
          ...
          worden aangemeld. */}
      {a.vragen?.length ? (
        <PillarFaq items={a.vragen} onderwerp={`de ${tc(a.naam)}`} />
      ) : null}
        ...
        <div className="mx-auto">
          <div className="rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-12">
            <div className="lg:grid lg:grid-cols-[1.18fr_.82fr] lg:gap-14">
              <div>
                <Label opDonker>{t("Eerst meten")}</Label>
                <h2 className="diba-display-m mt-4 max-w-[20ch]">
                  {t("Het verschil zit in")}{" "}
                  <span className="diba-accent-on-dark">
                    {t("de hand die het bedient")}
                  </span>
                </h2>
                <p className="mt-6 max-w-[52ch] text-[16px] leading-7 text-[var(--on-dark-body)]">
                  {t("Dezelfde")} {tc(a.naam)}{" "}
                  {t(
