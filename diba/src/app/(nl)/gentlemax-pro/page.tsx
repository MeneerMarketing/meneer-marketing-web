    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
      ...
      <section className="bg-[var(--g-700)] text-[var(--on-dark)] px-5 sm:px-9 lg:px-[7.5vw]">
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 sm:p-10 text-[var(--t-strong)]">
            <Label>{t("De vraag waar alles op neerkomt")}</Label>
            ...
            <p className="mt-5 text-[16px] leading-7 text-[var(--t-body)]">
              {t("Daar is die tweede golflengte voor.")}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[var(--g-025)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            <Label>{t("Het derde onderdeel")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("De koeling")}
              <br />
              <span className="diba-accent">{t("hoort bij de puls.")}</span>
            </h2>
          </div>
      ...
      <section className="bg-[var(--g-025)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            <Label>{t("En dan de praktijk")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Wat het")}
              <br />
              <span className="diba-accent">{t("bij jou kost.")}</span>
            </h2>
          </div>
          <div className="max-w-[58ch]">
            <p className="text-[17px] leading-8 text-[var(--t-body)]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3">
              ...
              >
                {t("Bekijk de tarieven per zone")}
              </Link>
              <Link
                href="/laserontharing"
                className="diba-label text-[var(--g-700)] underline underline-offset-4 hover:text-[var(--g-800)]"
              >
                {t("Alles over laserontharing")}
              </Link>
