    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-stretch lg:py-20">
          <div className="flex flex-col">
            ...
            >
              ...
              <span className="text-[var(--t-muted)]">{t("Kennisbank")}</span>
            </nav>
          ...
          <BeeldVignet
            ...
            alt={tc(
              "Behandelaar legt aan de hand van een doorsnedemodel van de huid uit wat er waar zit",
            )}
            onderschrift={t("Eerst begrijpen waar het zit")}
            priority
            ...
            <div className="mx-auto">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
                <div className="shrink-0">
                  {opDonker ? (
                    <Label opDonker>{tc(groep.kop)}</Label>
                  ) : (
                    <Label>{tc(groep.kop)}</Label>
                  )}
                </div>
                <p
      ...
      <section className="bg-[var(--g-050)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
            <div className="shrink-0">
              <Label>{t("Per huidprobleem")}</Label>
              <h2 className="diba-display-m mt-4">
                {BESTEMMINGEN.length} {t("pagina's,")}{" "}
                <span className="diba-accent">
                  {t("elk met een eigen vraag.")}
                </span>
              </h2>
            </div>
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-12 lg:p-14">
          <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:gap-16">
            <div>
              <Label opDonker>{t("Waar dit toe dient")}</Label>
              <h2 className="diba-display-m mt-4">
                {t("Zodat je een gesprek")}{" "}
                <span className="diba-accent-on-dark">{t("kunt voeren")}</span>
              </h2>
            ...
            <div className="flex flex-col justify-center gap-4">
              <p className="text-[16px] leading-7 text-[var(--on-dark-body)]">
                {t("Het register telt nu")} {aantalStukken}{" "}
                {t(
              ...
              <div className="mt-2 flex flex-wrap items-center gap-x-6 gap-y-3">
                ...
                >
                  {t("Of vul eerst je huidprofiel in")}
                </Link>
              </div>
            </div>
          </div>
