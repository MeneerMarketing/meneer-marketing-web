    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
      ...
      <section className="bg-[var(--g-700)] text-[var(--on-dark)] px-5 sm:px-9 lg:px-[7.5vw]">
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-stretch lg:py-20">
          <div className="flex flex-col">
            ...
            >
              ...
              <span className="text-[var(--on-dark-body)]">
                {t("Voor verwijzende zorgverleners")}
              </span>
            </nav>

            <div className="mt-8">
              <Label opDonker>{t("Voor zorgverleners")}</Label>
              <h1 className="diba-display-l mt-4">
                {t("Verwijzen naar Diba.")}{" "}
            ...
            <p className="mt-4 max-w-[62ch] text-[17px] leading-8 text-[var(--on-dark-body)]">
              {DIBA_SITE.name} {t("zit in")} {DIBA_ADDRESS.city}
              {t(". Er werken")} {TEAM_AANTAL}{" "}
              {t(
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 sm:p-10 text-[var(--t-strong)]">
            <Label>{t("Waar de grens ligt")}</Label>
      ...
      <section className="px-5 py-10 sm:px-9 sm:py-14 lg:px-[7.5vw] lg:py-16">
        <div className="mx-auto">
          <BeeldVignet
            ...
            alt={tc(
              "Behandelaar werkt aan de huid van een client in de behandelkamer",
            )}
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-12 lg:p-14">
          <div className="grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
            <div>
              <Label opDonker>{t("Wie de behandeling doet")}</Label>
              <h2 className="diba-display-m mt-4">
                {t("Eén titel is")}{" "}
                <span className="diba-accent-on-dark">
                  {t("wettelijk beschermd.")}
                </span>
              </h2>
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between lg:gap-16">
            <div className="shrink-0">
              <Label>{t("Hoe u verwijst")}</Label>
              <h2 className="diba-display-m mt-4">
                {t("Verwijzen gaat")}{" "}
                <span className="diba-accent">{t("per brief of e-mail")}</span>
              </h2>
            </div>
            <p className="max-w-[46ch] text-[16px] leading-7 text-[var(--t-body)]">
              {t(
          ...
          <ol className="mt-8 sm:mt-10 grid gap-4 lg:grid-cols-3">
            {HOE_VERWIJZEN.map((h) => (
              <li
                ...
                className="rounded-[var(--r-lg)] bg-white p-7 sm:p-8"
              >
                <p className="diba-label text-[var(--t-label)]">{tc(h.stap)}</p>
      ...
      <section className="bg-[var(--g-025)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          <Label>{t("Verder lezen")}</Label>
          <h2 className="diba-display-m mt-4">
            {t("Wat er verder")}{" "}
            <span className="diba-accent">{t("te controleren valt.")}</span>
          </h2>
