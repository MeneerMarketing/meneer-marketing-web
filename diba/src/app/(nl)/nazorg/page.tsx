  ...
  return (
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
          <div>
            ...
            >
              ...
              <span className="text-[var(--on-dark-body)]">{t("Nazorg")}</span>
            </nav>

            <h1 className="diba-display-l mt-6 max-w-[21ch]">
              {t("Mag ik morgen")}
              <br />
              <span className="diba-accent-on-dark">{t("weer sporten?")}</span>
            </h1>
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 sm:p-10 text-[var(--t-strong)]">
            <Label>{t("Wat voorgaat op deze pagina")}</Label>
            ...
            <p className="mt-5 text-[16px] leading-7 text-[var(--t-muted)]">
              {t("Twijfel je, bel dan. Dat is altijd goedkoper dan afwachten.")}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[var(--g-025)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        ...
        <div className="mx-auto pb-16 lg:pb-20">
          <BeeldVignet
            ...
            alt={tc(
              "Behandelaar geeft een verzorgingsproduct mee aan een client",
            )}
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          <div>
            <Label>{t("Geen verrassingen")}</Label>
            <h2 className="diba-display-m mt-4">
              {t("Wat je de eerste uren")}{" "}
              <span className="diba-accent">{t("gaat merken.")}</span>
            </h2>
            <p className="max-w-[62ch] mt-6 text-[17px] leading-8 text-[var(--t-body)]">
              {t(
            ...
            {NAZORG.map((n) => (
              ...
              >
                ...
                <p className="mt-5 rounded-[var(--r-md)] bg-[var(--g-050)] p-5 text-[15px] leading-7 text-[var(--t-body)]">
                  ...
                  <span className="mt-2 block">{tc(n.hoofdregel)}</span>
                </p>
              </li>
            ))}
          </ul>
      ...
      <section className="bg-[var(--g-025)] px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16">
          <div>
            <Label>{t("Bij twijfel")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Liever één keer")}
              <br />
              <span className="diba-accent">{t("te veel gebeld.")}</span>
            </h2>
          </div>
          <div className="max-w-[58ch]">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-x-6 gap-y-3">
              ...
              >
                {t("Of stuur een bericht met een foto")}
              </a>
            </div>
          </div>
        </div>
