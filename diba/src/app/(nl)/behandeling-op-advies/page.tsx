    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="mt-6 grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-14">
          <div>
            <h1 className="diba-display-l max-w-[16ch]">
              {t("Ik wil een behandeling")}{" "}
              <span className="diba-accent">{t("op advies")}</span>
            </h1>
            ...
            <div className="mt-8 diba-knoprij">
              ...
              >
                <span className="sm:hidden">{t("Boek op advies")}</span>
              ...
              >
                <span className="sm:hidden">{t("Nieuw of klant?")}</span>
                <span className="max-sm:hidden">{t("Nieuw of al klant?")}</span>
              </a>
            </div>
          </div>
          ...
          <BeeldVignet
            ...
            alt={tc(
              "Cliënt en behandelaar aan tafel in de intakeruimte, met een kop koffie",
            )}
      ...
      >
        <div className="mx-auto">
          <Label>{t("Kies de afspraak die bij jou past")}</Label>
          <h2 className="diba-display-m mt-4 max-w-[20ch]">
            {t("Nieuw bij ons")}{" "}
            <span className="diba-accent">{t("of al eens geweest")}</span>
          </h2>
          ...
          <div className="mt-8 sm:mt-12 grid gap-4 lg:grid-cols-2 lg:items-start">
            ...
            <div className="flex h-full flex-col rounded-[var(--r-lg)] bg-white p-8 sm:p-10">
              <Label>{t("Ik ben nieuw bij Diba")}</Label>
              <p className="diba-display-s mt-3 text-[var(--t-strong)]">
                {t("Intake plus behandeling op advies")}
              </p>
              ...
              <p className="mt-5 text-[16px] leading-7 text-[var(--t-body)]">
                ...
                {t("minuten, dus twee uur. De intake duurt daarvan")}{" "}
                {ADVIES_MINUTEN.intakeVan} {t("tot")} {ADVIES_MINUTEN.intakeTot}{" "}
                {t(
              ...
              <div className="mt-7 rounded-[var(--r-sm)] bg-[var(--g-025)] p-5">
                <p className="text-[15px] leading-7 text-[var(--t-body)]">
                  ...
                  {intakeBedrag}
                  {t(". De afspraak hoeft de")} {ADVIES_MINUTEN.nieuw}{" "}
                  {t("minuten niet vol te maken.")}
                </p>
              </div>
            ...
            {/* Bestaand */}
            <div className="flex h-full flex-col rounded-[var(--r-lg)] bg-white p-8 sm:p-10">
              <Label>{t("Ik ben al klant bij Diba")}</Label>
              <p className="diba-display-s mt-3 text-[var(--t-strong)]">
                {t("Behandeling op advies")}
              </p>
              <p className="diba-label mt-3 text-[var(--t-label)]">
      ...
      <section className="px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16">
          <div>
            <Label>{t("Waar kun je advies over vragen")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Je hoeft de naam")}{" "}
              <span className="diba-accent">{t("niet te kennen")}</span>
            </h2>
      ...
      <section className="bg-white px-5 py-10 sm:py-16 sm:px-9 lg:px-[7.5vw] lg:py-24">
        <div className="mx-auto">
          <Label>{t("Zo verloopt je afspraak")}</Label>
          <h2 className="diba-display-m mt-4 max-w-[20ch]">
            {t("Vier stappen")}{" "}
            <span className="diba-accent">
              {t("van vraag tot behandeling")}
            </span>
          </h2>
        ...
        <div className="mx-auto">
          <div className="rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-12">
            ...
            <h2 className="diba-display-m mt-4 max-w-[22ch]">
              {t("Vertel wat je stoort.")}
              <br />
              <span className="diba-accent-on-dark">
                {t("De rest zoeken wij uit.")}
              </span>
            </h2>
            ...
            <div className="mt-8 diba-knoprij">
              ...
              >
                <span className="sm:hidden">{t("Ik ben nieuw")}</span>
                <span className="max-sm:hidden">
                  {t("Ik ben nieuw bij Diba")}
                </span>
              </Link>
              <Link
                href="/afspraak"
