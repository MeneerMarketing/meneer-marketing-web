...
export default function Pagina() {
  return (
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="mx-auto grid gap-6 px-5 pb-10 sm:px-9 sm:pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-10 lg:px-[7.5vw] lg:pb-0">
          ...
          <div className="relative min-h-[220px] overflow-hidden rounded-[var(--r-md)] bg-[var(--g-200)] sm:min-h-[300px] lg:min-h-[460px]">
            <Image
              ...
              alt={tc(
                "Laserontharing van de kaaklijn bij een man, met oogbescherming",
              )}
              fill
              priority
      ...
      >
        <div className="mx-auto">
          ...
          <div className="mt-10 rounded-[var(--r-md)] bg-[var(--g-700)] p-7 text-[var(--on-dark)] sm:p-9">
            <Label opDonker>{t("Zoek je vooral gladde benen?")}</Label>
            <p className="diba-card-title-lg mt-4 max-w-[36ch]">
              {t("Dan begint het bij de behandeling en niet bij de klacht.")}
            </p>
      ...
      <ReviewsBijOnderwerp
        onderwerp="laser"
        intro="Deze komen uit Salonized en zijn niet door ons uitgekozen op inhoud. Ze gaan over laserontharing, want dat is wat ingroei stopt."
        achtergrond="zacht"
      />
