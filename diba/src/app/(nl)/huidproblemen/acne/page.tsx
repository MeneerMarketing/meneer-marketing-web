    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="mx-auto grid gap-6 px-5 pb-10 sm:px-9 sm:pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-10 lg:px-[7.5vw] lg:pb-0">
          <div className="py-10 sm:py-14 lg:py-20 max-lg:pb-0">
            ...
            >
              ...
              <span aria-hidden="true">/</span>
              <span className="text-[var(--on-dark-body)]">{t("Acne")}</span>
            </nav>
            ...
            <h1 className="diba-display-l mt-6 text-[var(--on-dark)]">
              {t("Acne die steeds")}
              <br />
              <span className="diba-accent-on-dark">{t("terugkomt")}</span>
            </h1>
            ...
            <p className="mt-4 max-w-[48ch] text-[16px] leading-7 text-[var(--on-dark-body)]">
              ...
              {t(", want dat is vaak helemaal geen litteken.")}
            </p>
          ...
          <div className="relative min-h-[220px] overflow-hidden rounded-[var(--r-md)] bg-[var(--g-200)] sm:min-h-[300px] lg:min-h-[460px]">
            ...
            <Image
              ...
              alt={tc(
                "Jonge cliënt met acne op de behandelbank, met de peelingproducten die bij zijn behandeling horen",
              )}
              fill
              priority
      ...
      >
        <div className="mx-auto">
          <div className={RASTER_SECTIEKOP}>
            <div>
              <Label>{t("De acnekaart")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[16ch]">
                {t("Waar het zit,")}
                <br />
                <span className="diba-accent">{t("zegt wat het is.")}</span>
              </h2>
            </div>
      ...
      >
        <div className="mx-auto">
          <div className={RASTER_SECTIEKOP}>
            <div>
              <Label>{t("Herkenning")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[14ch]">
                {t("Welke acne heb jij?")}
              </h2>
            </div>
            <p className="max-w-[64ch] text-[16px] leading-7 text-[var(--t-body)]">
              {t(
      ...
      >
        <div className="mx-auto">
          <div className={RASTER_SECTIEKOP}>
            <div>
              <Label>{t("Onder je huid")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[18ch]">
                {t("Acne verloopt in verschillende stadia")}
              </h2>
            </div>
            <p className="max-w-[64ch] text-[16px] leading-7 text-[var(--t-body)]">
              {t(
      ...
      >
        <div className="mx-auto">
          ...
          <div className={RASTER_SECTIEKOP_GELIJK}>
            <div>
              <Label>{t("Zonder omwegen")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[14ch]">
                {t("Wat helpt en wat we afraden")}
              </h2>
            </div>
            <p className="max-w-[64ch] text-[16px] leading-7 text-[var(--t-body)]">
              {t(
          ...
          <div className="mt-8 sm:mt-12 grid gap-6 lg:grid-cols-2 lg:gap-8">
            <div className="rounded-[var(--r-md)] bg-white p-6 sm:p-8">
              <h3 className="diba-label text-[var(--g-700)]">
                {t("Dit werkt")}
              </h3>
              <ul className="mt-5 space-y-4">
                {ACNE_WEL_NIET.wel.map((r) => (
                  <li key={r} className="flex gap-3 text-[15px] leading-7">
                    ...
                    <span className="text-[var(--t-body)]">{t(r)}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      >
        <div className="mx-auto">
          <div className={RASTER_SECTIEKOP}>
            <div>
              <Label opDonker>{t("Onze volgorde")}</Label>
              <h2 className="diba-display-m mt-4 max-w-[19ch]">
                {t("Waarom we beginnen")}
                <br />
          ...
          <ul className="mt-8 sm:mt-12 grid gap-px overflow-hidden rounded-[var(--r-md)] bg-white/15 md:grid-cols-3">
            {ACNE_WIJ_DOEN_NIET.map((p) => (
              <li key={p.titel} className="bg-[var(--g-700)] p-6 sm:p-8">
                <h3 className="diba-card-title">{t(p.titel)}</h3>
      ...
      >
        <div className="mx-auto grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
          <div>
            ...
            <h2 className="diba-display-m mt-4 max-w-[18ch]">
              {t("Deze kenmerken volgen we bij acne")}
            </h2>
          ...
          <ul className="grid gap-3 sm:grid-cols-3">
            {[
              ...
              >
                <h3 className="diba-card-title">{t(as)}</h3>
