    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="mx-auto grid gap-6 px-5 pb-10 sm:px-9 sm:pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-10 lg:px-[7.5vw] lg:pb-0">
          <div className="py-10 sm:py-14 lg:py-20 max-lg:pb-0">
            ...
            <div className="diba-knoprij mt-9">
              <Button variant="primair-op-donker" href="#triggers">
                {t("Sorteer jouw triggers")}
              </Button>
              <Button
          ...
          <div className="relative min-h-[220px] overflow-hidden rounded-[var(--r-md)] bg-[var(--g-200)] sm:min-h-[300px] lg:min-h-[460px]">
            ...
            <Image
              ...
              alt={tc(
                "IPL-behandeling van vaatjes met de Nordlys, met oogbescherming",
              )}
              fill
              priority
      ...
      >
        <div className="mx-auto">
          ...
          <ul className="mt-8 sm:mt-12 grid gap-px overflow-hidden rounded-[var(--r-md)] bg-[var(--g-100)] sm:grid-cols-2 lg:grid-cols-4">
            {ACNE_OF_ROSACEA.map(([kop, tekst]) => (
              <li key={kop} className="bg-white p-6 sm:p-7">
                <h3 className="diba-card-title">{tc(kop)}</h3>
