        ...
        <div className="grid gap-10 py-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-start lg:py-20">
          <div>
            ...
            <h1 className="diba-display-l mt-6 max-w-[21ch]">
              {tc(v.paginaTitel.kop)}{" "}
              <span className="diba-accent-on-dark">
                {tc(v.paginaTitel.accent)}
              </span>
            </h1>
          ...
          <div className="rounded-[var(--r-lg)] bg-white p-8 text-[var(--t-strong)] sm:p-10">
            ...
            <p className="mt-6 border-t border-[var(--g-100)] pt-5 text-[14px] leading-6 text-[var(--t-body)]">
              ...
              <time dateTime={v.geplaatst}>
                {new Date(v.geplaatst).toLocaleDateString(
      ...
      <section className="px-5 py-10 sm:py-14 sm:px-9 lg:px-[7.5vw] lg:py-16">
        <div className="mx-auto">
          <BeeldVignet
            ...
            alt={tc(
              "Twee huidtherapeuten met koffie in de kliniek van Diba Clinics in Rotterdam",
            )}
      ...
      >
        <div className="mx-auto">
          ...
          <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-4">
            <Button href={mailto}>{t("Solliciteer op deze functie")}</Button>
            <Link
              href="/werken-bij"
              className="diba-label text-[var(--g-700)] underline underline-offset-4 hover:text-[var(--g-800)]"
            >
              {t("Alle vacatures bij Diba")}
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="px-5 pt-10 sm:pt-16 sm:px-9 lg:px-[7.5vw] lg:pt-20">
        <div className="mx-auto">
          <div className="rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-12">
            <Label opDonker>{t("Solliciteren")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[22ch]">
              {t("Stuur je cv, de rest")}{" "}
              <span className="diba-accent-on-dark">{t("bespreken we")}</span>
            </h2>
            ...
            <div className="mt-8 diba-knoprij">
              ...
              >
                <span className="sm:hidden">{t("Mail je cv")}</span>
                <span className="max-sm:hidden">
                  {t("Mail je sollicitatie")}
                </span>
              </a>
              <a
                href={DIBA_WHATSAPP_URL}
