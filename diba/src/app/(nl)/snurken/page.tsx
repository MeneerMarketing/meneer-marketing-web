    ...
    <main className="figma-home bg-[var(--g-010)] text-[var(--t-strong)]">
        ...
        <div className="grid gap-6 pb-10 sm:pb-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-10 lg:pb-0">
          <div className="py-10 sm:py-14 lg:py-20 max-lg:pb-0">
            ...
            >
              ...
              <span className="text-[var(--on-dark-body)]">{t("Snurken")}</span>
            </nav>
            ...
            <div className="diba-knoprij mt-9">
              <Button
                ...
                kort="Naar de bron"
              >
                {t("Waar komt jouw geluid vandaan?")}
              </Button>
              <Button
          ...
          <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-white p-8 text-[var(--t-strong)] sm:p-10">
            ...
            <p className="diba-card-title-lg mt-4 max-w-[24ch]">
              {t("Laser op het zachte gehemelte, zonder snijden of beugel.")}
            </p>
                ...
                {(
                  [
                    nightlase.duurMinuten
                      ...
                      : null,
                    [t("Hoe vaak"), eersteZin(tc(nightlase.sessies))] as const,
                    [t("Herstel"), eersteZin(tc(nightlase.herstel))] as const,
                  ...
                  >
                    <dt className="diba-label shrink-0">{tc(kop)}</dt>
      ...
      >
        <div className="mx-auto grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          <div>
            <Label>{t("De grens die telt")}</Label>
            <h2 className="diba-display-m mt-4 max-w-[16ch]">
              {t("Snurken is niet")}
              <br />
              <span className="diba-accent">{t("hetzelfde als apneu.")}</span>
            </h2>
              ...
              <div className="mt-8 sm:mt-12 grid gap-4 lg:grid-cols-2 lg:items-stretch">
                {nightlase.fotoInDeStoel ? (
                  <BeeldVignet
                    ...
                    alt={tc(nightlase.fotoInDeStoel.alt)}
                ...
                <div className="flex flex-col justify-center rounded-[var(--r-lg)] bg-[var(--g-700)] p-8 text-[var(--on-dark)] sm:p-10 lg:p-12">
                  <Label opDonker>{t("De behandeling bij snurken")}</Label>
                  <h3 className="diba-display-s mt-4 max-w-[18ch]">
                    {t("Snurken behandelen we")}{" "}
                    <span className="diba-accent-on-dark">
                      {t("met NightLase")}
                    </span>
                  </h3>
                  ...
                  <dl className="mt-8 divide-y divide-white/15 border-t border-white/15">
                    {(
                      ...
                      >
                        <dt className="diba-label diba-label-on-dark">
                          {tc(kop)}
                        </dt>
