...
import { auditOpportunity, loadAuditCandidates, } from "../services/audit/auditRunner.js";
...
async function main() {
    ...
    const preferredDomains = env.CRO_AUDIT_DOMAIN_FILTER
        ? env.CRO_AUDIT_DOMAIN_FILTER.split(",")
            ...
            .filter(Boolean)
        : DEFAULT_PREFERRED;
    const candidates = await loadAuditCandidates(supabase, env.CRO_AUDIT_MAX_OPPORTUNITIES_PER_RUN, preferredDomains);
...
main();
//# sourceMappingURL=auditOpportunities.js.map