...
import { buildM994HarvestQueries, M994_DISCOVERY, M994_DISCOVERY_ROUTE, M994_DISCOVERY_VERSION, M994_PARKED_FAMILIES, M994_REPORT_PATH, M994_DASHBOARD_REPORT_PATH, } from "../config/visualFocusedBrandProduction.js";
...
import { hardenShowcasePageEntity, assessBrandOwnership, assessCrossDomainMatches, computeValidatedVisualSalesFit, deriveCurrentSiteImpression, extractProductIdentityFingerprint, passesShowcaseSalesCandidate, } from "../services/prospect/showcaseCandidateIntegrity.js";
...
export async function runM994VisualFocusedBrandProduction(options) {
    ...
    const dfsBudget = { spent: 0, cap: env.M994_MAX_DATAFORSEO_COST };
    const anthropicBudget = { spent: 0, cap: env.M994_MAX_ANTHROPIC_COST };
...
//# sourceMappingURL=runM994VisualFocusedBrandProduction.js.map