...
export function domainHomepage(domain) {
    return `https://${domain.replace(/^www\./, "")}`;
}
export function isSameHost(url, domain) {
    try {
...
export function classifyUrlPageType(url) {
    try {
...
export function isEcommerceRoute(url) {
    try {
...
export function scoreKeywordMatch(text, keyword) {
...
export function slugifyTokens(text) {
    return text
        .toLowerCase()
        .normalize("NFD")
        .replace(/[\u0300-\u036f]/g, "")
