export type PlatformType = "SHOPIFY" | "WOOCOMMERCE" | "MAGENTO" | "SHOPWARE" | "OTHER_ECOMMERCE" | "UNKNOWN";
/** Strict page taxonomy for M3.1+. */
export type PageType = "HOME" | "PRODUCT" | "COLLECTION" | "CATEGORY" | "SEARCH" | "CONTENT" | "UNKNOWN";
export type CrawlStatus = "success" | "failed" | "blocked" | "timeout" | "skipped";
export type ProductResolutionSource = "ads_landing_url" | "final_url" | "internal_link" | "json_ld" | "sitemap" | "collection_link" | "none";
