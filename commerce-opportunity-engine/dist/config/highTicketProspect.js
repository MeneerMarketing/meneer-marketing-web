 ...
 */
export const HIGH_TICKET_PROFILE_VERSION = "HIGH_TICKET_FOCUSED_BRAND_V1";
/**
...
export function catalogBandFor(size) {
    if (size == null)
...
export function priceBandFor(price) {
    ...
    for (const band of PRICE_BANDS) {
        if (price >= band.min) {
            return { band: band.band, score: band.score, label: band.label };
        }
    }
    return { band: "LOW", score: 22, label: "commodity prijspunt" };
}
//# sourceMappingURL=highTicketProspect.js.map