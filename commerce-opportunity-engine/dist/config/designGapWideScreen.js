 ...
 */
export const M951_DISCOVERY_VERSION = "DESIGN_GAP_WIDE_SCREEN_V1";
...
export function gapScoreBand(score) {
    const value = score ?? 0;
    if (value >= GAP_SCORE_BANDS.veryHighMin)
        return "VERY_HIGH";
    if (value >= GAP_SCORE_BANDS.highMin)
        return "HIGH";
    if (value >= GAP_SCORE_BANDS.mediumMin)
        return "MEDIUM";
    return "LOW";
}
//# sourceMappingURL=designGapWideScreen.js.map