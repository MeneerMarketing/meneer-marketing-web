...
export const OWN_BRAND_FIT_BY_MODEL = {
    DTC_OWN_BRAND: 100,
    MOSTLY_OWN_BRAND: 88,
    MIXED: 62,
...
export const CONCEPT_PLATFORM_FIT = {
    SHOPIFY: 100,
    WOOCOMMERCE: 72,
    MAGENTO: 48,
    CUSTOM: 40,
 ...
 */
export const CONCEPT_TRANSFORM_SOFT_CAPS = [
...
export const CONCEPT_PREVIEW_BASE_HOST = process.env.CONCEPT_PREVIEW_BASE_HOST?.trim() ||
    "preview.meneermarketing.nl";
export const CONCEPT_TEMPLATE_REGISTRY = [
    {
...
export function conceptVerdictFromScore(score) {
    if (score >= CONCEPT_VERDICT_BANDS.CONCEPT_READY)
        return "CONCEPT_READY";
    if (score >= CONCEPT_VERDICT_BANDS.STRONG_CONCEPT)
        return "STRONG_CONCEPT";
    if (score >= CONCEPT_VERDICT_BANDS.POSSIBLE_CONCEPT)
        return "POSSIBLE_CONCEPT";
    if (score >= CONCEPT_VERDICT_BANDS.WEAK_CONCEPT_CANDIDATE)
        return "WEAK_CONCEPT_CANDIDATE";
    return "NOT_SUITABLE";
}
//# sourceMappingURL=conceptScoring.js.map