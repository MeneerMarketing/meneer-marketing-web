 ...
 * UNKNOWN                → 4
 */
export const KEYWORD_INTENT_PENALTY = {
    NON_BRANDED_COMMERCIAL: 0,
    PRODUCT_BRANDED: 6,
    BRANDED: 14,
    NAVIGATIONAL: 18,
...
export const OPPORTUNITY_VERDICT_BANDS = [
    { min: 93, verdict: "CONTACT_IMMEDIATELY" },
    { min: 85, verdict: "HIGH_PRIORITY" },
    { min: 70, verdict: "INTERESTING" },
    { min: 50, verdict: "LOW_PRIORITY" },
    { min: 0, verdict: "SKIP" },
];
...
//# sourceMappingURL=scoringWeights.js.map