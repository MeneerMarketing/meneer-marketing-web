...
export const M997_TARGET_PROFILE = "COMPACT_BRAND_STRONG_VISUAL_GAP_V1";
export const M997_DISCOVERY_VERSION = "COMPACT_BRAND_VISUAL_GAP_PRODUCTION_V1";
export const M997_DISCOVERY_ROUTE = "compact_brand_visual_gap_production";
const M997_EXTRA_QUERIES = [
    {
...
export const M997_DASHBOARD_REPORT_PATH = "dashboard/src/preview/concepts/data/compact-brand-visual-gap-production-report.json";
//# sourceMappingURL=compactBrandVisualGap.js.map