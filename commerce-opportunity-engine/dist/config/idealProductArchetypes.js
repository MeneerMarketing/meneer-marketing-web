 ...
 */
export const IDEAL_PRODUCT_ARCHETYPES_VERSION = "IDEAL_PRODUCT_ARCHETYPES_V1";
const NEUTRAL_COMMODITY = {
    commodity: 10,
...
export const IDEAL_PRODUCT_ARCHETYPES_V1 = [
    {
        id: "BEAUTY_DEVICES",
    ...
    },
    {
        ...
        notes: "Haargroeitechniek: hoge prijs, veel uitleg, sterke voor/na logica. Shampoos en supplementen horen er niet bij.",
    },
    {
        ...
        notes: "Alleen devices die uitleg vragen. Verbruiksartikelen en drogisterij-assortiment blijven buiten.",
    },
    {
        ...
        notes: "Alleen specialist-brand driven installaties met echte uitleg. Losse filters en retailer-elektronica blijven buiten.",
    },
    {
        ...
        notes: "Eén product dat uitleg vraagt, verkocht door een merk in plaats van een elektronicaketen.",
    },
    {
        id: "WELLNESS_DEVICES",
    ...
    },
    {
        ...
        notes: "Luchtreiniging is bewust weggelaten: in M9.3 waren coolblue, mediamarkt en kruidvat daar dominant.",
    },
    {
        ...
        notes: "Uit op basis van M9.3 regressie: dumbbells, gewichten en matten zijn commodity en retailer-gedomineerd.",
    },
];
export const ARCHETYPE_BY_ID = new Map(IDEAL_PRODUCT_ARCHETYPES_V1.map((a) => [a.id, a]));
export function enabledArchetypes() {
    return IDEAL_PRODUCT_ARCHETYPES_V1.filter((a) => a.enabled);
}
export function enabledArchetypeCategories() {
    return [...new Set(enabledArchetypes().map((a) => a.keywordCategory))];
}
/** Normalized budget share across enabled branches. */
export function normalizedBudgetShares() {
...
//# sourceMappingURL=idealProductArchetypes.js.map