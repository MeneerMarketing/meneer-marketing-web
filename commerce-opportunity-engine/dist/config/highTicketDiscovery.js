 ...
 */
export const M94_DISCOVERY_VERSION = "HIGH_TICKET_FOCUSED_DISCOVERY_V1";
export const HIGH_TICKET_BRANCHES = [
    {
        archetypeId: "BEAUTY_DEVICES",
        familyIds: ["led_masks", "microneedling_devices", "ipl_hair_removal"],
        keywordShare: 0.2,
        evidence: "Devices met hoge prijs, veel techniek en zichtbaar resultaat. Bewezen archetype uit M9.3.1.",
    },
    {
    ...
    },
    {
        ...
        keywordShare: 0.2,
        evidence: "Herstel- en lichttherapie: specialistische merken, prijzen ver boven het commodity-punt.",
    },
    {
...
export const PARKED_ARCHETYPES = [
    {
        ...
        reason: "Een eerste design target hier zou een directe BestRest-concurrent zijn. Data blijft bewaard.",
    },
    {
        archetypeId: "PET_TECH",
        reason: "M9.3.4: vier audits leverden contrast 33-46. De pagina's zijn te verzorgd voor een before/after.",
    },
];
...
//# sourceMappingURL=highTicketDiscovery.js.map