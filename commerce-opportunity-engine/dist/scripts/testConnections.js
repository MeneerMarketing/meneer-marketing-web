...
import { createDataForSeoClient, testDataForSeoConnection, } from "../services/dataforseo/client.js";
import { createSupabaseServerClient, testSupabaseConnection, } from "../services/supabase/client.js";
import { createAnthropicClient, testAnthropicConnection, } from "../services/anthropic/client.js";
const scriptDir = dirname(fileURLToPath(import.meta.url));
const projectRoot = resolve(scriptDir, "../../");
config({ path: resolve(projectRoot, ".env"), quiet: true });
async function runDataForSeoTest(env) {
...
async function runSupabaseTest(env) {
...
async function runAnthropicTest(env) {
