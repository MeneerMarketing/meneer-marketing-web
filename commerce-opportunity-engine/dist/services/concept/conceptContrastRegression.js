 ...
 */
import { CONTRAST_FIXTURES } from "../../config/conceptContrastFixtures.js";
...
function runFixture(fixture) {
    ...
    const designTarget = result.concept_contrast_potential >= CONTRAST_GATE_THRESHOLDS.minDesignTargetContrast;
    ...
    if (!targetOk) {
        problems.push(fixture.expectDesignTarget
...
export function runConceptContrastRegression() {
...
//# sourceMappingURL=conceptContrastRegression.js.map