...
export function scoreProspectingValue(input) {
    let score = 40;
    const reasons = [];
...
export function assignProspectingTier(input) {
    if (input.intentType === "RETAILER_BRANDED" ||
...
//# sourceMappingURL=prospectingValue.js.map