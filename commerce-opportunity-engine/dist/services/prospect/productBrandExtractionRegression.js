 ...
 */
import { classifyOrganicEntitySync, extractProductBrandName, } from "./productBrandExtractor.js";
export function runProductBrandExtractionRegression() {
    const cases = [];
    ...
    cases.push({
        ...
        passed: retailerExternalBrand.entityRole === "OFFICIAL_BRAND_DOMAIN" &&
    ...
    cases.push({
        ...
        passed: privateLabelNoDomain.entityRole === "MERCHANT_DOMAIN" &&
    ...
    cases.push({
        ...
        passed: directBrand.entityRole === "OFFICIAL_BRAND_DOMAIN" &&
...
//# sourceMappingURL=productBrandExtractionRegression.js.map