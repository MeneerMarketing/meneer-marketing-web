...
export function computeContentPresentationGap(input) {
    const evidence = [];
    let available = 35;
...
export function extractContentPresentationSignals(html) {
...
//# sourceMappingURL=contentPresentationGap.js.map