...
export function computeBrandFirstOpportunityScore(input) {
    ...
    const presentationGap = Math.max(0, Math.min(100, Math.round((visualGap * 0.45 + purchaseGap * 0.35 + mobileGap * 0.2) - presentation * 0.15)));
    const score = Math.round(brandQuality * 0.14 +
        companyScaleFit * 0.1 +
        catalogFocus * 0.08 +
...
//# sourceMappingURL=brandFirstOpportunityScore.js.map