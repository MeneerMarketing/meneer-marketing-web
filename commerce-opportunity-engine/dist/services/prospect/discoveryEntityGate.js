...
export function classifyDiscoveryDomain(normalizedDomain) {
...
export function isHardDiscoveryExcludedDomain(normalizedDomain) {
    return classifyDiscoveryDomain(normalizedDomain).hardExclude;
}
//# sourceMappingURL=discoveryEntityGate.js.map