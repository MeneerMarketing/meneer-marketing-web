...
export function isUsableForOutreach(emailType) {
    return emailType !== "PRIVACY_LEGAL";
}
export function emailTypePreferenceRank(emailType) {
    switch (emailType) {
