...
export async function applyTransparencyResult(client, result) {
...
export async function selectDomainsForTransparencyCheck(client, limit, preferredDomains = []) {
    const selected = [];
...
//# sourceMappingURL=transparencyRepository.js.map