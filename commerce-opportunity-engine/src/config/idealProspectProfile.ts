...
export const IDEAL_COMMERCE_PROSPECT_V1 = "IDEAL_COMMERCE_PROSPECT_V1" as const;

export const IDEAL_PROSPECT_DISCOVERY_MODE = "IDEAL_PROSPECT_DISCOVERY" as const;
...
export const IDEAL_OWN_BRAND_SCORES: Record<string, number> = {
  DTC_OWN_BRAND: 98,
  MOSTLY_OWN_BRAND: 90,
...
export const IDEAL_PLATFORM_SCORES: Record<string, number> = {
  SHOPIFY: 95,
  WOOCOMMERCE: 72,
  MAGENTO: 58,
  CUSTOM: 50,
