...
export const M992_DISCOVERY_VERSION = "VISUALLY_UNDERDESIGNED_FOCUSED_BRAND_V1" as const;
export const M992_DISCOVERY_ROUTE = "visual_underdesigned_pdp_gap_first" as const;
...
export const M992_PARKED_FAMILIES = ["SLEEP_COMFORT", "PET_PRODUCTS"] as const;

/** Broad ecommerce niches — avoid device-heavy M9.8.2 pools. */
export const M992_PRODUCT_QUERIES: M992ProductQuery[] = [
  {
...
export function buildM992HarvestQueries(): M992ProductQuery[] {
...
export const M992_DASHBOARD_REPORT_PATH =
  "dashboard/src/preview/concepts/data/visual-underdesigned-focused-brand-report.json";
