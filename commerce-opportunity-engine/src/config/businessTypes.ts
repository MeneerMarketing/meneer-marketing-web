...
export const domainBusinessTypes: Record<string, BusinessType> = {
...
const NON_LEAD_TYPES: BusinessType[] = [
  "GENERAL_RETAILER",
  "MASS_RETAILER",
  "MARKETPLACE",
  "COMPARISON_SITE",
...
export function classifyBusinessType(normalizedDomain: string): BusinessClassification {
