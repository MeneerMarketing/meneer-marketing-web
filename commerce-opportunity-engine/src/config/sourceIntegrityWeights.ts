...
export const SOURCE_TYPE_SCORE_CAPS: Record<string, number> = {
  LIVE_PAID_SERP: 100,
...
export const CRO_AUDIT_ALLOWED_LEVELS: CroReadinessLevel[] = ["EXACT_PAID_FUNNEL"];
...
export type SourceType =
  | PaidSourceType
  | "CONFIRMED_SEARCH_AD"
  | "TRANSPARENCY_CONFIRMED_SHOPPING"
  | "SHOPPING_CANDIDATE"
  | "PAID_CANDIDATE"
  | "UNKNOWN";
