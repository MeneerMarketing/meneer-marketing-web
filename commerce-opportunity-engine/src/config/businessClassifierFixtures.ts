...
export interface BusinessClassifierFixture {
  ...
  signals: Partial<PageExtractedSignals> & { bodyTextSample: string };
...
export function buildPageSignals(
  overrides: Partial<PageExtractedSignals> & { bodyTextSample: string }
...
export const BUSINESS_CLASSIFIER_FIXTURES: BusinessClassifierFixture[] = [
  {
    ...
    signals: {
      title: "LED Devices",
      bodyTextSample:
        "onze led apparaten voor beauty en huidverzorging. ons merk ontwikkelt zelf elk apparaat. gratis verzending, 30 dagen bedenktijd.",
  ...
  },
  {
    ...
    signals: {
      ...
      bodyTextSample:
        "eigen ontwerp, zelf ontwikkeld in nederland. onze producten helpen sporters herstellen. bekijk de collectie.",
  ...
  },
  {
    ...
    signals: {
      ...
      bodyTextSample:
        "elektronica, huishouden, beauty, tuin en sport onder één dak. bekijk al onze vestigingen en filialen door heel het land. alle merken op voorraad.",
  ...
  },
  {
    ...
    signals: {
      ...
      bodyTextSample:
        "sport, kampeer, camping, mode en reis artikelen. onze filialen en vestigingen door heel nederland. topmerken en a-merken in ons warenhuis.",
  ...
  },
  {
    ...
    signals: {
      ...
      bodyTextSample:
        "wij verkopen ergonomische hoofdkussens voor nekklachten. persoonlijk slaapadvies en 100 nachten proefslapen.",
      localeAlternateCount: 1,
  ...
  },
  {
    ...
    signals: {
      title: "Warenhuis",
      bodyTextSample:
        "elektronica, mode, tuin, dieren en huishouden. bezoek onze vestigingen of bestel online. alle merken a-z.",
      localeAlternateCount: 1,
