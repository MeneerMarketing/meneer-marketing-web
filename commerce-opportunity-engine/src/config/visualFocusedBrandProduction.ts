...
export const M994_DISCOVERY_VERSION = "VISUAL_FOCUSED_BRAND_PRODUCTION_V1" as const;
export const M994_DISCOVERY_ROUTE = "visual_focused_brand_production" as const;

/** Extra niches beyond M9.9.2 base set. */
const M994_EXTRA_QUERIES: M992ProductQuery[] = [
  {
...
export const M994_PRODUCT_QUERIES: M992ProductQuery[] = [
...
export function buildM994HarvestQueries(): M992ProductQuery[] {
...
export const M994_DASHBOARD_REPORT_PATH =
  "dashboard/src/preview/concepts/data/visual-focused-brand-production-report.json";
