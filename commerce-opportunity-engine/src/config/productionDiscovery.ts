...
export const M933_DISCOVERY_VERSION = "FOCUSED_PRODUCTION_DISCOVERY_V1" as const;
...
export const PRODUCTION_BRANCHES: ProductionBranch[] = [
  {
    archetypeId: "SLEEP_COMFORT",
    familyIds: ["ergonomic_pillows", "premium_mattress_systems"],
    keywordShare: 1,
    evidence:
      "M9.3.2: 51,5% prospect yield, beide families leverden APPROVED keywords met quality 59 en 64.",
  },
];

/** Families explicitly parked, with the reason, so nobody re-adds them blind. */
export const PARKED_FAMILIES: Array<{ familyId: string; reason: string }> = [
  ...
  { familyId: "automatic_feeders", reason: "voerbakken: 59% retailers" },
  {
    ...
    reason:
      "M9.3.4: vier audits in deze familie leverden contrast 33-46 tegen een drempel van 62. De pagina's zijn te goed voor een overtuigende before/after. Categorie geparkeerd op verzoek.",
  },
];
...
export type ProspectFunnelStage =
  | "raw_advertisers"
  | "prospect_eligible"
...
export const FUNNEL_STAGE_LABELS: Record<ProspectFunnelStage, string> = {
