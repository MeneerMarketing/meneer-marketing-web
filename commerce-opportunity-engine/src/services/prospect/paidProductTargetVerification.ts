...
export function verifyPaidProductTarget(input: PaidProductTargetInput): PaidProductTargetResult {
  const evidence: string[] = [];
  const keyword =
    input.expectedKeyword && input.adKeywords.includes(input.expectedKeyword)
