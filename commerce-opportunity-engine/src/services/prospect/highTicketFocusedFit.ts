...
import {
  HIGH_TICKET_FIT_WEIGHTS,
  HIGH_TICKET_PENALTIES,
...
export function computeHighTicketFocusedFit(input: HighTicketFitInput): HighTicketFitResult {
  ...
  const addPenalty = (reason: string, points: number): void => {
