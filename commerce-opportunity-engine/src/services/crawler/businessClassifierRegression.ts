...
import {
  BUSINESS_CLASSIFIER_FIXTURES,
  buildPageSignals,
  type BusinessClassifierFixture,
} from "../../config/businessClassifierFixtures.js";
...
function runFixture(fixture: BusinessClassifierFixture): ClassifierRegressionCase {
...
export function runBusinessClassifierRegression(): ClassifierRegressionResult {
