...
export function computeConceptAssetFeasibility(
  input: ConceptAssetFeasibilityInput
): ConceptAssetFeasibilityResult {
  ...
  let score = 0;
  const weights: Array<{ key: keyof typeof inventory; points: number; label: string }> = [
