...
export const personalizationSchema = z.object({
  ...
  /**
   * Eén zin over wat er nu op hun site mist, geschreven uit de constateringen
   * die de visuele beoordeling opleverde. Dit is het moment waarop de mail
   * bewijst dat er echt gekeken is.
   */
  site_gap: z.string().nullable().optional().default(null),
  ...
  subject_variant: z
    .enum(["chosen", "city", "made", "idea", "concept", "website"])
    .optional()
    .default("chosen"),
});
