...
export const TEMPLATES: {
  ...
  },
  {
    ...
    shortLabel: "C",
    description:
      "Filmische magazine-stijl. Instrument Serif met italic, oxblood en cream, volbeeld opening en weekrooster.",
  },
  {
    variant: "clinical-atelier",
    label: "Atelier Clinical",
    shortLabel: "D",
    description:
      "Premium petrol editorial. Plus Jakarta Sans, journey-stappen, experts-grid en Instagram-strip (Figma Setup).",
  },
];
...
function parseTemplateParam(value?: string | null): TemplateVariant | null {
  ...
  if (normalized === "d" || normalized === "atelier" || normalized === "clinical-atelier") {
    return "clinical-atelier";
  }
  return null;
}
