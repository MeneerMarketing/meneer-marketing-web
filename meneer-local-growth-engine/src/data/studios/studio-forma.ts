...
export const studioForma: StudioData = {
  ...
  country: "Nederland",
  logo: null,
  primary_color: "#2A211A",
  secondary_color: "#F8F4EE",
  accent_color: "#9C6B45",
  tagline: "Reformer Pilates met precisie en rust",
  description:
    "Studio Forma is een intieme reformer studio in het hart van Arnhem. Kleine groepen, scherpe instructie en een ruimte die uitnodigt tot focus. Hier train je kracht, controle en lengte, zonder ruis.",
  ...
  review_count: 87,
  founded_year: 2021,
  opening_hours: "Ma t/m vr 07:00 tot 21:00. Za 08:00 tot 14:00.",
  team: [
    {
      id: "lotte",
      name: "Lotte Vermeer",
      role: "Founder & Lead Instructor",
      bio: "Opgeleid in Londen en Amsterdam. Lotte combineert klassieke reformer techniek met een scherp oog voor alignment. Tien jaar ervaring in private en groepslessen.",
      image_url: "/demo/pilates-warm-team-1.webp",
    },
    {
      id: "noah",
      name: "Noah Bakker",
      ...
      image_url: "/demo/pilates-warm-team-2.webp",
    },
    {
      id: "saar",
      name: "Saar de Wit",
      ...
      image_url: "/demo/pilates-warm-team-3.webp",
    },
  ],
  images: [
    {
      ...
      alt: "Reformer oefening bij hoge boogramen met linnen gordijnen in Studio Forma",
      role: "hero",
    },
    {
      id: "studio-1",
      url: "/demo/pilates-warm-studio.webp",
      alt: "Studioruimte met vier reformers, eikenvloer en warme kalkwanden",
      role: "studio",
    },
    {
      id: "reformer-1",
      url: "/demo/pilates-warm-reformer.webp",
      alt: "Detail van leren straps, messing gespen en veren op de reformer",
      role: "reformer",
    },
    {
      id: "atmosphere-1",
      url: "/demo/pilates-warm-atmosphere.webp",
      alt: "Instructeur die de houding van een lid corrigeert op de reformer",
      role: "atmosphere",
    },
    {
      id: "gallery-1",
      url: "/demo/pilates-warm-movement.webp",
      alt: "Voeten in de straps met lange lijn tijdens een reformer oefening",
      role: "gallery",
    },
    {
      id: "gallery-2",
      url: "/demo/pilates-warm-corner.webp",
      alt: "Rustige hoek met travertijnen nis, handdoeken en eikenbank",
      role: "gallery",
    },
  ],
  memberships: [
