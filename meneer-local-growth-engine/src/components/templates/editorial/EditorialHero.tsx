...
interface Props {
  ...
  /** True als de sticky shell ook een top bar heeft: hero trekt verder omhoog. */
...
export function EditorialHero({
  ...
  const hasMedia = Boolean(model.heroImage);
  ...
  const headline = (
    <h1
      className={`ed-serif mt-6 max-w-[20ch] pb-1.5 ${
        hasMedia
          ? "text-[clamp(2.7rem,6.6vw,6rem)] leading-[1.02] tracking-[-0.024em] text-white"
          : "ed-display"
      }`}
    >
