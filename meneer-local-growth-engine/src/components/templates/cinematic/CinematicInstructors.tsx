 ...
 */
export function CinematicInstructors({ model }: Props) {
  ...
  return (
    <section id="instructors" className="bg-[var(--cn-cream)]">
      <div className="mx-auto px-5 py-16 sm:px-8 sm:py-20 lg:px-10 lg:py-24">
        <ScrollReveal>
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div>
              <p className="cine-label text-[var(--cn-muted)]">Instructors</p>
            ...
            <p className="max-w-[34ch] text-[13.5px] leading-6 text-[var(--cn-body)] sm:text-[14px]">
              Iedere les wordt gegeven door een instructor die je bij naam kent.
              Kies een naam en je ziet wie er voor je staat.
            </p>
          </div>
        </ScrollReveal>
