 ...
 */
export function CinematicChrome({ model }: Props) {
  const { wordmark, booking, navLinks, contact, city, studioName, primaryService } =
    model;
    ...
    <>
      <header className="absolute inset-x-0 top-0 z-30 px-5 pt-5 sm:px-8 sm:pt-7 lg:px-10">
        <div className="flex items-center justify-between gap-4">
          <a
            href="#top"
            className="cine-display cine-lower text-[1.6rem] text-[var(--cn-on-dark)] sm:text-[1.85rem]"
          >
            {wordmark.head}
            {wordmark.tail ? (
              <>
          ...
          >
            ...
            <div className="relative flex h-full flex-col px-5 pb-24 pt-5 sm:px-8 sm:pb-28 sm:pt-7 lg:px-10">
              ...
              <div className="mt-10 grid gap-6 border-t border-white/12 pt-6 sm:grid-cols-3">
                <div>
                  <p className="cine-label text-[var(--cn-on-dark-soft)]">Studio</p>
