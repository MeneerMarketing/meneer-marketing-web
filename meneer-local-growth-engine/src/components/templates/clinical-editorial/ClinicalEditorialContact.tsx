...
export function ClinicalEditorialContact({
  city,
  studioName,
  contact,
  booking,
        ...
        <ScrollReveal className="lg:col-span-6">
          <div className="flex flex-col">
            ...
            <h2 className="ed-serif ed-h2 mt-4 max-w-[34ch]">
              {city ? `Kom langs in ${city}` : "Kom langs in de kliniek"}
            </h2>
            ...
            {hasDetails ? (
              ...
              <p className="mt-8 max-w-[48ch] text-[1rem] leading-relaxed text-[var(--ed-fg-70)]">
                {`Plan een intake bij ${studioName} en ontdek welk behandelplan bij je huid past.`}
              </p>
            )}
            ...
            <div className="relative flex flex-1 flex-col justify-between gap-8 overflow-hidden p-7 md:p-9">
              <div className="relative">
                ...
                <p className="mt-4 max-w-[42ch] text-[0.97rem] leading-relaxed text-[var(--ed-fg-70)]">
                  Kies een moment dat past. Je krijgt huidanalyse, uitleg over
                  behandelingen en een helder vervolgadvies.
                </p>
              </div>
              <a
                href={booking.href}
