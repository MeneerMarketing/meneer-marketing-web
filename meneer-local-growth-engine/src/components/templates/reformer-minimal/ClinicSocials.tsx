 ...
 */
export function ClinicSocials({ studioName, socials, images }: Props) {
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <ScrollReveal>
            ...
            <p className="mt-4 max-w-md text-[15px] leading-7 text-[var(--fc-ink-soft)]">
              Lessen, sfeer en kleine momenten uit {studioName}. Dagelijks op
              Instagram en TikTok.
            </p>
          </ScrollReveal>
              ...
              return (
                <ScrollReveal key={`${img.url}-${index}`} delayMs={index * 70}>
                  ...
                  >
                    ...
                    <div
                      aria-hidden
                      className="absolute inset-0 bg-[var(--fc-ink)]/40 transition-opacity duration-500 group-hover:bg-[var(--fc-ink)]/50"
                    />
