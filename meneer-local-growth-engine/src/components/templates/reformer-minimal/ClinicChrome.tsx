  ...
  return (
    ...
    >
      <header className="relative z-10">
        <div
          className={`relative flex h-[4.25rem] items-center justify-between gap-6 px-5 sm:px-8 lg:px-10 ${
            onMedia ? "" : "mx-auto max-w-[1400px] lg:px-[5vw]"
          }`}
        >
          <a
            href="#top"
...
function MegaPanel({
  ...
  return (
    <div
      id={panelId}
      className={`absolute inset-x-3 top-[4.25rem] z-40 hidden overflow-hidden rounded-[var(--fc-radius-lg)] border border-[var(--fc-line)] bg-[var(--fc-paper)] lg:block ${
