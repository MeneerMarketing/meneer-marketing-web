 ...
 */
export function ClinicTeam({ team, variant = "pilates" }: Props) {
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="figma-display-l mt-3">
                {variant === "skin-clinic" ? (
                  <>
                    ...
                    <span className="font-light">specialisten</span>
                  </>
                ) : (
                  <>
                    <span className="font-bold">Jouw</span>{" "}
              ...
              <p className="mt-3 max-w-[42ch] text-[14px] leading-6 text-[var(--fc-ink-soft)] sm:text-[15px]">
                {variant === "skin-clinic"
                  ? "Artsen en huidtherapeuten die intake, veiligheid en resultaat combineren. Kies een portret en lees wie je begeleidt."
                  : "Zij staan naast je reformer. Kies een portret en je leest wie je voor je hebt."}
              </p>
            </div>
