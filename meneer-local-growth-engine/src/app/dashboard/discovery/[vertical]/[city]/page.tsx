...
import { Badge, MetricTile, Panel, SectionTitle } from "@/components/dashboard/ui";
import {
...
export default async function DiscoveryCityDetailPage({ params }: Props) {
  ...
  const { city, exclusivity, businesses, market } = detail;
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-sm text-slate-500">
                    {business.website_url ?? "geen website"} · rating{" "}
