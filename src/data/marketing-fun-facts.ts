...
const ALL_FACTS: MarketingFunFact[] = [
  ...
  },
  {
    ...
    body: "BP betaalde naar schatting 211 miljoen dollar voor hun huisstijl in 2008. Dat is consultancy en implementatie wereldwijd, geen tekeningetje op zolder. Merk is geen bijzaak.",
  ...
  },
  {
    ...
    body: "Veel marketeers en webshops zien hogere conversie met video op productpagina's. Niet gegarandeerd op elke shop. Wel een patroon dat blijft terugkomen in A/B-tests.",
    href: "/diensten/ugc",
