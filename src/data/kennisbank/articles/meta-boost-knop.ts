...
export const META_BOOST_KNOP: KennisbankArticle = {
  slug: "meta-boost-knop-budget-verbranden",
  title: "Meta Ads: waarom je boost-knop geld verbrandt",
  description:
  ...
  sections: [
    ...
    {
      type: "h2",
      text: "Wat de boost-knop wél doet",
    },
    {
      type: "p",
      text: "Je betaalt voor bereik en soms engagement op één post. Likes, views, misschien een klik naar je profiel. Meta optimaliseert op wat het platform gezond vindt: activiteit. Niet per se op jouw omzet. Een post die leuk is om te liken maar niet verkoopt, wordt met boost alleen duurder leuk om te liken.",
    },
    {
      type: "ul",
      items: [
    ...
    {
      type: "h2",
      text: "Wat je in plaats daarvan doet",
    },
    {
      type: "h3",
    ...
    {
      type: "h3",
      text: "UGC en echte mensen",
    },
    {
      type: "p",
      text: "Stock en corporate video voelt als een ad. UGC voelt als content. Dat is waarom creators en short video onderdeel zijn van hoe ik Meta aanpak. Niet omdat het hip is, maar omdat het scrollen stopt.",
    },
    {
      type: "h3",
      text: "Landings die matchen",
    },
    {
      type: "p",
    ...
    {
      type: "callout",
      text: "Heet take: boosten op een post zonder pixel en zonder landingspagina is een kunstproject, geen acquisitie.",
    },
    {
      type: "h2",
