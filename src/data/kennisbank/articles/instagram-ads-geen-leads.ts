...
export const INSTAGRAM_ADS_GEEN_LEADS: KennisbankArticle = {
  slug: "instagram-ads-geen-leads",
  title: "Instagram Ads: mooi beeld, lege inbox",
  description:
  ...
  keywords: [
    ...
    "instagram advertenties ondernemer",
    "meta ads leads",
    "instagram ads tips",
  ],
  ...
  sections: [
    {
      type: "p",
      text: "Je creative is prachtig. Reels-quality. Je collega zegt wow. Je moeder vindt het leuk. Je inbox zegt niets. Ads zijn geen portfolio voor je designer-ego. Ads zijn een kassabon. Mooi helpt. Mooi zonder offer, landings en tracking is een dure like-machine.",
    },
    {
      type: "callout",
    ...
    {
      type: "h2",
      text: "Waar Instagram Ads stuklopen",
    },
    {
      type: "ul",
      items: [
