...
export const TRACKING_GOOGLE_ANALYTICS: SeoLandingPage = {
  ...
  enrichedOverrides: {
    ...
    deepDive: {
      title: "Events, waarde, consent, ads",
      paragraphs: [
        "Primary conversions: purchase, generate_lead, call. Scroll en engaged session zijn diagnostisch.",
        "Ecommerce: value, currency, items. Zonder waarde is ROAS theater.",
        "Consent mode: tags respecteren keuze. Modellering helpt, rommelige setup niet.",
        "Ads: importeer alleen wat klopt. Optimaliseer niet op bedanktpagina-views.",
        "Nazorg: na releases opnieuw testen. Tracking is onderhoud, geen eenmalige checkbox.",
      ],
    },
    scenario: {
      title: "Stel: Ads toont 3× meer conversies dan je shop",
      paragraphs: [
        "Dan optimaliseer je op fantomen. Ik zoek dubbele tags, verkeerde triggers, enhanced conversions die dubbeltellen.",
        "Na de fix daalt het dashboard-cijfer vaak. Dat is goed nieuws. Eerlijkheid is goedkoper dan valse ROAS.",
