...
export const GOOGLE_ADS_BUREAU: SeoLandingPage = {
  ...
  pains: [
    {
      ...
      body: "Je dashboard toont verkeer. Je bankrekening niet. Meestal liegt de site, niet het budget.",
    },
    {
      title: "Account vol met rommel",
      body: "Broad match hier, smart campaign daar. Je betaalt voor zoekwoorden die je moeder ook zou typen.",
    },
    {
      title: "Bureau zonder context",
      body: "Ze sturen een maandrapport. Niemand vraagt waarom je marge op product X te laag is voor breakeven.",
    },
  ],
  deliverables: [
    {
    ...
    },
    {
      ...
      body: "Advertentie en pagina zeggen hetzelfde. Anders betaal je dubbel voor afhakers.",
    },
    {
    ...
    },
    {
      ...
      body: "Wat werkt krijgt gas. Wat niet werkt eruit. SkinComplete deed dit pas nadat SEO en site stonden.",
    },
  ],
  visual: "google-ads",
  ...
  processSteps: [
    ...
    },
    {
      ...
      body: "Conversies, remarketing-lists, Merchant Center als je verkoopt. Saai werk dat alles later makkelijker maakt.",
    },
    {
      title: "Klein testen",
      body: "Beperkt budget, strakke zoekwoorden, één duidelijke landingspagina. Leren zonder branden.",
    },
    {
      title: "Opschalen met bewijs",
      body: "ROAS of CPA op orde? Dan pas budget omhoog. Niet omdat de maand om is.",
    },
  ],
