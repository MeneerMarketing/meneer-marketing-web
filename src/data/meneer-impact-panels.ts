...
const IMPACT_PANELS: readonly MeneerImpactPanel[] = [
  ...
  },
  {
    ...
    visual: "intake",
    label: "Intake",
    headline: "Twee minuten. Geen deck.",
  ...
  },
  {
    ...
    body: "SkinComplete: SEO en mail eerst. BestRest: per productlijn. Hills: site en app in één lijn. Jouw fase bepaalt de volgorde, geen copy-paste traject.",
    href: "/werkwijze",
...
export const OVER_IMPACT: MeneerImpactContent = {
  ...
  title: "Wie je inhuurt.",
  titleAccent: "En hoe.",
  lead: "Sinds 2012 bouw ik, meet en stuur ik zelf. Geen postbus, geen accountmanager die wisselt. Dit is wie je aan tafel krijgt.",
