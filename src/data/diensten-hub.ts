...
export const DIENSTEN_HUB_HERO = {
  ...
  subtitle:
    "Twaalf jaar site, shop, SEO en ads. Jij praat met mij. Direct contact met degene die je shop opent, je campagnes draait en je code kent.",
  stats: [
  ...
  cards: [
    {
      ...
      quip: "Groeiplan, ads-strategie, CRO en tracking. Een plan dat je opent, niet in een la laat liggen.",
      accent: "#FF5722",
    },
    {
      ...
      anchor: "hub-bouwen",
      shortLabel: "Bouwen",
      title: "Sites en shops from scratch. Jouw merk, eigen code.",
...
export const DIENSTEN_HUB_PILLARS: readonly DienstenHubPillar[] = [
  {
    ...
    body: "Groeiplan, advertentiestrategie, CRO en tracking die klopt. Een plan dat je gebruikt: welk kanaal wanneer, waar het lekt, en wat je níet moet doen.",
    hotTake:
    ...
    proof: "Per productlijn een eigen route. Jouw funnel, niet een standaard template uit Canva.",
  ...
  },
  {
    ...
    titleAccent: "Een digitale verkoper die 24/7 draait.",
    body: "Next.js, custom Shopify, B2B-portalen, boekingsapps. Eigen code die mee kan met adverteren en opschalen. Code die meegroeit als jij opschaalt.",
    hotTake:
      "Gekochte templates zijn als een pak van de Hema. Past, maar niemand onthoudt je naam.",
    proof: "B2B-portaal waar klanten 24/7 bestellen. Van nachtelijke mailtjes naar een systeem dat meeschaalt.",
    pillarHref: "/bouwen",
  ...
  },
  {
    ...
    proof: "Eerst ranken op de vragen die je klant echt stelt. Ads pas wanneer organisch al verkocht.",
  ...
  },
  {
    ...
    proof: "Eigen strategie per productlijn. Budget dat rendeert, niet verdampt in een generieke funnel.",
  ...
  },
  {
    ...
    proof: "Mail en flows vóór het adsbudget omhoog ging. Elke euro werkte harder.",
    pillarHref: "/behoud",
...
export const DIENSTEN_SKINCOMPLETE_BEAT = {
  ...
  title: "Organisch eerst verkopen.",
  titleAccent: "Ads als versterker.",
  body: "Bewust gekozen volgorde: eerst shop, SEO en mail tot klanten zelf bestellen. Pas dan Google Ads en Meta als versterker. Zwakke shop + veel ads = arm worden met stijl.",
  steps: [
...
export const DIENSTEN_HUB_FAQ = [
  ...
  },
  {
    ...
    answer:
      "Kan, mits de basis klopt. Vaak begin ik met SEO en mail. Ads pas wanneer organisch verkocht.",
  },
  {
...
export const DIENSTEN_HUB_CTA = {
  ...
  body: "Vul de intake in. Twee minuten. Ik kijk mee welk hoofdstuk nu het meest logisch is. Vrijblijvend en eerlijk. Soms is het antwoord: nog niet adverteren.",
} as const;
