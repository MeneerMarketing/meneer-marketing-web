...
export const HUIDKLINIEKEN_VERTICAL: VerticalLandingConfig = {
  ...
  caseStudy: {
    ...
    lead: "DIBA had in de stoel al het vertrouwen. Online moest hetzelfde. Ik bouwde dibaclinics.nl from scratch, SEO per behandeling, Google Ads en Meta op landings die echt converteren. Eén marketinglijn, geen losse partijen.",
    facets: [
      { label: "Website", text: "From scratch, vertrouwen online" },
      { label: "SEO", text: "Per klacht en behandeling" },
