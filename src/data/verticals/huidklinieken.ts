...
export const HUIDKLINIEKEN_VERTICAL: VerticalLandingConfig = {
  ...
  caseStudy: {
    ...
    imageAlt: "DIBA Clinics website en afspraakflow",
    eyebrow: "Case · DIBA Clinics",
    title: "Huidkliniek-site from scratch. Live in Rotterdam.",
    lead: "Voor DIBA Clinics bouwde ik dibaclinics.nl in Next.js: prijzen zichtbaar, SEO per behandeling en een route naar afspraak die past bij een echte kliniek, niet bij een influencer-template.",
    facets: [
      { label: "Website", text: "Next.js from scratch" },
      { label: "SEO", text: "Behandelingen en lokale intentie" },
      { label: "Conversie", text: "Prijzen en afspraakflow zichtbaar" },
      { label: "Locatie", text: "Rotterdam" },
    ],
  },
  faq: [
    {
