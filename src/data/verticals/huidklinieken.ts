...
export const HUIDKLINIEKEN_VERTICAL: VerticalLandingConfig = {
  ...
  caseStudy: {
    enabled: true,
    client: "DIBA Clinics",
    city: "Hillegersberg, Rotterdam",
    href: "/cases/diba-clinics",
    websiteUrl: "https://dibaclinics.nl",
    imageSrc: "/cases/diba-clinics-hero.jpg",
    imageAlt: "DIBA Clinics huidscan en marketingtraject",
    eyebrow: "Case · DIBA Clinics",
    title: "Site, SEO, Google Ads en Meta. Eén lijn.",
    lead: "Voor DIBA Clinics aan de Weissenbruchlaan in Hillegersberg bouwde ik dibaclinics.nl from scratch, plus SEO per behandeling, Google Ads en Meta. Prijzen zichtbaar, route naar afspraak strak, campagnes op landings die converteren.",
    facets: [
      { label: "Website", text: "From scratch, geen template" },
      { label: "SEO", text: "Behandelingen en lokale intentie" },
      { label: "Google Ads", text: "Landings op zoekintentie" },
      { label: "Meta Ads", text: "Creatives die als kliniek voelen" },
    ],
  },
  faq: [
    {
