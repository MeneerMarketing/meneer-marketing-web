...
const CHAT_BY_SITUATION: Record<string, readonly ChatLine[]> = {
  ...
  find: [
    ...
    { from: "jij", text: "Twijfel of we daar bestaan in AI-antwoorden." },
    { from: "meneer", text: "SEO én AI-antwoorden. Dat is je goedkoopste traffic." },
  ],
  ads: [
    { from: "meneer", text: "Wat kost een klant je nu echt?" },
    { from: "jij", text: "ROAS schommelt elke week. Ik zie het patroon niet." },
  ...
  retain: [
    ...
    { from: "jij", text: "Af en toe een nieuwsbrief. Verder stil." },
