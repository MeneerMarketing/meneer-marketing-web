...
interface AboutMeneerCollabCtaProps {
  visible: boolean;
}

/** Full-width CTA onder de About Meneer-sectie, na het strategiegesprek. */
export function AboutMeneerCollabCta({ visible }: AboutMeneerCollabCtaProps) {
