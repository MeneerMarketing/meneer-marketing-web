...
import { MeterShareScore } from "@/components/meter/MeterShareScore";

import { MeterTechnicalReport } from "@/components/meter/MeterTechnicalReport";
...
const SCAN_LINES = [
  ...
  "TLS handshake en final URL check…",

  "Canonical, robots en hreflang in head parsen…",

  "JSON-LD blocks en schema types uitpluizen…",

  "Render stack: sync scripts in document head…",

  "Stylesheet count en inline CSS weight…",

  "Image lazyload, dimensions en modern formats…",

  "Open Graph, Twitter card en social preview stack…",

  "Booking integraties en contact hooks scannen…",

  "CMS fingerprint en legacy dependencies…",

  "Platform signatuur vs custom stack…",

];



interface MeterExperienceProps {
...
export function MeterExperience({ initialUrl = "" }: MeterExperienceProps) {
  ...
  useEffect(() => {
    ...
    if (phase === "verdict" && result) {
      ...
      setLiveMessage(
        ...
        `Eindscore ${result.total} van 100. Oordeel: ${result.verdict}. ${result.oneLiner}`,
  ...
  const runScan = useCallback(async () => {
    ...
    setLiveMessage("Scan gestart. HTML response wordt geanalyseerd.");
    ...
    try {
      ...
      setLiveMessage(
        ...
        `Analyse klaar voor ${record.result.siteName}. Raad je score voordat je het oordeel ziet.`,
      ...
      if (typeof window !== "undefined") {
        ...
        w.dataLayer.push({
          ...
          findings: record.result.technicalFindings.length,
      ...
      setLiveMessage("Netwerkprobleem tijdens scan.");
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="mt-5 text-4xl font-extrabold tracking-tighter text-slate-900 sm:text-5xl lg:text-6xl">
            ...
            <span className="mt-1 block text-[#FF5722]">Ik lees je stack, niet je slogans.</span>

          </h1>

          <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-slate-600 sm:text-lg">
            Plak je link. Ik kijk of je site snel is, of Google je snapt, of mensen je vertrouwen
            en kunnen boeken. Vier scores, één eindcijfer. Gratis. Ik leg alles uit in gewone taal.
          </p>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              ...
              <motion.p
                ...
                className="mt-3 text-sm font-semibold text-slate-700 sm:text-base"
          ...
          >
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg sm:p-8">
              ...
              <p className="mt-2 text-sm text-slate-600">
                ...
                {result.technicalFindings.length} technische signalen gevonden. Eén getal. Geen
        ...
        {phase === "verdict" && result ? (
          ...
          <>
            ...
            <MeterTechnicalReport findings={result.technicalFindings} />

            <MeterShareScore result={result} userGuess={guess} />
