...
const FOOTER_CONTACT_LINE =
  "Eerst praten. Jouw plannen horen, rare ideeën en al.";
  ...
  return (
    <footer className="border-t border-slate-800 bg-mm-footer-bg text-white">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
        <div className="rounded-2xl border border-slate-600/80 bg-slate-800/90 p-4 sm:p-8">
          ...
          <div className="mt-4 sm:mt-5 lg:flex lg:justify-center">
            <div className="flex w-full flex-col gap-2 lg:inline-flex lg:w-auto lg:items-stretch">
            ...
            <Link
              ...
              className="group flex w-full items-center justify-between gap-3 rounded-2xl border border-white/20 bg-white/[0.07] px-4 py-3.5 text-left transition hover:border-sky-400/45 hover:bg-sky-500/10 sm:px-5 sm:py-4 lg:min-w-0"
            >
        ...
        <div className="mt-8 grid grid-cols-2 gap-x-5 gap-y-7 sm:gap-x-8 lg:mt-12 lg:grid-cols-[1.2fr_1fr_1fr] lg:gap-10">
          <div className="col-span-2 lg:col-span-1">
            <Logo variant="light" />
            <p className="mt-3 max-w-sm text-sm leading-relaxed tracking-tight text-mm-footer-muted lg:mt-4">
              <span className="lg:hidden">Web, marketing &amp; automatisering. Één lijn.</span>
              <span className="hidden lg:inline">
                MeneerMarketing helpt ondernemers groeien. Web, marketing en automatisering op
                één lijn. Technisch scherp, menselijk in de uitvoering.
              </span>
            </p>
            <MeneerPeek />
          </div>
          ...
          <div>
            ...
            <ul className="mt-3 grid grid-cols-2 gap-x-3 gap-y-2.5 text-sm font-medium text-slate-200 lg:mt-4 lg:grid lg:grid-cols-2 lg:gap-x-3 lg:gap-y-2.5">
              <li>
              ...
              {megaMenuColumns.map((col) => (
                <li key={col.category}>
                  ...
                  <span className="mt-0.5 hidden text-xs text-mm-footer-muted lg:block">
                    {col.subtitle}
                  </span>
                </li>
              ))}
        ...
        <nav
          ...
          className="mt-6 flex flex-row flex-wrap items-center justify-center gap-x-5 gap-y-1 text-[11px] font-normal text-slate-500"
        >
        ...
        <div className="mt-6 flex flex-col items-center gap-2 text-center text-xs text-mm-footer-muted sm:mt-8">
