...
import { DIENSTEN_HERO_FACTS } from "@/data/diensten-index";

export function DienstenHeroFactStack() {
  const reduce = useReducedMotion();
  const [featured, ...rest] = DIENSTEN_HERO_FACTS;
        ...
        {rest.map((fact, index) => (
          <motion.div
            ...
            initial={
              reduce
                ? false
                : { opacity: 0, x: index % 2 === 0 ? -10 : 10, rotate: fact.tilt * 1.5 }
            }
