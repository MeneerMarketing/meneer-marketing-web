  ...
  return (
    <AnimatePresence>
      {show ? (
        ...
        >
          <div className="pointer-events-auto flex w-full max-w-4xl items-center gap-2.5 rounded-full border border-mm-border bg-white/92 py-2 pl-2.5 pr-2 shadow-[0_10px_40px_rgba(15,23,42,0.16)] backdrop-blur-lg sm:gap-4 sm:py-2.5 sm:pl-4 sm:pr-2.5">
