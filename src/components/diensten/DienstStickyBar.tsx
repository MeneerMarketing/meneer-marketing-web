  ...
  return (
    <AnimatePresence>
      {show ? (
        ...
        >
          <div className="pointer-events-auto flex w-full max-w-xl items-center gap-2.5 rounded-full border border-mm-border bg-white/92 py-2 pl-2.5 pr-2 shadow-[0_10px_40px_rgba(15,23,42,0.16)] backdrop-blur-lg sm:gap-3 sm:pl-3">
            ...
            <p className="min-w-0 flex-1 text-[13px] font-bold leading-snug text-mm-text sm:text-sm">
              Zin om te groeien?
              <span className="hidden font-medium text-mm-muted sm:inline">
                {" "}
                {dienstName
