...
import { HUIDKLINIEKEN_RELATED_LINKS } from "@/data/verticals/huidklinieken";

/** Topical internal links: crawlable, compact, design-light. */
export function HuidkliniekInternalLinks() {
  return (
    <section
      className="border-b border-slate-200 bg-white"
      aria-labelledby="Huidkliniek-related-heading"
    >
      <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
        ...
        <h2
          id="Huidkliniek-related-heading"
        ...
        <p className="mt-3 max-w-xl text-sm leading-relaxed text-slate-600 sm:text-base">
          Dit Huidkliniek-programma leunt op dezelfde expertise. Bekijk de
          onderliggende diensten of de case.
        </p>

        <ul className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {HUIDKLINIEKEN_RELATED_LINKS.map((item) => (
            <li key={item.href}>
              <Link
                href={item.href}
