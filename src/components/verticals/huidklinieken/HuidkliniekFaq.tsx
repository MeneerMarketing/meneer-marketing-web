 ...
 */
export function HuidkliniekFaq() {
  const faqs = HUIDKLINIEKEN_VERTICAL.faq;

  return (
    <section
      id="faq"
      className="border-b border-slate-200 bg-slate-50/70"
      aria-labelledby="huidkliniek-faq-heading"
    >
      <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-start lg:gap-14">
          <Reveal className="lg:sticky lg:top-24">
            ...
            <h2
              id="huidkliniek-faq-heading"
              className="mt-3 text-3xl font-extrabold tracking-tighter text-slate-900 sm:text-4xl"
            >
              Vragen die kliniek-eigenaren écht stellen
            </h2>
            <p className="mt-4 max-w-md text-base leading-relaxed text-slate-600">
              Liever de korte versie? Rechts staan de vragen die ik het vaakst
              krijg. Antwoord open, zonder salespraat eromheen.
            </p>
            ...
            <div className="mt-8">
              <GroeiscanMeneerCoach
                theme="light"
                message="Twijfel je tussen Clinic Edition en Growth Partner? Stuur je situatie. Ik zeg eerlijk welk pakket past."
              />
            </div>
