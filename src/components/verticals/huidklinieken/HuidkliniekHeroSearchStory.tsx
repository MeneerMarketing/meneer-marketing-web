...
/**
 * Het moment waarop een kliniek een intake wint of verliest: de lokale zoekopdracht.
 * Speelt eenmalig af bij mount, staat stil bij prefers-reduced-motion.
 */
export function HuidkliniekHeroSearchStory() {
        ...
        >
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] font-medium text-slate-500">
              Donderdag 14:00, zonder telefoontje
            </p>
          </div>
        </motion.div>
      </div>
