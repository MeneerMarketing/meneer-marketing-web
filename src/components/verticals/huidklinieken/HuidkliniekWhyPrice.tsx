...
const clinicPackage = HUIDKLINIEKEN_VERTICAL.pricing.packages[0]!;
const monthly = formatVerticalMoney(clinicPackage.monthly);
...
const SEGMENTS = [
  {
    ...
    dot: "bg-orange-300",
    detail:
      "De kliniek-fundering, UX en design systems staan al. Die uren zijn ooit gemaakt en betaal jij niet opnieuw.",
  },
  {
    id: "branding",
    label: "Jouw branding",
    ...
    dot: "bg-white",
    detail:
      "Logo, kleuren, fotografie, behandelingen, team en tarieven. Hier gaat mijn tijd heen, want dit maakt het jouw kliniek.",
  },
  {
    id: "seo",
    label: "Lokale SEO",
    ...
    dot: "bg-[#FF5722]",
    detail:
      "Structuur, schema, snelheid en de injectie op huidkliniek [jouw stad], zodat zoekverkeer je überhaupt vindt.",
  },
  {
    id: "care",
    label: "Hosting & zorg",
...
export function HuidkliniekWhyPrice() {
  ...
  return (
    <section
      ...
      aria-labelledby="Huidkliniek-why-price-heading"
    >
      <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="grid gap-8 lg:grid-cols-12 lg:gap-10">
          <Reveal className="lg:col-span-7">
            ...
            <h2
              id="Huidkliniek-why-price-heading"
          ...
          <Reveal delay={0.08} className="lg:col-span-5 lg:pt-24">
            <p className="text-base leading-relaxed text-slate-600 sm:text-lg">
              ...
              kliniek-fundering staat, dus de uren gaan naar jouw kliniek in
