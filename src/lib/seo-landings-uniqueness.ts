...
const PAIN_ALTS: Record<SeoLandingCategory, readonly Card[]> = {
  ...
  seo: [
    ...
    { title: "Blogfabriek zonder route", body: "Veertien posts per kwartaal. Geen interne links. Geen pagina die echt geld oplevert. Volume is geen strategie." },
  ...
  website: [
    ...
    { title: "Alles op één pagina", body: "Je homepage moet verkopen, informeren, werven en bloggen. Geen wonder dat niemand snapt wat je doet." },
    { title: "Geen landings per campagne", body: "Je ads sturen naar je homepage. Die moet alles aan. Spoiler: dat kan geen enkele pagina." },
  ...
  shopify: [
    ...
    { title: "Checkout-frictie", body: "Mensen vullen hun mand. Dan vragen we om een account, drie velden extra en hun grootmoeders meisjesnaam." },
    { title: "Product-SEO als bijlage", body: "Titels uit de leverancier. Geen structuur. Google indexeert je wel, maar verkoopt voor je concurrent met betere copy." },
    ...
    { title: "Geen abandoned cart flow", body: "Mensen laten €80 liggen. Je stuurt geen mail. Dat is gratis geld dat elke week terugkomt." },
  ...
  content: [
    { title: "Volume zonder intentie", body: "Drie blogs per week. Geen enkele rankt op koopwoorden. Je team is moe. Google is ongeïnteresseerd." },
    { title: "AI-bulk zonder stem", body: "Honderd pagina's in een weekend. Geen mens herkent je merk. AI-zoek citeert je ook niet." },
    { title: "Geen interne linkstructuur", body: "Je sterke pagina's linken nergens naartoe. Je zwakke pagina's sterven alleen. Autoriteit lekt weg." },
    { title: "FAQ die niemand leest", body: "Vijftien vragen onderaan, copy-paste uit je branche. Geen enkele beantwoordt wat je klant echt typt in Google." },
  ...
  "b2b-portal": [
    ...
    { title: "Geen koppeling met CRM", body: "Sales werkt in tool A. Marketing in tool B. Niemand weet welke lead warm is." },
    ...
    { title: "Geen inzicht in marges", body: "Je verkoopt online zonder te weten welke klant winst oplevert. Opschalen wordt gokken." },
  ],
};

const DELIVERABLE_ALTS: Record<SeoLandingCategory, readonly Card[]> = {
  "google-ads": [
    { title: "Zoektermen-audit", body: "Welke queries kosten geld zonder oplevering? Die gaan eruit voordat we opschalen." },
    { title: "Breakeven-rekening", body: "Marge, AOV, conversie. Pas als het klopt, gaat budget omhoog." },
    { title: "Ad copy die matcht", body: "Geen generieke headlines. Wel teksten die passen bij wat je landings beloven." },
    ...
    { title: "Weekly tune-ups", body: "Geen set-and-forget. Elke week iets bijsturen op basis van echte data." },
    { title: "Landings from scratch", body: "Als je pagina niet converteert, bouw ik er een die wel past bij je sterkste ad." },
    { title: "Meta + Google één plan", body: "Twee kanalen, één strategie. Geen bureaus die elkaar tegenspreken." },
  ],
  seo: [
    { title: "Technische basis", body: "Indexatie, canonicals, sitemap, CWV. Saai tot het niet saai is." },
    { title: "Intentie-mapping", body: "Welke vraag hoort op welke URL? Geen keyword-stuffing, wel structuur." },
    ...
    { title: "Interne link-architectuur", body: "Je sterke pagina's tillen de rest. Geen wees-pagina's meer." },
    ...
    { title: "Monitoring zonder drama", body: "Rankings, clicks, conversies. Geen maandrapport met vage KPI's." },
  ],
  website: [
    { title: "Next.js from scratch", body: "Geen theme. Wel semantische HTML, snelheid en ruimte om te groeien." },
    { title: "Mobiel-first QA", body: "Ik test op telefoon vóór we trots zijn op desktop." },
    ...
    { title: "Copy in Meneer-stem", body: "Jij/je, direct, soms droog. Geen bureau-template." },
  ...
  content: [
    ...
    { title: "Update-ritme", body: "Oude posts versterken vóór we nieuwe stapelen." },
    { title: "FAQ die rankt", body: "Vragen die mensen stellen, beantwoord op je domein." },
    { title: "Case-blokken met cijfers", body: "SkinComplete, BestRest waar het past. Geen vage 'succesverhalen'." },
    { title: "AI-zoek ready", body: "Structuur die machines kunnen samenvatten zonder je te misquoten." },
  ],
  "b2b-portal": [
    { title: "Proces-mapping", body: "Van lead tot order tekenen we waar tijd lekt." },
    ...
    { title: "Automatische prijslijsten", body: "Eén bron van waarheid. Geen PDF versie 12." },
    { title: "Training & overdracht", body: "Je team snapt het systeem. Geen black box die alleen ik kan bedienen." },
  ],
};

const PROCESS_ALTS: Record<SeoLandingCategory, readonly Step[]> = {
  "google-ads": [
    { title: "Account autopsie", body: "Wat lekt, wat werkt, wat weg mag. Geen schuldspel, wel feiten." },
    ...
    { title: "Remarketing aanscherpen", body: "Doelgroepen die echt warm zijn. Geen stalking." },
  ],
  seo: [
    { title: "Technische scan", body: "Indexatie, snelheid, errors. Fundament vóór content." },
    { title: "Intentie per URL", body: "Welke pagina wint welke vraag? Geen cannibalization." },
  ...
  website: [
    ...
    { title: "Build in Next.js", body: "Snel, schoon, schaalbaar. Geen plugin-drama." },
  ...
  content: [
    ...
    { title: "Prioriteit", body: "Welke antwoorden leveren geld op? Daar beginnen we." },
    ...
    { title: "Updaten", body: "Oude posts versterken. Geen eindeloze stapel nieuw." },
  ],
  "b2b-portal": [
    ...
    { title: "Testen met echt team", body: "Geen demo voor de board. Wel workflow met je medewerkers." },
    { title: "Live & trainen", body: "Je team snapt het. Geen afhankelijkheid van één persoon." },
...
const PROOF_TWISTS = [
  " SkinComplete groeide eerst organisch, ads kwamen pas toen de site en SEO stonden.",
  " BestRest kreeg per product een plan. Geen one-size-fits-all account.",
  " Bij {kw} kopieer ik geen playbook. Wel principes die bij SkinComplete en BestRest werkten.",
...
const CTA_BODY_ALTS = [
  ...
  "Geen sales-script. Wel een gesprek over marge, timing en wat je site nu doet.",
  "Stuur je situatie. Ik reageer met eerlijk advies, soms ook met: doe dit eerst zelf.",
  "Intake is geen verkooptruc. Het is kijken of we samen iets kunnen bouwen dat je bank snapt.",
...
const UNIQUE_OPENERS: readonly string[] = [
  ...
  "Geen 'wij zijn dé specialist'-praat. Wel: dit is wat ik echt doe, wat het kost aan tijd en waar het misgaat als je het verkeerd aanpakt.",
  ...
  "SkinComplete en BestRest leerden me dat volgorde alles is. SEO, site, dan ads. Niet andersom.",
...
const PAIN_SECTION_INTROS = [
  "Dit hoor ik wanneer iemand zoekt op {kw}. Herkenbaar? Geen schaamte. Wel een teken dat het anders mag.",
  ...
  "Geen diagnose. Wel herkenning. Dit zijn de patronen die ik zie rond {kw}{loc}.",
  "Voordat we oplossingen praten: dit zijn de klachten die echt binnenkomen over {kw}.",
] as const;
...
export const EXTRA_FAQ_POOL: Record<SeoLandingCategory, readonly SeoLandingFaq[]> = {
  "google-ads": [
    { question: "Wat maakt jullie {kw} anders dan een standaard bureau?", answer: "Ik bouw en optimaliseer zelf: site, landings, tracking, campagnes. Geen keten van specialisten die elkaar de schuld geven." },
    { question: "Werken jullie ook voor kleinere budgetten?", answer: "Ja, als de rekensom klopt. Liever €800 strak dan €8.000 zonder plan." },
    ...
    { question: "Moet ik al verkeer hebben voor {kw}?", answer: "Niet per se. Wel meetpunten. Geen data is geen strategie, wel een gok." },
    { question: "Wat als het niet werkt?", answer: "Dan zeg ik waarom en wat we anders doen of stoppen. Cijfers bepalen, niet de kalender." },
    { question: "Beheren jullie Performance Max?", answer: "Ja, met schone feeds en duidelijke doelen. PMax zonder input is een gokautomaat." },
    { question: "Doen jullie ook Google Shopping?", answer: "Ja. Feed eerst, campagnes daarna. Anders betaal je voor producten die Google niet wil tonen." },
    { question: "Kunnen jullie mijn bestaande account overnemen?", answer: "Vaak wel. Eerst audit: wat lekt, wat blijft, wat weg mag." },
    ...
    { question: "Werken jullie op ROAS of CPA?", answer: "Wat past bij je marge. Soms is CPA leidend, soms ROAS. We kiezen vóór we opschalen." },
    ...
    { question: "Doen jullie ook remarketing?", answer: "Ja, met grenzen. Herkenning zonder stalken." },
    { question: "Kunnen jullie landingspagina's bouwen?", answer: "Dat is vaak stap één. Ad en pagina moeten hetzelfde verhaal vertellen." },
    { question: "Hoe vaak sturen jullie rapportages?", answer: "Zoals jij het nodig hebt. Ik stuur liever actie dan dertig pagina's groen." },
    { question: "Werken jullie met vaste contracten?", answer: "Nee verplichte lange contracten. Wel afspraken over scope en verwachting." },
  ],
  seo: [
    ...
    { question: "Doen jullie ook lokale SEO?", answer: "Ja. GBP, site, reviews in één lijn. Alleen je adres in de footer is niet genoeg." },
    { question: "Schrijven jullie content zelf?", answer: "Ja, in jouw stem waar mogelijk. Geen AI-bulk zonder redactie." },
    { question: "Wat is het verschil met een SEO-bureau?", answer: "Ik bouw ook je site. SEO zonder technische controle is half werk." },
    { question: "Helpen jullie met AI-zoek?", answer: "Ja. ChatGPT en Gemini citeren duidelijke antwoorden op je domein." },
    { question: "Doen jullie linkbuilding?", answer: "Alleen kwaliteit boven kwantiteit. Slechte links zijn erger dan geen." },
    ...
    { question: "Hoe meten jullie succes?", answer: "Leads, omzet, rankings die converteren. Niet alleen impressions." },
    { question: "Doen jullie SEO-audits?", answer: "Ja. Snel inzicht in wat lekt en wat winst geeft." },
    { question: "Werken jullie voor e-commerce?", answer: "Ja. Shopify SEO is een specialiteit, inclusief productpagina's." },
    ...
    { question: "Kunnen jullie mijn concurrent analyseren?", answer: "Ja. Niet om te kopiëren, wel om te zien waar jij kunt winnen." },
    { question: "Is SEO nog zinvol met ads?", answer: "Juist samen. SkinComplete groeide eerst organisch, ads daarna." },
    { question: "Wat kost {kw}?", answer: "Scope-afhankelijk. Na intake een voorstel, geen standaardpakket uit de lade." },
  ],
  website: [
    { question: "Bouwen jullie in WordPress?", answer: "Nee als eindstation. Custom build in Next.js of Shopify waar het past." },
    { question: "Hoe lang duurt een website?", answer: "Hangt af van scope. Landings sneller dan volledige corporate site met portal." },
    { question: "Doen jullie ook design?", answer: "Ja. Minimalistisch, premium, snel. Geen template met je logo erop." },
    { question: "Is mijn site daarna vindbaar?", answer: "SEO zit in de basis: semantiek, schema, snelheid. Geen bijlage." },
    { question: "Kunnen jullie mijn huidige site migreren?", answer: "Ja, met redirects en plan. Geen organische dip accepteren als norm." },
    { question: "Wat kost {kw}?", answer: "Projectmatig na intake. Geen €299-template prijzen, wel eerlijk voor custom work." },
    { question: "Leveren jullie ook teksten?", answer: "Ja, in Meneer-stem of afgestemd op jouw merk. Geen lorem ipsum live." },
    { question: "Kunnen jullie landingspagina's apart bouwen?", answer: "Ja. Vaak slimmer dan alles op de homepage proppen." },
    { question: "Werken jullie met bestaande huisstijl?", answer: "Ja. Design volgt merk, performance volgt best practice." },
    { question: "Is onderhoud inbegrepen?", answer: "We spreken hosting en updates af. Geen verrassingen achteraf." },
    { question: "Bouwen jullie webshops?", answer: "Ja, vaak Shopify. Zie ook webshop-laten-maken als dat je pad is." },
    { question: "Hoe zit het met toegankelijkheid?", answer: "Semantische HTML en a11y-basics horen standaard. Geen checkbox achteraf." },
    { question: "Kunnen jullie koppelen met mijn CRM?", answer: "Ja. Formulieren, webhooks, automatisering waar nodig." },
  ...
  shopify: [
    { question: "Migreren jullie van WooCommerce?", answer: "Ja, met redirect-plan. Anders betaal je dubbel in organische dip." },
    { question: "Bouwen jullie custom themes?", answer: "Waar nodig. Geen app-hel die je CWV sloopt." },
    { question: "Doen jullie Shopify SEO?", answer: "Ja. Producten, collecties, techniek." },
    { question: "Kunnen jullie B2B op Shopify?", answer: "Ja. Groothandel, staffels, portal-koppeling." },
    { question: "Hoe zit het met Shopify apps?", answer: "Alleen met business case. Elke app kost snelheid en geld." },
    { question: "Doen jullie Google Shopping?", answer: "Ja, feed hygiene eerst." },
    { question: "Wat kost {kw}?", answer: "Scope-afhankelijk. Theme-tweak vs volledige rebuild vs migratie." },
    { question: "Leveren jullie ook e-mail flows?", answer: "Ja, Klaviyo en abandoned cart waar het past." },
    { question: "Hoe snel kan een shop live?", answer: "Hangt af van catalogus en custom work. Geen valse beloftes." },
    { question: "Werken jullie met bestaande Shopify?", answer: "Ja. Audit, opschonen, optimaliseren." },
    { question: "Kunnen jullie checkout verbeteren?", answer: "Ja. Frictie zie je in omzet, niet in design mockups." },
    { question: "Doen jullie international?", answer: "Kan, met plan voor feeds, talen en structuur." },
    { question: "Is Shopify Plus nodig?", answer: "Niet altijd. Eerst kijken wat je echt nodig hebt." },
    { question: "Hoe meten jullie shop succes?", answer: "Conversie, AOV, ROAS, niet alleen bezoekers." },
    { question: "Wat na launch?", answer: "Marketing, SEO, ads. Shop is fundament, geen eindpunt." },
  ],
  content: [
    { question: "Schrijven jullie blogs?", answer: "Antwoord-pagina's die ranken en converteren. Blogs alleen als het past bij intentie." },
    { question: "Gebruiken jullie AI?", answer: "Als hulpmiddel, niet als bulk-vervanger. Stem en redactie blijven menselijk." },
    { question: "Hoe vaak moet ik publiceren?", answer: "Kwaliteit boven ritme. Eén sterke pagina wint van vijf dunne." },
    { question: "Doen jullie content voor SEO én ads?", answer: "Ja. Landings die matchen met campagnes." },
    { question: "Wat kost {kw}?", answer: "Per project of retainer na intake. Geen woordprijs uit de lade." },
    { question: "Kunnen jullie bestaande content updaten?", answer: "Ja. Vaak slimmer dan nieuwe stapelen." },
    { question: "Hoe meten jullie content succes?", answer: "Rankings, clicks, leads. Niet alleen pageviews." },
    { question: "Doen jullie video scripts?", answer: "Kan, als het past in je plan." },
    { question: "Werken jullie met mijn tone of voice?", answer: "Ja. Of we ontwikkelen er een die bij je past." },
    { question: "Helpen jullie met AI-zoek?", answer: "Content die citeerbaar is voor ChatGPT en Gemini." },
    { question: "Doen jullie social content?", answer: "Owned first. Social als versterker, niet als enige basis." },
    { question: "Kunnen jullie case studies?", answer: "Ja, met echte cijfers waar mogelijk." },
    { question: "Hoe lang duurt een contentplan?", answer: "Intake en plan: kort. Uitvoering: doorlopend met prioriteiten." },
    { question: "Is content genoeg zonder ads?", answer: "Soms. SkinComplete groeide eerst organisch. Timing verschilt per merk." },
    { question: "Wat als ik al een contentteam heb?", answer: "Dan versterk ik strategie, SEO en landings. Geen dubbel werk." },
  ],
  "b2b-portal": [
    { question: "Bouwen jullie custom portalen?", answer: "Ja. Shopify B2B, koppelingen, flows waar je stack het toelaat." },
    { question: "Werken jullie met n8n of Make?", answer: "Ja. Systemen aan elkaar knopen zonder handmatig gedoe." },
    ...
    { question: "Kunnen jullie CRM koppelen?", answer: "Ja. Leads horen niet in Gmail te sterven." },
    { question: "Doen jullie training?", answer: "Ja. Je team moet het snappen, niet alleen ik." },
    { question: "Wat als we Excel blijven gebruiken?", answer: "Dan rekenen we door of automatisering terugverdient." },
    { question: "Is een portal altijd nodig?", answer: "Nee. Soms is een slimmere orderflow genoeg." },
    { question: "Hoe meten jullie succes?", answer: "Uren bespaard, snellere orders, minder fouten." },
    { question: "Werken jullie met bestaande ERP?", answer: "Koppelingen afhankelijk van API's. Eerst haalbaarheid checken." },
    { question: "Kunnen klanten zelf bestellen?", answer: "Dat is vaak het doel. Minder mail, meer marge." },
    { question: "Hoe zit het met beveiliging?", answer: "Standaard best practices. Geen shortcuts met klantdata." },
    { question: "Doen jullie ook B2C naast B2B?", answer: "Ja, met juiste scheiding en prijslogica." },
    ...
    const cityQ =
      page.location.city === "Apeldoorn"
        ...
        : {
            ...
            answer: fill(
              `Omdat generieke copy met '{city}' in de titel niemand overtuigt. Ik schrijf voor ondernemers in {city} en {region}, met dezelfde principes als voor SkinComplete en BestRest.`,
              vars,
            ),
          };
    picked.push(cityQ);
  ...
  const visualCaption =
    ...
    fill(
      pick(
        page.slug,
        [
          `Zo pakken we {kw} aan{loc}. Geen template, wel plan.`,
