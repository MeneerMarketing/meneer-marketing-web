...
export const EXTRA_FAQ_POOL: Record<SeoLandingCategory, readonly SeoLandingFaq[]> = {
  "google-ads": [
    { question: "Wat maakt mijn {kw} anders dan een standaard bureau?", answer: "Ik bouw en optimaliseer zelf: site, landings, tracking, campagnes. Geen keten van specialisten die elkaar de schuld geven." },
    ...
    { question: "Werk je op ROAS of CPA?", answer: "Wat past bij je marge. Soms is CPA leidend, soms ROAS. Ik kies vóór we opschalen." },
  ...
  seo: [
    ...
    { question: "Schrijf je content zelf?", answer: "Ja, in jouw stem waar mogelijk. Geen AI-bulk zonder redactie." },
  ...
  website: [
    ...
    { question: "Doe je ook design?", answer: "Ja. Minimalistisch, premium, snel. Geen template met je logo erop." },
    { question: "Is mijn site daarna vindbaar?", answer: "SEO zit in de basis: semantiek, schema, snelheid. Geen bijlage." },
    { question: "Kun je mijn huidige site migreren?", answer: "Ja, met redirects en plan. Geen organische dip accepteren als norm." },
    { question: "Wat kost {kw}?", answer: "Projectmatig na intake. Geen €299-template prijzen, wel eerlijk voor custom work." },
    { question: "Lever je ook teksten?", answer: "Ja, in Meneer-stem of afgestemd op jouw merk. Geen lorem ipsum live." },
  ...
  shopify: [
    ...
    { question: "Bouw je custom themes?", answer: "Waar nodig. Geen app-hel die je CWV sloopt." },
