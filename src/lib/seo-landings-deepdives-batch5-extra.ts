...
/** Handgeschreven deep-dive secties voor batch 5, originals, vergelijk, extra en trio-bases. */
export const DEEPDIVE_BATCH5_EXTRA: Partial<Record<string, SeoLandingProseOverride>> = {
  "marketing-bureau": {
  ...
  "seo-bureau": {
    title: "SEO bureau met techniek, content en autoriteit",
    paragraphs: [
  ...
  "email-marketing": {
    title: "Email marketing die omzet per flow meet",
    paragraphs: [
      "Email marketing is nog steeds een van de hoogste ROI-kanalen voor webshops en dienstverleners. Welkom, cart, post-purchase en win-back horen standaard in je stack.",
      "Ik setup Klaviyo of vergelijkbaar, segmenteer op gedrag en schrijf in jouw tone. Elke flow krijgt een metric: omzet, herhaalaankoop, reactivatie.",
      "Email marketing zonder schone data en snelle landings lekt. Ik koppel shop, site en ads zodat dezelfde aanbieding overal klopt.",
      "Email marketing is retentie. Acquisitie via ads wordt goedkoper als mail je bestaande klanten wakker houdt.",
    ],
  },
  "e-mailmarketing-bureau": {
    title: "E-mailmarketing bureau gekoppeld aan je shop en site",
    paragraphs: [
      "E-mailmarketing bureau richt flows, segmenten en campagnes in. Het verschil met een losse freelancer: strategie, techniek en copy in één lijn.",
      "Ik migreer lijsten, bouw templates, test onderwerpregels en koppel automatiseringen aan je CRM of Shopify.",
      "E-mailmarketing bureau bij mij werkt samen met SEO en ads. Remarketing en mail op hetzelfde segment versterken elkaar.",
      "E-mailmarketing is geen nieuwsbrief om de week. Het is gedraggestuurde communicatie die je marge beschermt.",
    ],
  },
  ...
  "internetmarketing-bureau": {
    title: "Internetmarketing bureau voor het hele online plaatje",
    paragraphs: [
  ...
  "online-marketing-specialist": {
    title: "Online marketing specialist als verlengstuk van je team",
    paragraphs: [
  ...
  "website-ontwikkelaar": {
    title: "Website ontwikkelaar voor Next.js en Shopify",
    paragraphs: [
      "Website ontwikkelaar bouwt de technische basis: performance, SEO-structuur, integraties en beveiliging. Bij marketing-sites moet dat converteerbaar zijn.",
      "Ik ontwikkel custom in Next.js App Router en Shopify Liquid. TypeScript, schema, Core Web Vitals ingebouwd.",
      "Website ontwikkelaar bij Meneer Marketing is geen WordPress-plugin-stack. Custom build voor merken die willen schalen.",
      "Van portal tot checkout: website ontwikkelaar die je funnel begrijpt levert minder rework.",
    ],
  },
  "social-media-marketing-bureau": {
    title: "Social media marketing bureau met paid én content",
    paragraphs: [
      "Social media marketing bureau regelt organische posts, community en betaalde campagnes. Het moet samenhangen met je site en aanbod.",
      "Ik plan content die hergebruikt kan in ads, koppel pixel en CAPI, en meet tot checkout. Volgers zijn geen doel, omzet wel.",
      "Social media marketing bureau bij mij denkt platform-specifiek: Meta voor reach, LinkedIn voor B2B, TikTok voor UGC-tests.",
      "Social zonder landings is entertainment. Ik bouw pagina's die de swipe afmaken.",
    ],
  },
  "webdesign-specialist": {
    title: "Webdesign specialist die ook live zet",
    paragraphs: [
      "Webdesign specialist focust op UI, UX en merk. Bij mij eindigt dat in productie: responsive, snel, toegankelijk.",
      "Ik werk met een strak grid, bold type en micro-interacties die premium voelen zonder je Lighthouse-score te slopen.",
      "Webdesign specialist voor Meneer Marketing zelf en voor klanten: hetzelfde niveau van afwerking.",
      "Webdesign specialist zonder developer-skills levert PSD's. Bij mij klik je op de live URL.",
    ],
  },
  "website-laten-maken": {
  ...
  "seo-specialist": {
    title: "SEO specialist met techniek én commerciële focus",
    paragraphs: [
      "SEO specialist optimaliseert voor rankings die verkopen. Keyword research, technische fixes, content en interne linkstructuur.",
      "Ik lees Search Console en analytics, prioriteer pagina's met koopintentie en bouw landings zelf als dat sneller is.",
      "SEO specialist bij een bureau dat alleen rapporteert, mist uitvoering. Bij mij is SEO live werk.",
      "Organisch eerst, ads daarna. SEO specialist met die discipline beschermt je marge op lange termijn.",
    ],
  },
  "google-ads-bureau": {
    title: "Google Ads bureau met landings die message match kloppen",
    paragraphs: [
  ...
  "hoger-in-google": {
    title: "Hoger in Google: rankings die omzet opleveren",
    paragraphs: [
  ...
  "content-marketing-vindbaarheid": {
    title: "Content marketing en vindbaarheid in Google én AI",
    paragraphs: [
      "Content marketing vindbaarheid betekent: content die rankt, autoriteit opbouwt en ook in AI-antwoorden terugkomt.",
      "Ik schrijf pagina's die echte vragen beantwoorden, met schema en interne links naar je money pages.",
      "Content marketing zonder technische basis dupliceert concurrenten. Unieke expertise wint van bulk-AI-artikelen.",
      "Vindbaarheid in ChatGPT en Gemini hoort bij dit werk. Sterke antwoorden, citeerbare cases, consistent merk.",
    ],
  },
  "b2b-portaal-bouwen": {
    title: "B2B portaal bouwen op Shopify: zelf bestellen, minder handwerk",
    paragraphs: [
  ...
  "meta-ads-bureau": {
    title: "Meta Ads bureau voor Facebook en Instagram campagnes",
    paragraphs: [
      "Meta Ads bureau zet campagnes op voor Facebook en Instagram: prospecting, retargeting, catalog en lead gen. Pixel en Conversions API moeten kloppen.",
      "Ik test creatives, doelgroepen en landings op mobiel. Hook in de feed, conversie op de site.",
      "Meta Ads bureau bij mij werkt met UGC en korte video. Stock die niemand gelooft, gaat eruit.",
      "Meta en Google in één plan voorkomt tegenstrijdige aanbiedingen en dubbel werk.",
    ],
  },
  "online-marketing-bureau": {
    title: "Online marketing bureau voor SEO, ads en site in één lijn",
    paragraphs: [
      "Online marketing bureau dekt je volledige digitale acquisitie: site, SEO, Google Ads, Meta en mail. Eén strategie, geen tegenstrijdige bureaus.",
      "Ik werk als jouw online marketing manager met vaste rapportage en eerlijke prioriteiten.",
      "Online marketing bureau bij Meneer Marketing bouwt from scratch en schaalt op data.",
      "Apeldoorn en landelijk. Online marketing met twaalf jaar praktijk en live cases.",
    ],
  },
  "shopify-expert": {
    title: "Shopify expert voor theme, performance en koppelingen",
    paragraphs: [
  ...
  "google-shopping-ads": {
    title: "Google Shopping ads met feed die winkelt",
    paragraphs: [
      "Google Shopping ads tonen je producten bovenaan zoekresultaten met foto, prijs en winkelnaam. De feed bepaalt of je wint of verdwijnt.",
      "Ik fix titels, attributen, disapprovals en campagnestructuur. Shopping zonder schone productdata is budget weggooien.",
      "Google Shopping ads werken het best met snelle productpagina's en remarketing op bezoekers.",
      "Shopping is vaak de eerste paid stap na basis-SEO in ecommerce. Ik zet het op als je feed en site klaar zijn.",
    ],
  },
  "vindbaarheid-ai": {
  ...
  "landing-page-laten-maken": {
    title: "Landing page laten maken voor ads en campagnes",
    paragraphs: [
      "Landing page laten maken is een pagina op maat voor één aanbod en één actie. Ads landen hier, niet op je homepage.",
      "Ik bouw snelle landings met message match, trust en tracking. Mobiel eerst, Core Web Vitals in orde.",
      "Landing page laten maken zonder A/B-mindset is een eenmalige poster. Ik meet en verbeter op conversie.",
      "Elke campagne verdient een landing die past bij de hook. Ik lever die pagina's zelf, geen template uit een bouwer.",
    ],
  },
  "marketing-automatisering": {
    title: "Marketing automatisering: systemen aan elkaar knopen",
    paragraphs: [
      "Marketing automatisering koppelt shop, CRM, mail, ads en interne tools. Minder handwerk, snellere opvolging, minder leads die tussen wal en schip vallen.",
      "Ik bouw met n8n, Make of custom API's afhankelijk van je stack. Triggers, filters, logging.",
      "Marketing automatisering zonder schone data is chaos op autopilot. Ik audit eerst je bronnen.",
      "E-commerce op autopilot is het doel: orders, mail, rapportage lopen terwijl jij focust op product en klant.",
    ],
  },
  "sea-specialist": {
    title: "SEA specialist voor Google Ads met commerciële focus",
    paragraphs: [
  ...
  "google-ads-of-seo": {
    title: "Google Ads of SEO: wat eerst voor jouw situatie",
    paragraphs: [
  ...
  "shopify-of-woocommerce": {
    title: "Shopify of WooCommerce: platformkeuze voor groei",
    paragraphs: [
      "Shopify of WooCommerce vergelijken is kijken naar onderhoud, snelheid, kosten en wie je shop beheert. Shopify is managed, Woo draait op WordPress.",
      "Voor merken die willen schalen zonder plugin-chaos adviseer ik vaak Shopify. Woo past als je team diep in WordPress zit.",
      "Shopify of WooCommerce voor marketing: Shopify wint vaak op performance, apps en support.",
      "Migratie van Woo naar Shopify doe ik met redirects en SEO in gedachten. Shopify of WooCommerce is strategie, geen feature-tabel.",
    ],
  },
  "meta-ads-of-google-ads": {
    title: "Meta Ads of Google Ads: welk kanaal wanneer",
    paragraphs: [
